<?php 
/* 
File Name: Directorotherinfo.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Employeeotherinfo.php");
$objEmployee= new employeeOtherInfo;
$arrEmpPersonal = $objEmployee->checkGetEmpNmbr("Employee", $strEmpNmbr);
?>
<html><!-- InstanceBegin template="/Templates/Personaldirectortmplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
function openPrint() { 
	...
	strPage = "Dirindex.php?strEmpNmbr="+strEmpNmbr+"&t_strUserLevel="+t_strUserLevel+"&t_strUserPermission="+t_strUserPermission+"&t_strAccessPermission="+t_strAccessPermission;
...
<table width="778" border="0" cellpadding="0" cellspacing="0" id="OUTERTBL">
  <tr> 
    <td height="395"><table width="100%" height="395" border="0" align="center" cellpadding="0" cellspacing="0" id="INNERTBL">
        <tr> 
          <td width="58%" height="44" valign="bottom"><img src="images/execommodule.jpg" width="169" height="23"> 
          </td>
                          ...
                          <tr>
                                  ...
                                  <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td width="5%" height="21"><img src="images/skills_organization.gif" width="22" height="22"> 
                                              </td>
                                              <td width="95%" class="note">SKILLS 
                                          ...
                                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? $objEmployee->viewSkills($txtSearch, $optField, $p, $t_strSkills, $t_strNADR, $t_strMIAO, $arrEmpPersonal["empNumber"]);   //View list of employee's other information
									?>
                                              </td>
                                            </tr>
                                          </table>
							...
							$objEmployee->viewLegalInfo($txtSearch, $optField, $p, $t_strRelatedThird, $t_strRelatedFourth, $t_strRelatedDegreeParticulars, $t_strAdminCase, $t_strAdminCaseParticulars, $t_strViolateLaw, $t_strViolateLawParticulars, $t_strForcedResign, $t_strForcedResignParticulars, $t_strCandidate, $t_strCandidateParticulars, $t_strIndigenous, $t_strIndigenousParticulars, $t_strDisabled, $t_strDisabledParticulars, $t_strSoloParent, $t_strSoloParentParticulars, $arrEmpPersonal["empNumber"]);  //view employee Legal Information
							  ?>
                                          ...
                                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td width="6%" height="13"><img src="images/chraracter_reference.gif" width="29" height="23"></td>
                                              <td width="94%" valign="middle" class="note">CHARACTER 
                                                REFERENCE </td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                        ...
                                        <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          ...
                                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              ...
                                              <td width="95%"><span class="note"> 
                                                PLEDGE DETAILS </span></td>
                                            </tr>
                                          </table>
                                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? $objEmployee->viewPledge($txtSearch, $optField, $p, $t_strSignature, $t_dtmDateAccomplished, $t_strComTaxNumber, $t_strIssuedAt, $t_dtmIssuedOn, $arrEmpPersonal["empNumber"]);  //View list of employee's signature, ctc
										?>
                                              </td>
                                            </tr>
                                          </table></td>
