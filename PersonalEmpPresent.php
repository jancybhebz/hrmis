                    ...
                    <tr> 
                      <td height="339"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="23" class="header"><p>EMPLOYEES PRESENT</p></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><table width="86%" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="59%" class="alterrow">Name of Employee(s)</td>
                                  <td width="41%" class="alterrow">Time In</td>
                                </tr>
                                <tr> 
...
$objEmpPresent = mysql_query("SELECT tblEmpPersonal.surname, tblEmpPersonal.firstname, 
									 tblEmpDTR.dtrDate, tblEmpDTR.inAM, tblEmpDTR.outAM, 
									 tblEmpDTR.inPM, tblEmpDTR.outPM
						      FROM tblEmpPersonal
							  INNER JOIN tblEmpDTR
							  	ON tblEmpPersonal.empNumber = tblEmpDTR.empNumber
							  WHERE tblEmpDTR.dtrDate = '$curDate'
							  ORDER BY tblEmpPersonal.surname, tblEmpPersonal.firstname asc");
							


while($arrEmpPresent = mysql_fetch_array($objEmpPresent))  
{
	$strEmpName = $arrEmpPresent['surname']. ", ".$arrEmpPresent['firstname'];
	$strDate = $arrEmpPresent['dtrDate'];
	$strInAM = $arrEmpPresent['inAM'];
	$strOutAM = $arrEmpPresent['outAM'];
	$strInPM = $arrEmpPresent['inPM'];
	$strOutPM = $arrEmpPresent['outPM'];
	
	if ((($strInAM != '00:00:00')&&($strOutAM == '00:00:00'))||(($strInAM != '00:00:00')||($strOutAM != '00:00:00')))
		{	
			$strTimeIN = $strInAM;
			$strTZone = 'AM';
			$strTimeINTZ = $strTimeIN." ".$strTZone;
			echo "<tr> 
                  <td height='8'>$strEmpName       
                  </td>
                  <td height='8'>$strTimeINTZ</td>
                  </tr>
				 ";
		 }
	
	elseif((($strInPM != '00:00:00')&&($strOutPM == '00:00:00'))||(($strInPM != '00:00:00')||($strOutPM != '00:00:00')))
		{	
			$strTimeIN = $strInPM;
			$strTZone = 'PM';
			$strTimeINTZ = $strTimeIN." ".$strTZone;
...
?>
                          ...
                          <tr> 
                            <td height="14"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
							  ...
							  { 
									echo "<tr>
										  <td height='8' class='note'>*** No employee(s) present for the day ***</td>
										  <td height='8'>&nbsp;</td></tr>";
							   } else 
							   {
								    echo "<tr> 
