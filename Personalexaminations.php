<?php 
/* 
File Name: Personalexaminations.php
----------------------------------------------------------------------
...
include("../hrmis/class/Personalexaminations.php");
$objEmployee= new personalExaminations;
...
if ($t_strEmpNumber <> NULL)
{
	if ($t_strExamCode != "") { 
	//--------------------------------  Add Examination Information -------------------------------//
	$objEmployee->addExamination($strEmpNmbr, $t_strEmpNumber, $t_strExamCode, $t_dtmExamMonth, $t_dtmExamDay, $t_dtmExamYear, $t_intExamRating, $t_strExamPlace, $t_strLicenseNumber, $t_dtmDateReleaseMonth, $t_dtmDateReleaseDay, $t_dtmDateReleaseYear, $Submit);   //Add employee exmination
	}
}
//--------------------------------  Edit Examination Information -------------------------------//

$objEmployee->editExamination($strEmpNmbr, $txtSearch, $optField, $p, $strLetter, $t_strExamCode, $t_dtmExamMonth, $t_dtmExamDay, $t_dtmExamYear, $t_intExamRating, $t_strExamPlace, $t_strLicenseNumber, $t_dtmDateReleaseMonth, $t_dtmDateReleaseDay, $t_dtmDateReleaseYear, $Submit, $t_strEmpNumber, $t_strOldExamCode, $t_dtmOldExamMonth, $t_dtmOldExamDay, $t_dtmOldExamYear);  //edit employee examinations

//--------------------------------  Delete Examination Information -------------------------------//

$strConfirm=$objEmployee->deleteExamination($strEmpNmbr, $t_strEmpNumber, $t_strExamCode, $t_dtmExamDate, $t_intExamRating, $t_strExamPlace, $t_strLicenseNumber, $t_dtmDateRelease, $Submit);  //Delete employee examination
...
function validatePlaceOfExam(field) 
{
...
function validateLicenseNumber(field) 
{
...
var temp
if (document.frmExam.t_strExamCode.value=="") {
alert("Please input exam description!")
return false
} else if (document.frmExam.t_strExamPlace.value=="") {
alert("Please input place of exam!")
return false
} else if (document.frmExam.t_intExamRating.value=="") {
alert("Please input exam rating!")
return false
}

if (document.frmExam.t_intExamRating.value=="") {
alert("Please input exam rating!")
return false
}

for (var i=0;i<document.frmExam.t_intExamRating.value.length;i++){
temp=document.frmExam.t_intExamRating.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid exam rating !")
return false
      }
   }
...
function updateRequirement()
{
	...
	var strEmpData = document.frmExam.t_strExamCode.value;
	
	window.location = "Personalexaminations.php?strEmpNmbr="+strEmpNmbr+"&t_strExamCode="+strEmpData;
}
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td><p class="header">Examinations</p>
                              ...
                              <hr> 
                              <? 
								$arrEmployee=$objEmployee->viewExamination($strEmpNmbr, $txtSearch, $optField, $p, $strLetter, $t_strExamCode, $t_dtmExamDate, $t_intExamRating, $t_strExamPlace,  $t_strLicenseNumber, $t_dtmDateRelease, $arrEmpPersonal["empNumber"]);   //view list of employee's exmination
								?>
                              <br> 
                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form method="post" action="<? $PHP_SELF; ?>" name="frmExam" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
							      ...
							      ?>
                                  <tr> 
                                    <td width="149" height="19" class="paragraph"> 
                                  ...
                                  <tr> 
                                    <td class="paragraph">Place of Exam/Conferment 
                                      :</td>
                                    <td colspan="2"> <input name="t_strExamPlace" type="text" value="<? echo "$t_strExamPlace"; ?>" size="30" maxlength="50" onBlur="validatePlaceOfExam(this)"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Rating :</td>
                                    <td width="108"><input name="t_intExamRating" type="text" value="<? echo "$t_intExamRating"; ?>" size="10" maxlength="5" onBlur="validateRating(this)">
                                      % </td>
                                    <td class="paragraph">Date of Exam/Conferment 
                                      :<?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
										echo "<SELECT NAME=\"t_dtmExamYear\" onChange=\"updateList(t_dtmExamMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmExamDay')\">\r";
										$yyyymmdd = $t_dtmExamDate;
                                        list($t_dtmExamYear) = array(substr($yyyymmdd,0,4));
										$objEmployee->comboYearOld($t_dtmExamYear);
										echo "</SELECT>\r";
										?> 
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
									    echo "<SELECT NAME=\"t_dtmExamMonth\" onChange=\"updateList(this.selectedIndex,t_dtmExamYear[t_dtmExamYear.selectedIndex].text,'t_dtmExamDay')\">"; 
										$yyyymmdd = $t_dtmExamDate;
                                        list($t_dtmExamMonth) = array(substr($yyyymmdd,5,2));
										$objEmployee->comboMonth($t_dtmExamMonth);
										echo "</SELECT>";
										?>
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
										echo "<SELECT NAME=\"t_dtmExamDay\">\r";
										$yyyymmdd = $t_dtmExamDate;
                                        list($t_dtmExamDay) = array(substr($yyyymmdd,8,2));
										$objEmployee->comboDay($t_dtmExamDay);
										echo "</SELECT>\r";
										?>
                                      
                                      <input name="t_dtmOldExamDate" type="hidden" value="<? echo "$t_dtmExamDate"; ?>"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">License No. (if applicable) 
                                      : </td>
                                    <td><input name="t_strLicenseNumber" type="text" value="<? echo "$t_strLicenseNumber"; ?>" size="20" maxlength="20" onBlur="validateLicenseNumber(this)"></td>
                                    <td class="paragraph">Date of Release :<?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
										echo "<SELECT NAME=\"t_dtmDateReleaseYear\" onChange=\"updateList(t_dtmDateReleaseMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmDateReleaseDay')\">\r";
										$yyyymmdd = $t_dtmDateRelease;
                                        list($t_dtmDateReleaseYear) = array(substr($yyyymmdd,0,4));
										$objEmployee->comboYearOld($t_dtmDateReleaseYear);
										echo "</SELECT>\r";
										?>
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
									    echo "<SELECT NAME=\"t_dtmDateReleaseMonth\" onChange=\"updateList(this.selectedIndex,t_dtmDateReleaseYear[t_dtmDateReleaseYear.selectedIndex].text,'t_dtmDateReleaseDay')\">"; 
										$yyyymmdd = $t_dtmDateRelease;
                                        list($t_dtmDateReleaseMonth) = array(substr($yyyymmdd,5,2));
										$objEmployee->comboMonth($t_dtmDateReleaseMonth);
										echo "</SELECT>";
										?>
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblEmpExam");
										echo "<SELECT NAME=\"t_dtmDateReleaseDay\">\r";
										$yyyymmdd = $t_dtmDateRelease;
                                        list($t_dtmDateReleaseDay) = array(substr($yyyymmdd,8,2));
										$objEmployee->comboDay($t_dtmDateReleaseDay);
										echo "</SELECT>\r";
										?>
                                      
                                      <input name="t_dtmOldDateRelease" type="hidden" value="<? echo "$t_dtmDateRelease"; ?>">
                                  ...
                                  <tr> 
                                    <td colspan="3" class="paragraph"><div align="justify"></div></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3">&nbsp;</td>
                                  </tr>
                                  <?
								     ...
								     ?>
                                  <tr> 
                                    <td width="149" height="19" class="paragraph">Exam 
                                      Description : </td>
                                    <td colspan="2"> 
                                      <?php 
                                  ...
                                  <tr> 
                                    <td class="paragraph">Place of Exam/Conferment 
                                      :</td>
                                    <td colspan="2"> <input name="t_strExamPlace" type="text" size="30" maxlength="50" onBlur="validatePlaceOfExam(this)"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Rating :</td>
                                    <td><input name="t_intExamRating" type="text" size="10" maxlength="5" onBlur="validateRating(this)">
                                      %</td>
                                    <td width="328" class="paragraph">Date of 
                                      Exam/Conferment :<select name="t_dtmExamYear" size="1" onChange="updateList(t_dtmExamMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmExamDay')">
                                        <?
										$objEmployee->comboYearOld(date('Y'));
									   ?>
                                      </select>
										<select name="t_dtmExamMonth" size="1" onChange="updateList(this.selectedIndex,t_dtmExamYear[t_dtmExamYear.selectedIndex].text,'t_dtmExamDay')">
                                        <?
                                  ...
                                  <tr> 
                                    <td class="paragraph">License No. (if applicable) 
                                      : </td>
                                    <td><input name="t_strLicenseNumber" type="text" size="20" maxlength="20" onBlur="validateLicenseNumber(this)"></td>
                                    <td class="paragraph">Date of Release :<select name="t_dtmDateReleaseYear" size="1" onChange="updateList(t_dtmDateReleaseMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmDateReleaseDay')">
                                        <?
										$objEmployee->comboYearOld(date('Y'));
									   ?>
                                      </select> 
                                      <select name="t_dtmDateReleaseMonth" size="1" onChange="updateList(this.selectedIndex,t_dtmDateReleaseYear[t_dtmDateReleaseYear.selectedIndex].text,'t_dtmDateReleaseDay')">
                                        <?
										$objEmployee->comboMonth(date('n'));
										?>
                                      </select>
