...
include("../hrmis/class/Signatory.php");   //Load database connection
$objSignatory= new signatory;   //Load signatory function
$objSignatory->addSignatory($strEmpNmbr, $t_strDesignation, $t_strSignatory, $t_strSignatoryTitle, $Submit); //add signatory
$objSignatory->editSignatory($strEmpNmbr, $t_strDesignation, $t_strSignatory, $t_strSignatoryTitle, $Submit, $t_strOldDesignation);  //edit signatory
?>
...
var temp
if (document.frmSignatory.t_strDesignation.value=="") {
alert("Please input name of designation !")
return false
} else if (document.frmSignatory.t_strSignatory.value=="") {
alert("Please input name of signatory !")
return false
} else if (document.frmSignatory.t_strSignatoryTitle.value=="") {
alert("Please input position title of signatory !")
return false
}
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="143" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="26" class="header"><p>SIGNATORY</p></td>
                          </tr>
                          <tr> 
                            <td height="13" valign="top">&nbsp;</td>
                          </tr>
                          <tr> 
                            <td height="6" valign="top"> <form action="<?php $PHP_SELF; ?>" method="post" name="frmSignatory" onSubmit="return validate()">
                                <?
								if($Submit == 'Edit')
								{
								?>
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td colspan="3" class="paragraph">Designation 
                                      : </td>
                                    <td width="390"><input name="t_strDesignation" type="text" value="<? echo $t_strDesignation; ?>" size="30" maxlength="30" readonly onBlur="validateCharacter(this)"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">Signatory 
                                      : </td>
                                    <td width="390"><input name="t_strSignatory" type="text" value="<? echo "$t_strSignatory"; ?>" size="50" maxlength="70" onBlur="validateCharacter(this)"> 
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">Position 
                                      Details :</td>
                                    <td> <input name="t_strSignatoryTitle" type="text" value="<? echo "$t_strSignatoryTitle"; ?>" size="50" maxlength="70" onBlur="validateCharacter(this)"> 
                                      <span class="required">* </span> <input name="t_strOldDesignation" type="hidden" value="<? echo $t_strDesignation; ?>"> 
                                  ...
                                  <tr> 
                                    <td colspan="4" class="paragraph"><div align="center"> 
                                        ...
                                        <input name="Submit" type="submit" id="Submit" onClick="return validate()" value="Cancel">
                                      </div></td>
                                  </tr>
                                </table>
                                <?
                                ...
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td colspan="3" class="paragraph">Designation 
                                      : </td>
                                    <td width="390"><input name="t_strDesignation" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">Signatory 
                                      : </td>
                                    <td width="390"><input name="t_strSignatory" type="text" size="50" maxlength="70" onBlur="validateCharacter(this)"> 
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">Position 
                                      Details :</td>
                                    <td> <input name="t_strSignatoryTitle" type="text" size="50" maxlength="70" onBlur="validateCharacter(this)"> 
                                  ...
                                  <tr> 
                                    <td colspan="4" class="paragraph"><div align="center"> 
                                        <input name="Submit" type="submit" id="Submit" onClick="return validate()" value="ADD">
                          ...
                          <tr> 
                            <td height="6" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objSignatory->viewSignatory($strEmpNmbr, $t_strSignatory, $t_strSignatoryTitle);  //View list of signatory
									?>
                                  </td>
                                </tr>
                              </table></td>
