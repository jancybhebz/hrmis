<?php 
/* 
File Name: Directorexaminations.php
----------------------------------------------------------------------
...
include("../hrmis/class/Employeeexaminations.php");
$objEmployee= new employeeExaminations;
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td><p class="header">Examinations</p>
                                    ...
                                    <hr> 
                                    <? 
								$arrEmployee=$objEmployee->viewExamination($txtSearch, $optField, $p, $t_strExamCode, $t_dtmExamDate, $t_intExamRating, $t_strExamPlace,  $t_strLicenseNumber, $t_dtmDateRelease, $arrEmpPersonal["empNumber"]);   //view list of employee's exmination
								?>
                                    <br> </td>
                                </tr>
                              </table>
