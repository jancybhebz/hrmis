<?php 
/* 
File Name: Director201update.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Director201update.php");
$objDirector201Update = new director201Update;
$arrEmpPersonal = $objDirector201Update->checkGetEmpNmbr("Employee", $strEmpNmbr);


if ($t_strDirectorProfile == 'Training') 
{
// Function Training 
$objDirector201Update->addTraining($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strTrainingRequestCode, $t_strTrainingCode, $t_dtmTrainingContractMonth, $t_dtmTrainingContractDay, $t_dtmTrainingContractYear, $t_strTrainingConductedBy, $t_strTrainingVenue, $t_dtmTrainingStartMonth, $t_dtmTrainingStartDay, $t_dtmTrainingStartYear, $t_dtmTrainingEndMonth, $t_dtmTrainingEndDay, $t_dtmTrainingEndYear, $t_intTrainingHours, $t_intTrainingCost, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director training/seminar
} elseif ($t_strDirectorProfile == 'Reference') {
//	Function Reference
$objDirector201Update->addReference($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strRefRequestCode, $t_strRefName, $t_strRefAddress, $t_intRefTelephone, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director reference
} elseif ($t_strDirectorProfile == 'Children') {
//	Function Children
$objDirector201Update->addChildren($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strChildRequestCode, $t_strChildName, $t_strChildBirthMonth, $t_strChildBirthDay, $t_strChildBirthYear, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director children information
} elseif ($t_strDirectorProfile == 'Tax'){
//	Function Tax
$objDirector201Update->addTax($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strTaxRequestCode, $t_strTaxCertNmbr, $t_strIssuedAt, $t_dtmIssuedOnMonth, $t_dtmIssuedOnDay, $t_dtmIssuedOnYear, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director community tax certificate
} elseif ($t_strDirectorProfile == 'Examination') {
//  Function Examinations
$objDirector201Update->addExaminations($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strExamRequestCode, $t_strExamCode, $t_dtmExamMonth, $t_dtmExamDay, $t_dtmExamYear, $t_intExamRating, $t_strExamPlace, $t_strLicenseNumber, $t_dtmDateReleaseMonth, $t_dtmDateReleaseDay, $t_dtmDateReleaseYear, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director examination
} elseif ($t_strDirectorProfile == 'Voluntary') {
//  Function Voluntary Works
$objDirector201Update->addVoluntaryWorks($t_strEmpNumber, $t_strDirectorProfile, $t_strVWRequestCode, $t_strVWName, $t_strVWAddress, $t_dtmVWDateFromMonth, $t_dtmVWDateFromDay, $t_dtmVWDateFromYear, $t_dtmVWDateToMonth, $t_dtmVWDateToDay, $t_dtmVWDateToYear, $t_intVWHours, $t_strVWPosition, $t_dtmStatusDate, $t_strRequestStatus, $Submit);  //Add employee personal data
} elseif ($t_strDirectorProfile == 'Profile') {
//  Function Profile
$objDirector201Update->addProfile($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strProfileRequestCode, $t_strSurname, $t_strMiddlename, $t_strCivilStatus, $t_intWeight, $t_strResidentialAddress, $t_intZipCode1, $t_intTelephone1, $t_strPermanentAddress, $t_intZipCode2, $t_intTelephone2, $t_strEmail, $t_intMobile, $t_strSpouse, $t_strSpouseWork, $t_strSpouseBusName, $t_strSpouseBusAddress, $t_intSpouseTelephone, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add employee personal data
} elseif ($t_strDirectorProfile == 'Education') {
//  Function Education
$objDirector201Update->addEducation($strEmpNmbr, $t_strEmpNumber, $t_strDirectorProfile, $t_strEducationRequestCode, $t_strLevelCode, $t_strSchoolName, $t_strCourse, $t_intUnits, $t_strHonors, $t_dtmSchoolFromMonth, $t_dtmSchoolFromDay, $t_dtmSchoolFromYear, $t_dtmSchoolToMonth, $t_dtmSchoolToDay, $t_dtmSchoolToYear, $t_dtmStatusDate, $t_strRequestStatus, $Submit);   //Add director educational attainment
}
?>
...
function updateRequirement()
{
	...
	var strEmpData = document.frmDirector201Update.t_strDirectorProfile.value;
	
	window.location = "Director201update.php?strEmpNmbr="+strEmpNmbr+"&t_strDirectorProfile="+strEmpData;
}
...
if (document.frmDirector201Update.t_strTaxCertNmbr.value=="") {
alert("Please input community tax certificate!")
return false
} else if (document.frmDirector201Update.t_strIssuedAt.value=="") {
...
if (document.frmDirector201Update.t_strRefName.value=="") {
alert("Please input reference name!")
return false
} else if (document.frmDirector201Update.t_strRefAddress.value=="") {
alert("Please input reference address!")
return false
} else if (document.frmDirector201Update.t_intRefTelephone.value=="") {
alert("Please input reference telephone!")
return false
} 

for (var i=0;i<document.frmDirector201Update.t_intRefTelephone.value.length;i++){
temp=document.frmDirector201Update.t_intRefTelephone.value.substring(i,i+1)
...
if (document.frmDirector201Update.t_strExamPlace.value=="") {
alert("Please input place of exam!")
return false
} else if (document.frmDirector201Update.t_intExamRating.value=="") {
alert("Please input exam rating!")
return false
}

for (var i=0;i<document.frmDirector201Update.t_intExamRating.value.length;i++){
temp=document.frmDirector201Update.t_intExamRating.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
if (document.frmDirector201Update.t_strSchoolName.value=="") {
alert("Please input school name!")
return false
} else if (document.frmDirector201Update.t_strCourse.value=="") {
alert("Please input course!")
return false
} else if (document.frmDirector201Update.t_intUnits.value=="") {
alert("Please input unit!")
return false
}

for (var i=0;i<document.frmDirector201Update.t_intUnits.value.length;i++){
temp=document.frmDirector201Update.t_intUnits.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert(" Invalid rate of exam! \n\n Please input numbers only!")
return false
      }
...
if (document.frmDirector201Update.t_strChildName.value=="") {
...
if (document.frmDirector201Update.t_intTrainingHours.value=="") {
alert("Please input training hours!")
return false
} else if (document.frmDirector201Update.t_strTrainingVenue.value=="") {
alert("Please input training venue!")
return false
} else if (document.frmDirector201Update.t_strTrainingConductedBy.value=="") {
alert("Please input training conducted by!")
return false
} else if (document.frmDirector201Update.t_intTrainingCost.value=="") {
alert("Please input training cost!")
return false
} 

for (var i=0;i<document.frmDirector201Update.t_intTrainingHours.value.length;i++){
temp=document.frmDirector201Update.t_intTrainingHours.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intTrainingCost.value.length;i++){
temp=document.frmDirector201Update.t_intTrainingCost.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
var digits=".0123456789"
var temp
if (document.frmDirector201Update.t_strVWName.value=="") {
alert("Please input name of organization!")
return false
} else if (document.frmDirector201Update.t_strVWAddress.value=="") {
alert("Please input address of organization!")
return false
} else if (document.frmDirector201Update.t_intVWHours.value=="") {
alert("Please input number of hours!")
return false
} else if (document.frmDirector201Update.t_strVWPosition.value=="") {
alert("Please input position/nature of work!")
return false
}

for (var i=0;i<document.frmDirector201Update.t_intVWHours.value.length;i++){
temp=document.frmDirector201Update.t_intVWHours.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
if (document.frmDirector201Update.t_strSurname.value=="") {
alert("Please input surname!")
return false
} else if (document.frmDirector201Update.t_strFirstname.value=="") {
alert("Please input first name!")
return false
} else if (document.frmDirector201Update.t_strMiddlename.value=="") {
alert("Please input middle name!")
return false
} else if (document.frmDirector201Update.t_intWeight.value=="") {
alert("Please input weight in kgs.!")
return false
} else if (document.frmDirector201Update.t_strResidentialAddress.value=="") {
alert("Please input residential!")
return false
} else if (document.frmDirector201Update.t_intZipCode1.value=="") {
alert("Please input resident zip code!")
return false
} else if (document.frmDirector201Update.t_strPermanentAddress.value=="") {
alert("Please input permanent address!")
return false
} else if (document.frmDirector201Update.t_intZipCode2.value=="") {
alert("Please input permanent zip code!")
return false
} else if (document.frmDirector201Update.t_strEmail.value=="") {
alert("Please input email!")
return false
}

for (var i=0;i<document.frmDirector201Update.t_intWeight.value.length;i++){
temp=document.frmDirector201Update.t_intWeight.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intZipCode1.value.length;i++){
temp=document.frmDirector201Update.t_intZipCode1.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intTelephone1.value.length;i++){
temp=document.frmDirector201Update.t_intTelephone1.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intZipCode2.value.length;i++){
temp=document.frmDirector201Update.t_intZipCode2.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intTelephone2.value.length;i++){
temp=document.frmDirector201Update.t_intTelephone2.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmDirector201Update.t_intMobile.value.length;i++){
temp=document.frmDirector201Update.t_intMobile.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td height="6" class="header"></td>
                                </tr>
                                <tr> 
                                  <td> <form action="<? $PHP_SELF; ?>" name="frmDirector201Update" method="post">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          ...
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr> 
                                                <td width="30%" class="paragraph">Type 
                                                  of Profile : </td>
                                                <td width="70%"> <select name="t_strDirectorProfile" size="1" onChange="updateRequirement();">
                                                    <option>Select Personal Data 
                                                    ...</option>
                                                    <?
													if($t_strDirectorProfile=="Profile")
													{
													?>
													...
													?>
                                                    <? 
													if($t_strDirectorProfile=="Education")
													{
													?>
													...
													?>
                                                    <?
													if ($t_strDirectorProfile=="Examination")
													{
													?>
													...
													?>
                                                    <?
													if ($t_strDirectorProfile=="Children")
													{
													?>
													...
													?>
                                                    <?
													if ($t_strDirectorProfile=="Reference") 
													{
													?>
													...
													?>
                                                    <?
													if ($t_strDirectorProfile=="Voluntary") 
													{
													?>
                                                    <option value="Voluntary" selected>Voluntary Works</option>
                                                    <?
													} else {
													?>
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" height="25" class="paragraph"><strong> 
										...
										?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Number 
                                                  of Hours :</td>
                                                <td><input name="t_intTrainingHours" type="text" size="10" maxlength="4" onBlur="validateHours(this)"> 
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Cost 
                                                  :</td>
                                                <td><input name="t_intTrainingCost" type="text" size="15" maxlength="10" onBlur="validateCost(this)">
                                                  <span class="required"> * (write 
                                                  0 if not-applicable) </span></td>
                                              </tr>
                                              <tr> 
                                                ...
                                                <td><select name="t_dtmTrainingContractYear" size="1" onChange="updateList(t_dtmTrainingContractMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmTrainingContractDay')">
                                                    <?
													$objDirector201Update->comboYearOld(date('Y'));
												   	?>
                                                    ...
                                                    <?
													$objDirector201Update->comboMonth(date('n'));
													?>
                                                  </select> <select name="t_dtmTrainingContractDay" size="1">
                                                    <?
													$objDirector201Update->comboDay(date('j'));
													?>
                                                  </select> </td>
                                              </tr>
                                              <tr> 
...
?>
										...
										?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Ratings 
                                                  :</td>
                                                <td><input name="t_intExamRating" type="text" size="10" maxlength="4" onBlur="validateRate(this)">
                                                  % <span class="required">* </span></td>
                                              </tr>
                                              <tr> 
									   ...
									   ?>
										...
										?>
                                              ...
                                              <tr> 
                                                <td height="25" class="paragraph">License 
                                                  No. (if applicable) : </td>
                                                <td><input name="t_strLicenseNumber" type="text" id="t_strLicenseNumber" size="25" maxlength="50"> 
                                                </td>
                                              </tr>
                                              <tr> 
                                                <td height="25" class="paragraph">Date 
                                                  of Release : </td>
                                                <td><select name="t_dtmDateReleaseYear" size="1" id="t_dtmDateReleaseYear" onChange="updateList(t_dtmDateReleaseMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmDateReleaseDay')">
                                                    <?
										$objDirector201Update->comboYearOld(date('Y'));
									   ?>
                                                  </select> <select name="t_dtmDateReleaseMonth" size="1" id="t_dtmDateReleaseMonth" onChange="updateList(this.selectedIndex,t_dtmDateReleaseYear[t_dtmDateReleaseYear.selectedIndex].text,'t_dtmDateReleaseDay')">
                                                    <?
										$objDirector201Update->comboMonth(date('n'));
										?>
                                                  </select> <select name="t_dtmDateReleaseDay" size="1" id="t_dtmDateReleaseDay">
                                                    <?
										$objDirector201Update->comboDay(date('j'));
										?>
                                                  </select>
                                                  <input name="t_strRequestStatus" type="hidden" id="t_strRequestStatus7" value="<? echo "Filed Request"; ?>"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">&nbsp;</td>
                                                <td>&nbsp;</td>
										...
										?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Honors 
                                                  : </td>
                                                <td><input name="t_strHonors" type="text" size="60" maxlength="80"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph" height="25">Date 
                                                  From :</td>
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="31%" class="paragraph" height="25"><input name="t_strTaxRequestCode" type="hidden" id="t_strTaxRequestCode2" value="<? echo $t_strTaxRequestCode; ?>">
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Issued 
                                                  At : </td>
                                                <td><input name="t_strIssuedAt" type="text" size="25" maxlength="15"> 
									   ...
									   ?>
										...
										?>
                                                  ...
                                                  <input name="t_strRequestStatus" type="hidden" id="t_strRequestStatus5" value="<? echo "Filed Request"; ?>"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">&nbsp;</td>
                                                <td>&nbsp;</td>
                                          ...
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" class="paragraph" height="25"><strong> 
                                                  ...
                                                  <input name="t_strRefRequestCode" type="hidden" id="t_strRefRequestCode2" value="<? echo $t_strRefRequestCode; ?>">
                                                  Name :</td>
                                                <td width="70%"><input name="t_strRefName" type="text" size="50" maxlength="80"> 
                                                  <span class="required">*</span></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph" height="25">Address 
                                                  :</td>
                                                <td><input name="t_strRefAddress" type="text" size="50" maxlength="80"> 
                                                  <span class="required">*</span></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph" height="25">Telephone 
                                                  Number : </td>
                                                <td><input name="t_intRefTelephone" type="text" size="25" maxlength="12" onBlur="validateTelephone(this);">
                                                  <span class="required">*
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" class="paragraph" height="25"><input name="t_strChildRequestCode" type="hidden" id="t_strChildRequestCode2" value="<? echo $t_strChildRequestCode; ?>">
                                                  Name of Children :</td>
									   ...
									   ?>
                                                  ...
                                                  <select name="t_strChildBirthMonth" size="1" onChange="updateList(this.selectedIndex,t_strChildBirthYear[t_strChildBirthYear.selectedIndex].text,'t_strChildBirthDay')">
                                                    <?
										$objDirector201Update->comboMonth(date('n'));
										?>
											...
											?>
                                              ...
                                              <tr> 
                                                <td colspan="2"><div align="center"> 
                                                    <input name="Submit" type="submit" onClick="trapEntryVoluntary();return validateVoluntaryWorks()" value="Submit">
                                                    <input name="Reset" type="reset" value="Clear">
                                                  </div></td>
                                              </tr>
                                              <tr> 
                                          ...
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr> 
                                                      <td width="31%" class="paragraph" height="25"><input name="t_strProfileRequestCode" type="hidden" value="<? echo $t_strProfileRequestCode; ?>">
                                                        Surname : </td>
                                                    ...
                                                    <tr> 
                                                      <td width="31%" class="paragraph" height="25">First 
                                                        Name : </td>
                                                    ...
                                                    <tr> 
                                                      <td class="paragraph" height="25">Middle 
                                                        Name : </td>
										  	...
										  	$objDirector201Update->civilStatus("t_strCivilStatus", $row['civilStatus']);   
										  	?>
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                    ...
                                                    <tr> 
                                                      <td colspan="2" class="paragraph"><div align="center"><strong> 
                                                          ...
                                                          <input name="Submit" type="submit" onClick="return validateProfile()" value="Submit">
                                                          <input name="Reset" type="reset" value="Clear">
                                                        </div></td>
                                                    </tr>
                                                  </table></td>
