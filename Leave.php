...
To add and delete leave code & description to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Leave.php");   //Load database connection
$objLeave= new leaveType;   //Load leave function
$objLeave->addLeaveType($strEmpNmbr, $t_strLeaveCode, $t_strLeaveType, $t_intNumberOfDays, $Submit);   //Load addLeaveType function
$objLeave->editLeaveType($strEmpNmbr, $t_strLeaveCode, $t_strLeaveType, $t_intNumberOfDays, $Submit, $t_strOldLeaveCode);   //Load editLeaveType function
$strConfirm = $objLeave->deleteLeaveType($strEmpNmbr, $t_strLeaveCode, $t_strLeaveType, $t_intNumberOfDays, $Submit);   //Load deleteLeaveType function
?>
...
var temp
if (document.frmLeave.t_strLeaveCode.value=="") {
alert("Please input leave code!")
return false
} else if (document.frmLeave.t_strLeaveType.value=="") {
alert("Please input leave type!")
return false
} else if (document.frmLeave.t_intNumberOfDays.value=="") {
alert("Please input number of days!")
return false
}

for (var i=0;i<document.frmLeave.t_intNumberOfDays.value.length;i++){
temp=document.frmLeave.t_intNumberOfDays.value.substring(i,i+1)
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="102" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>LEAVE TYPE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr>
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('LeaveIndicator','','images/indicator1.jpg',1)"><img src="images/indicator1.jpg" alt="LeaveIndicator" name="LeaveIndicator" width="7" height="12" border="0"></a> 
                                    Leave Type </td>
                                </tr>
                                <tr> 
                                  <td height="22" class="radio"> <a href="http://dbmis.dost.gov.ph/hrmis/Holidayyear.php"> 
                                    </a><a href="Leavespecify.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('LeaveSpecifyIndicator','','images/indicator2.jpg',1)"><img src="images/indicator2.jpg" alt="Leave Specify Indicator" name="LeaveSpecifyIndicator" width="7" height="12" border="0"></a><a href="Leavespecify.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()"> 
                                    Specify Leave</a></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmLeave" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strLeaveCode; ?>, 
                                      <? echo $t_strLeaveType; ?> and <? echo $t_intNumberOfDays; ?> 
                                      ??? 
                                      <input name="t_strLeaveCode" type="hidden" value="<? echo $t_strLeaveCode; ?>">
								  ...
								  ?>
                                  <tr> 
                                    <td width="172" class="paragraph">Leave Code 
                                      :</td>
                                    <td width="382" colspan="3"> <input name="t_strLeaveCode" type="text" value="<? echo "$t_strLeaveCode"; ?>" size="20" maxlength="3" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Leave Type :</td>
                                    <td colspan="3"> <input name="t_strLeaveType" type="text" value="<? echo "$t_strLeaveType"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span>
<input name="t_strOldLeaveCode" type="hidden" value="<? echo "$t_strLeaveCode"; ?>"> 
                                    </td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Number of Days : </td>
                                    <td colspan="3"><input name="t_intNumberOfDays" type="text" value="<? echo $t_intNumberOfDays; ?>" size="10" maxlength="2" onBlur="validateNumber(this)">
                                      <span class="required"> * </span> 
                                  ...
                                  <?
								     ...
								     ?>
                                  <tr> 
                                    <td class="paragraph">Leave Code :</td>
                                    <td colspan="3"> <input name="t_strLeaveCode" type="text" size="20" maxlength="3" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Leave Type :</td>
                                    <td colspan="3"> <input name="t_strLeaveType" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Number of Days : </td>
                                    <td colspan="3"><input name="t_intNumberOfDays" type="text" size="10" maxlength="2" onBlur="validateNumber(this)">
                                      <span class="required"> * </span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"></td>
                                  </tr>
                                  <tr> 
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="18"> 
                                    <?php
									$objLeave->viewLeaveType($strEmpNmbr, $t_strLeaveCode, $t_strLeaveType, 			   $t_intNumberOfDays);   //Load viewLeaveType function
									?>
                                  </td>
                                </tr>
                              </table></td>
