...
To add, edit and delete Holiday to database.
----------------------------------------------------------------------
...
$arrEmpPersonal2 = $objHoliday->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objHoliday->addHoliday($strEmpNmbr, $t_strHolidayCode, $t_strHolidayName, $t_strHolidayMonth, $t_strHolidayDay, $t_strFixedHoliday, $t_strHolidayYear, $Submit);   //Load addHoliday function
$objHoliday->editHoliday($strEmpNmbr, $t_strHolidayCode, $t_strHolidayName, $t_strHolidayMonth, $t_strHolidayDay, $t_strFixedHoliday, $Submit, $t_strOldHolidayCode);   //Load editHoliday function
$strConfirm = $objHoliday->deleteHoliday($strEmpNmbr, $t_strHolidayCode, $t_strHolidayName, $t_strHolidayMonth, $t_strHolidayDay, $t_strFixedHoliday, $Submit);   //Load deleteHoliday function
?>
...
var temp
if (document.frmHoliday.t_strHolidayCode.value=="") {
alert("Please input holiday code!")
return false
} else if (document.frmHoliday.t_strHolidayName.value=="") {
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="26" class="header"><p>HOLIDAY</p>
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="#" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('HolidayIndicator','','images/indicator1.jpg',1); statusBar(); return true;" onClick="statusBar();"><img src="images/indicator1.jpg" alt="Holiday Indicator" name="HolidayIndicator" width="7" height="12" border="0"></a>Add 
                                    Holiday</td>
                                </tr>
                                <tr> 
                                  <td height="22" class="radio"> <a href="Holidayyear.php" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()"> 
                                    </a><a href="Holidayyear.php" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('HolidayYearIndicator','','images/indicator2.jpg',1); statusBar(); return true;" onClick="statusBar();"><img src="images/indicator2.jpg" alt="Holiday Year Indicator" name="HolidayYearIndicator" width="7" height="12" border="0"></a><a href="Holidayyear.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">View 
                                    Holiday</a> <a href="Holidayyear.php" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()"> 
                                    </a></td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr>
                            <td>
					<form action="<? $PHP_SELF; ?>" method="get" name="frmHoliday" onSubmit="return validate()">
							<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								?>
								<tr>
                                  <td class="titlebar">Are you sure you want to 
                                    delete <? echo $t_strHolidayCode; ?>, <? echo $t_strHolidayName; ?>, 
                                    <? 												$strMonthName = $objHoliday->intToMonthName($t_strHolidayMonth);											
echo $strMonthName; ?>
                                    and <? echo $t_strHolidayDay; ?>??? 
                                    <input name="t_strHolidayCode" type="hidden" id="t_strHolidayCode" value="<? echo $t_strHolidayCode; ?>">
                              ...
                              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<?
								   ...
								   {
								?>
                                  <td width="30%" class="paragraph">Holiday Code 
                                    : </td>
                                  <td colspan="3"> <input name="t_strHolidayCode" type="text" value="<? echo "$t_strHolidayCode"; ?>" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                </tr>
                                <tr> 
                                  <td class="paragraph">Holiday Name : </td>
                                  <td colspan="3"> <input name="t_strHolidayName" type="text" value="<? echo "$t_strHolidayName"; ?>" size="50" maxlength="30" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> </td>
                                </tr>
                                <tr> 
                                    ...
                                    <td width="9%"> 
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblHoliday ");
									    echo "<SELECT NAME=\"t_strHolidayMonth\" onChange=\"updateList(t_strHolidayMonth.selectedIndex,this[this.selectedIndex].text,'t_strHolidayDay')\">"; 
										$yyyymmdd = $t_strHolidayMonth;
                                        list($t_strHolidayMonth) = array(substr($yyyymmdd,0,3));
										$objHoliday->comboMonth($t_strHolidayMonth);
										echo "</SELECT>";
										?>
                                      <input name="t_strOldHolidayMonth" type="hidden" value="<? echo $t_strHolidayMonth; ?>"></td>
                                    <td width="14%" class="paragraph"> Holiday 
                                      Day : </td>
                                  <td width="47%">
                                    <?php 
										$result = mysql_query ("SELECT * FROM tblHoliday ");
									    echo "<SELECT NAME=\"t_strHolidayDay\" onFocus=\"updateList(t_strHolidayMonth.selectedIndex,this[this.selectedIndex].text,'t_strHolidayDay')\">"; 
										$yyyymmdd = $t_strHolidayDay;
                                        list($t_strHolidayDay) = array(substr($yyyymmdd,0,3));
										$objHoliday->comboDay($t_strHolidayDay);
										echo "</SELECT>";
										?>
                                    <input name="t_strOldHolidayDay" type="hidden" value="<? echo $t_strHolidayDay; ?>"></td>
                                </tr>
                                <tr> 
                                  <td class="paragraph">Fixed Holiday : </td>
                                    <td colspan="3"> 
									 ...
									 if($t_strFixedHoliday == "N")
									  ...
									  ?>
									  No
                                      <input name="t_strOldFixedHoliday" type="hidden" value="<? echo "$t_strFixedHoliday"; ?>">
                              ...
                              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr> 
                                  <td width="30%" class="paragraph">Holiday Code 
                                    : </td>
                                  <td colspan="3">
                                      <input name="t_strHolidayCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                </tr>
                                <tr> 
                                  <td class="paragraph">Holiday Name : </td>
                                  <td colspan="3">
                                      <input name="t_strHolidayName" type="text" size="50" maxlength="30" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> </td>
                                </tr>
                                <tr> 
                                    <td class="paragraph"> Holiday Month : </td>
                                  <td width="9%"><select name="t_strHolidayMonth" size="1" onChange="updateList(t_strHolidayMonth.selectedIndex,this[this.selectedIndex].text,'t_strHolidayDay')">
                                      <?
										$objHoliday->comboMonth($t_strHolidayMonth);
										?>
                                    </select></td>
                                    <td width="14%" class="paragraph"> Holiday 
                                      Day : </td>
                                  <td width="47%"><select name="t_strHolidayDay" size="1" onFocus="updateList(t_strHolidayMonth.selectedIndex,this[this.selectedIndex].text,'t_strHolidayDay')">
                                        <?
										$objHoliday->comboDay(t_strHolidayDay)
										?>
                                      </select>
                                ...
                                <tr> 
                                  <td class="paragraph">Fixed Holiday : </td>
                                  <td colspan="3"><input name="t_strFixedHoliday" type="radio" value="Y" checked>
                                      Yes 
                                      <input type="radio" name="t_strFixedHoliday" value="N">
                                      No 
                                ...
                                <tr> 
                                  <td class="paragraph">&nbsp;</td>
                                  <td colspan="3"><input name="Submit" type="submit" id="Submit" value="ADD"> 
                          ...
                          <tr>
                            <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objHoliday->viewHolidayFixed($strEmpNmbr, $t_strHolidayCode, $t_strHolidayName, $t_strHolidayMonth, $t_strHolidayDay, $t_strHolidayYear);   //Load viewHolidayFixed function
									?>
                                  </td>
                                </tr>
                              </table></td>
