<?php 
/* 
File Name: Directorvoluntarywork.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Employeevoluntarywork.php");
$objEmployee= new employeeVoluntaryWork;
                          ...
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="114"><p class="header">Voluntary 
                                      Works</p>
                                ...
                                <tr> 
                                  <td> 
                                    <? 
								$arrEmpVoluntaryWork=$objEmployee->viewVoluntaryWork($txtSearch, $optField, $p, $t_strVWName, $t_strVWAddress, $t_dtmVWDateFromMonth, $t_dtmVWDateFromDay, $t_dtmVWDateFromYear, $t_dtmVWDateToMonth, $t_dtmVWDateToDay, $t_dtmVWDateToYear,  $t_intVWHours, $t_strVWPosition, $Submit, $arrEmpPersonal["empNumber"]);  //View list of employee voluntary work
								?>
                                  </td>
                                </tr>
                                <tr> 
