                          ...
                          <tr>
                            <td> 
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr> 
                                  <td> <form name="frmEmpOB" method="post" action="EmpOB.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>">
                                      ...
                                      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
										...
										$objEmpOB->comboYear(date('Y'));
									   ?>
                                                  </select> <select name="cboMonthTo" onChange="updateList(this.selectedIndex,cboYearFrom[cboYearTo.selectedIndex].text,'cboDayTo')">
                                                    <?
										$objEmpOB->comboMonth(date('n'));
										?>
										...
										?>
										  ...
										  ?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" valign="middle" height="25">Time 
                                                  To :&nbsp;&nbsp;</td>
                                                <td><span class="paragraph"> Hours 
                                                  </span> 
                                                  <?
										  ...
										  ?>
                                              ...
                                              <tr> 
                                                ...
                                                <td> <input name="Submit" type="submit" value="Submit" onClick="trapEntryOB(txtPlace, 'place', txtPurpose, cboMonthFrom, cboMonthTo, cboDayFrom, cboDayTo, cboYearFrom, cboYearTo, cboHourFrom, cboHourTo, cboMinFrom, cboMinTo, cboSecFrom, cboSecTo, cboTimeFrom, cboTimeTo, t_strRequestStatus)"> 
