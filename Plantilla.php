<?php 
/* 
File Name: Plantilla.php
----------------------------------------------------------------------
Purpose of this file: 
To add, edit and delete plantilla to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Plantilla.php");   //Load database connection
$objPlantilla= new plantilla;   //Load plantilla function
$objPlantilla->addPlantilla($strEmpNmbr, $t_strItemNumber, $t_strPositionCode, $t_intAuthSalary, $t_intAuthSalaryYear, $t_intSalaryGrade, $t_intStepNumber, $Submit);   //Load addPlantilla function
$objPlantilla->editPlantilla($strEmpNmbr, $t_strItemNumber, $t_strPositionCode, $t_intAuthSalary, $t_intAuthSalaryYear, $t_intSalaryGrade, $t_intStepNumber, $Submit, $t_strOldItemNumber);   //Load editPlantilla function
$strConfirm = $objPlantilla->deletePlantilla($strEmpNmbr, $t_strItemNumber, $t_strPositionCode, $t_intAuthSalary, $t_intAuthSalaryYear, $t_intSalaryGrade, $t_intStepNumber, $Submit);   //Load deletePlantilla function
?>
...
var temp
if (document.frmPlantilla.t_strItemNumber.value=="") {
alert("Please input item number!")
return false
} else if (document.frmPlantilla.t_intAuthSalary.value=="") {
alert("Please input salary!")
return false
} else if (document.frmPlantilla.t_intSalaryGrade.value=="") {
alert("Please input salary grade!")
return false
}

for (var i=0;i<document.frmPlantilla.t_intAuthSalary.value.length;i++){
temp=document.frmPlantilla.t_intAuthSalary.value.substring(i,i+1)
...
for (var i=0;i<document.frmPlantilla.t_intSalaryGrade.value.length;i++){
temp=document.frmPlantilla.t_intSalaryGrade.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid salary grade !")
return false
      }
   }
...
function stepNumberRequirement()
{	
	// for combo stepNumber
	var strEmpNmbr = "<? echo $strEmpNmbr ?>";
	var t_strItemNumber = "<? echo $t_strItemNumber ?>";
	var t_strPositionCode = document.frmPlantilla.t_strPositionCode.value;
	var t_intStepNumber = document.frmPlantilla.t_intStepNumber.value;
	var t_intSalaryGrade = document.frmPlantilla.t_intSalaryGrade.value;
	var t_intAuthSalary = document.frmPlantilla.t_intAuthSalary.value;
	var t_intAuthSalaryYear = document.frmPlantilla.t_intAuthSalaryYear.value;
	var strSubmit = "<? echo $Submit; ?>";
	window.location = "Plantilla.php?strEmpNmbr="+strEmpNmbr+"&t_strItemNumber="+t_strItemNumber+"&t_strPositionCode="+t_strPositionCode+"&t_intStepNumber="+t_intStepNumber+"&t_intSalaryGrade="+t_intSalaryGrade+"&t_intAuthSalary="+t_intAuthSalary+"&t_intAuthSalaryYear="+t_intAuthSalaryYear+"&Submit="+strSubmit;

}

function salaryGradeRequirement()
{	
	// for combo salary grade
	var strEmpNmbr = "<? echo $strEmpNmbr ?>";
	var t_strItemNumber = "<? echo $t_strItemNumber ?>";
	var t_strPositionCode = document.frmPlantilla.t_strPositionCode.value;
	var t_intSalaryGrade = document.frmPlantilla.t_intSalaryGrade.value;
	...
	var t_intStepNumber = document.frmPlantilla.t_intStepNumber.value;
	var strSubmit = "<? echo $Submit; ?>";
	window.location = "Plantilla.php?strEmpNmbr="+strEmpNmbr+"&t_strItemNumber="+t_strItemNumber+"&t_strPositionCode="+t_strPositionCode+"&t_intSalaryGrade="+t_intSalaryGrade+"&t_intAuthSalary="+t_intAuthSalary+"&t_intAuthSalaryYear="+t_intAuthSalaryYear+"&t_intStepNumber="+t_intStepNumber+"&Submit="+strSubmit;
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td class="header"><p>PLANTILLA</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="get" name="frmPlantilla" onSubmit="return validate()">
                                  <?
							      if($strConfirm)
							      {
							      ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strItemNumber; ?>, 
                                      <? echo $t_strPositionCode; ?>, <? echo $t_intAuthSalary; ?> 
                                      and <? echo $t_intSalaryGrade; ?> ??? 
                                      <input name="t_strItemNumber" type="hidden" value="<? echo $t_strItemNumber; ?>"> 
                                  ...
                                  <tr> 
                                    <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td width="40%" class="paragraph">Salary 
                                            Grade Number :</td>
                                          <td width="60%"><select name="t_intSalaryGrade" size="1" onChange="salaryGradeRequirement();">
                                              <? 
										 $objPlantilla->comboSalaryGrade($strEmpNmbr, $t_intSalaryGrade); 
										  ?>
                                        ...
                                        <tr> 
                                          ...
                                          <td><select name="t_intStepNumber" size="1" onChange="stepNumberRequirement();">
                                              <? 
										 $objPlantilla->comboStepNumber($strEmpNmbr, $t_intStepNumber); 
										  ?>
                                            </select> <span class="required"> 
                                            *</span> </td>
                                        </tr>
                                  ...
                                  <tr> 
                                    <td width="40%" class="paragraph"> 
                                      <? 
											$t_intAuthSalary = $objPlantilla->authorizeSalary($t_intSalaryGrade, $t_intStepNumber); 
											?>
                                      Authorized Salary (per month) :</td>
                                    <td colspan="3"><input name="t_intAuthSalary" type="text" value="<? echo $t_intAuthSalary; ?>" size="20" maxlength="20" readonly> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph"> 
                                      <? 
											$t_intAuthSalaryYear = $objPlantilla->authorizeSalaryYear($t_intSalaryGrade, $t_intStepNumber); 
											?>
                                      Authorized Salary (per year) : </td>
                                    <td colspan="3"><input name="t_intAuthSalaryYear" type="text" value="<? echo $t_intAuthSalaryYear; ?>" size="20" maxlength="20" readonly> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3">&nbsp; </td>
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"><input name="t_strItemNumber" type="text" value="<? echo "$t_strItemNumber"; ?>" size="30" maxlength="20" onBlur="validateCharacter(this)"> 
                                      <span class="required"> 
                                  ...
                                  <tr> 
                                    <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td width="40%" class="paragraph">Salary 
                                            Grade Number :</td>
                                          <td width="60%"><select name="t_intSalaryGrade" size="1" id="t_intSalaryGrade" onChange="salaryGradeRequirement();">
                                              <? 
										 $objPlantilla->comboSalaryGrade($strEmpNmbr, $t_intSalaryGrade); 
										  ?>
                                            </select> <span class="required"> 
                                  ...
                                  <tr> 
                                    <td class="paragraph"> 
                                      <? 
											...
											?>
                                      Authorized Salary (per month) :</td>
                                    <td> <input name="t_intAuthSalary" type="text" value="<? echo $t_intAuthSalary; ?>" size="20" maxlength="20" readonly="readonly"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph"> 
                                      <? 
											...
											?>
                                      Authorized Salary (per year) : </td>
                                    <td><input name="t_intAuthSalaryYear" type="text" value="<? echo $t_intAuthSalaryYear; ?>" size="20" maxlength="20" readonly="readonly"></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3">&nbsp; </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Item Number : </td>
                                    <td width="60%"><input name="t_strItemNumber" type="text" onBlur="validateCharacter(this)" size="30" maxlength="20"> 
                                      <span class="required"> *</span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Position Code : </td>
                                    <td> <select name="t_strPositionCode" size="1">
                                        <? 
										 $objPlantilla->comboPositionCode($strEmpNmbr, $t_strPositionCode); 
										  ?>
                                      </select> <input name="t_strOldPositionCode" type="hidden" value="<? echo $t_strPositionCode; ?>"> 
                                      <span class="required"> 
                          ...
                          <tr> 
                            <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objPlantilla->viewPlantilla($strEmpNmbr, $t_strItemNumber, $t_strPositionCode, $t_intAuthSalary, $t_intAuthSalaryYear, $t_intSalaryGrade, $t_intStepNumber);   //Load viewPlantilla function
									?>
                                  </td>
                                </tr>
                              </table></td>
