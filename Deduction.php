...
To add and delete deduction code, description and type to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Deductioncode.php");   //Load database connection
$objDeduction= new deductionCode;   //Load deductionCode function
$objDeduction->addDeductionCode($strEmpNmbr, $t_strDeductionCode, $t_strDeductionAbb, $t_strDeductionDesc ,$t_strDeductionType, $Submit);   //Load addDeductionCode function
$objDeduction->editDeductionCode($strEmpNmbr, $t_strDeductionCode, $t_strDeductionAbb, $t_strDeductionDesc ,$t_strDeductionType, $Submit, $t_strOldDeductionCode);   //Load editDeductionCode function
$strConfirm = $objDeduction->deleteDeductionCode($strEmpNmbr, $t_strDeductionCode, $t_strDeductionAbb, $t_strDeductionDesc, $t_strDeductionType, $Submit);   //Load deleteDeductionCode function
?>
...
if (document.frmDeduction.t_strDeductionCode.value=="") {
alert("Please input deduction code!")
return false
} else if (document.frmDeduction.t_strDeductionAbb.value=="") {
alert("Please input abbreviation!")
return false
} else if (document.frmDeduction.t_strDeductionDesc.value=="") {
alert("Please input deduction description!")
return false
} else if (document.frmDeduction.t_strDeductionType.value=="") {
alert("Please input deduction type!")
return false
}
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="228" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="24" class="header"><p>DEDUCTION</p></td>
                          </tr>
                          <tr> 
                            <td height="26" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmDeduction" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strDeductionCode; ?>, 
                                      <? echo $t_strDeductionDesc; ?>, <? echo $t_strDeductionDesc; ?> 
                                      and <? echo $t_strDeductionType; ?> ??? 
                                      <input name="t_strDeductionCode" type="hidden" id="t_strDeductionCode" value="<? echo $t_strDeductionCode; ?>"></td>
                                  </tr>
                                  <tr> 
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Deduction 
                                      Code : </td>
                                    <td width="384" colspan="3"> <input name="t_strDeductionCode" type="text" id="t_strDeductionCode" value="<? echo "$t_strDeductionCode";  ?>" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td width="170" class="paragraph">Deduction 
                                      Abbreviation :</td>
                                    <td colspan="3"><input name="t_strDeductionAbb" type="text" value="<? echo "$t_strDeductionAbb";  ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Deduction Description 
                                      :</td>
                                    <td width="384" colspan="3"><input name="t_strDeductionDesc" type="text" value="<? echo "$t_strDeductionDesc";  ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Deduction Type :</td>
                                    <td colspan="3"> <input name="t_strDeductionType" type="text" value="<? echo "$t_strDeductionType";  ?>" size="20" maxlength="20" onBlur="validateCharacter(this)"> 
                                      <input type="hidden" name="t_strOldDeductionCode" value="<? echo "$t_strDeductionCode"; ?>"> 
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"> <input name="t_strDeductionCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Deduction Abbreviation 
                                      :</td>
                                    <td colspan="3"><input name="t_strDeductionAbb" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Deduction Description 
                                      :</td>
                                    <td colspan="3"><input name="t_strDeductionDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Deduction Type :</td>
                                    <td colspan="3"> <input name="t_strDeductionType" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)"> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objDeduction->viewDeductionCode($strEmpNmbr, $t_strDeductionCode, $t_strDeductionAbb, $t_strDeductionDesc ,$t_strDeductionType);   //Load viewDeductionCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
