<?php 
/* 
File Name: Chiefnotifyleave.php 
----------------------------------------------------------------------
...
*/
session_start();
require("../hrmis/class/Security.php");
...
$objChief->approvedLeaveRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_dtmStatusDate, $t_strRemarks, $Submit, $t_strOldRequestStatus, $t_strOldRemarks);  // approved employee/s leave request 
?>
                                ...
                                <tr> 
                                  <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td> 
                                          <?
										  $objChief->viewLeaveRequestForApproval($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $arrEmpPersonal['divisionCode']); //View list of employee/s request
										  ?>
                                        </td>
                                      </tr>
                                    </table></td>
                                          ...
                                          <td><table width="85%" border="1" align="center" cellpadding="0" cellspacing="0">
                                              <tr><td colspan="2">
												<div align="center">
												  ...
												  $intMonth = date("n");	
												  $intYear = date("Y");	
													$intVL = $objChief->getLeftSLVL($intMonth, $intYear, $t_strEmpNumber, "VL");
													
													if($intVL < 0)
													{
														$intVL = 0;
													}
													$intSL = $objChief->getLeftSLVL($intMonth, $intYear, $t_strEmpNumber, "SL");									  
													...
													$intPL = $objChief->accmltLeave($t_strEmpNumber, $intYear, "PL");
													$intFL = $objChief->accmltLeave($t_strEmpNumber, $intYear, "FL");													
												?>
