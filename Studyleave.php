                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="128" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>STUDY LEAVE</p></td>
                          </tr>
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									include("../hrmis/class/Studyleave.php");   //Load database connection
									$objStudyLeave= new studyLeave;   //Load studyLeave function
									$objStudyLeave->addStudyLeave($t_strStudyLeave, $t_intReportingDays, $Submit);   //Load addStudyLeave function
									$objStudyLeave->editStudyLeave($t_strStudyLeave, $t_intReportingDays, $Submit, $t_strOldStudyLeave);   //Load editStudyLeave function
									$strConfirm = $objStudyLeave->deleteStudyLeave($t_strStudyLeave, $t_intReportingDays, $Submit);   //Load deleteStudyLeave function
									?>
                                  </td>
                                </tr>
                              </table>
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="get" name="frmStudyLeave">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strStudyLeave; ?> 
                                      and <? echo $t_intReportingDays; ?> ??? 
                                      <input name="t_strStudyLeave" type="hidden" id="t_strStudyLeave" value="<? echo $t_strStudyLeave; ?>"></td>
                                  </tr>
                                  <tr> 
								  ...
								  ?>
                                  <tr> 
                                    <td width="170" class="paragraph">Study Leave 
                                      :</td>
                                    <td width="384" colspan="3"> <input name="t_strStudyLeave" type="text" id="t_strStudyLeave" value="<? echo "$t_strStudyLeave"; ?>" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Reporting Days :</td>
                                    <td colspan="3"> <input name="t_intReportingDays" type="text" id="t_intReportingDays" value="<? echo "$t_intReportingDays"; ?>" size="20" maxlength="10"> 
                                      <input name="t_strOldStudyLeave" type="hidden" id="t_strOldStudyLeave" value="<? echo "$t_strStudyLeave"; ?>"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                  ...
                                  <tr> 
                                    <td colspan="4" class="paragraph"><div align="center"> 
                                        <input name="Submit" type="submit" id="Submit" value="Submit" onClick="MM_validateForm('t_strStudyLeave','','R','t_intReportingDays','','RisNum');return document.MM_returnValue">
                                  ...
                                  <?
									 ...
									 ?>
                                  <tr> 
                                    <td class="paragraph">Study Leave :</td>
                                    <td colspan="3"> <input name="t_strStudyLeave" type="text" id="t_strStudyLeave" size="30" maxlength="50"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Reporting Days :</td>
                                    <td colspan="3"> <input name="t_intReportingDays" type="text" id="t_intReportingDays" size="20" maxlength="10"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="4" class="paragraph">&nbsp;</td>
                                  ...
                                  <tr> 
                                    <td colspan="4" class="paragraph"> <div align="center"> 
                                        <input name="Submit" type="submit" onClick="MM_validateForm('t_strStudyLeave','','R','t_intReportingDays','','RisNum');return document.MM_returnValue" value="ADD" >
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objStudyLeave->viewStudyLeave($t_strStudyLeave, $t_intReportingDays);   //Load viewStudyLeave function
									?>
                                  </td>
                                </tr>
                              </table></td>
