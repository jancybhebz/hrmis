<?php 
/* 
File Name: Directornotifyleave.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Directornotifyleave.php");
require("../hrmis/class/Attendance.php");
$objDirector = new directorNotifyLeave;
$objAttendance = new Attendance;
$arrEmpPersonal = $objDirector->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objDirector->approvedLeaveRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_dtmStatusDate, $t_strRemarks, $Submit, $t_strOldRequestStatus, $t_strOldRemarks);  // approved employee/s leave request (Directornotifyleave.php)
?>
<html><!-- InstanceBegin template="/Templates/Directornotificationtmplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/201over.jpg','images/notificationclick.jpg','images/requestsover.jpg','images/logout2.jpg'); history.forward();" onContextMenu="return false"><div align="center"> 
  ...
  <tr> 
    <td><table width="100%" height="426" border="0" align="center" cellpadding="0" cellspacing="0" id="INNERTBL">
                      ...
                      <td height="228" valign="top"><table width="95%" height="313" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td height="313" valign="top"><table width="100%" height="338" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="NAVTBL">
                                <tr> 
                                  <td height="338" valign="top"> <table width="95%" height="54" border="0" align="center" cellpadding="0" cellspacing="0" id="NAVTBL">
                                      <tr> 
		...
		$intCntTO = $arrCntTO['countTO'];
								...
								printf("<a href=\"Directornotifyleave.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">");
								printf("{&nbsp;");
								...
								if ($intCntOB >= 1){ 
								// if number of entries is more than 1
								printf("<a href=\"DirectornotifyOB.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">");
								printf("{&nbsp;");
								...
								if ($intCntTO >= 1){ 
								// if number of entries is more than 1
								printf("<a href=\"DirectornotifyTO.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">");
								printf("{&nbsp;");
								...
								?>
                                      ...
                                      <tr> 
                                        <td height="1"><img src="images/reminders.jpg" width="93" height="32"></td>
                                      </tr>
                                      <tr> 
                                        <td height="1"> 
                                          <?
										printf("&nbsp;<a href=\"DirectorEmpPresent.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">Employees Present</a>");
										?>
                                        </td>
                                      </tr>
									  <tr> 
                                        <td height="1"> 
                                          <?
										printf("&nbsp;<a href=\"DirectorEmpAbsent.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">Employees Absent</a>");
										?>
                                        </td>
                                      </tr>                                      <tr> 
									  <tr> 
                                        <td height="1"> 
                                          <?
										printf("&nbsp;<a href=\"DirectorEmpOnLeave.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">Employees On Leave</a>");
										?>
                                        </td>
                                      </tr>                                      <tr> 
									  <tr> 
                                        <td height="1"> 
                                          <?
										printf("&nbsp;<a href=\"DirectorEmpOnObToTt.php?strEmpNmbr=$strEmpNmbr\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">Employees On OB/TO/TT</a>");
										?>
                                        </td>
                                      </tr>                                      <tr> 
                                        <td height="2">&nbsp;</td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="23" class="header"><p>LEAVE REQUEST 
                                      for approval</p></td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td> 
                                          <?
										  	$intMonth = date("n", strtotime($t_dtmDateFrom));
										  	$intYear = date("Y", strtotime($t_dtmDateFrom));
											$strMonthFull = $objAttendance->intToMonthFull($intMonth);
										  
										  $objDirector->viewChiefLeaveRequestForApproval($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails);  //View list of employee/s request (Directornotifyleave.php)
										  ?>
                                        </td>
                                      </tr>
                                    </table></td>
                                ...
                                <tr> 
                                  <td> <form action="<? $PHP_SELF; ?>" method="post" name="frmLeaveRequest4Approval">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td> 
                                            <? if ($Submit == 'View') 
								  ...
								  ?>
                                        ...
                                        <tr> 
                                          <td><table width="85%" border="1" align="center" cellpadding="0" cellspacing="0">
                                              <tr><td colspan="2">
								  <div align="center"> Certify Leave Credits as 
                                                    of <? echo $strMonthFull." ".$intYear?><br>
								  <?
									$intVL = $objAttendance->getLeftSLVL($intMonth, $intYear, $t_strEmpNumber, "VL");
									...
									$intSL = $objAttendance->getLeftSLVL($intMonth, $intYear, $t_strEmpNumber, "SL");									  
									...
									$intPL = $objAttendance->accmltLeave($t_strEmpNumber, $intYear, "PL");
									$intFL = $objAttendance->accmltLeave($t_strEmpNumber, $intYear, "FL");
								  ?>
								  ...
								  <br>
											  ...
											  <tr> 
                                                <td width="27%" class="paragraph">Request 
                                                  ID :</td>
                                                <td width="73%"><input name="t_strRequestID" type="text" readonly value="<? echo $t_strRequestID; ?>" size="20" maxlength="6"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Employee 
                                                  Number :</td>
                                                <td><input name="t_strEmpNumber" type="text" readonly value="<? echo $t_strEmpNumber; ?>" size="20" maxlength="15"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Employee 
                                                  Name :</td>
                                                <td><input name="t_strSurname" type="text" readonly value="<? echo $t_strFirstname . " " . $t_strSurname; ?>" size="45" maxlength="80"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Type of 
                                                  Leave :</td>
                                                <td><input name="t_strTypeOfLeave" type="text" readonly value="<? echo $t_strTypeOfLeave; ?>" size="20" maxlength="255"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Specific 
                                                  Leave :</td>
                                                <td><input name="t_strSpecificLeave" type="text" readonly value="<? echo $t_strSpecificLeave; ?>" size="20" maxlength="10"></td>
                                              </tr>
                                              <tr> 
                                              ...
                                              <tr>
                                                <td class="paragraph">Reason :</td>
                                                <td><textarea name="t_strReason" cols="30" readonly rows="2"><? echo $t_strReason; ?></textarea></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph"> Request 
                                                  Status :</td>
...
<input name="t_dtmStatusDate" type="hidden" value="<? echo date ("Y-m-d"); ?>"> 
                                              ...
                                              <tr> 
                                                <td class="paragraph">Remarks 
                                                  : </td>
                                                <td> <textarea name="t_strRemarks" cols="30" rows="3"></textarea></td>
                                              </tr>
                                              <tr> 
                                                <td colspan="2" class="paragraph">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td colspan="2" class="paragraph"><div align="center"> 
