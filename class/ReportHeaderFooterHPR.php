<?
/* 
File Name: ReportHeaderFooterHPR.php 
----------------------------------------------------------------------
Purpose of this file: 
header footer of hazard pay report
----------------------------------------------------------------------
...
class ReportHeaderFooterHPR extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,5,'HAZARD PAY ATTENDANCE SHEET', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(110,5,'NUMBER OF LEAVE', 0, 0, 'C',1);
		$this->Cell(30,5,'', 0, 1, 'C',1);

		$this->Cell(40,5,'EMPLOYEE NAME', 0, 0, 'C',1);
		$this->Cell(55,5,'HALF DAY', 0, 0, 'C',1);
		$this->Cell(55,5,'WHOLE DAY', 0, 0, 'C',1);		
		$this->Cell(30,5,'TOTAL LEAVE', 0, 0, 'C',1);
		$this->Ln(7);
	}
