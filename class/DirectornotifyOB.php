<?php 
/* 
File Name: DirectornotifyOB.php (class folder)
----------------------------------------------------------------------
...
class DirectornotifyOB extends General
{

   function directorNotifyOB() 
   {
      include("../hrmis/class/Connect.php");   //the dbase connection
   }

	function viewChiefOBRequestForApproval($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRemarks) //View list of employee/s request (DirectornotifyOB.php)
    {
	...
	function approvedOBRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks, $t_dtmStatusDate, $Submit, $t_strOldRequestStatus, $t_strOldRemarks)  // approved employee/s leave request (DirectornotifyOB.php)
    {
      if ($Submit == 'View')
	  {
