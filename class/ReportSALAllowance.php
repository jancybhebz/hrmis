...
class ReportSALAllowance extends FPDF
{
	var $intPageNo;
	var $blnGrandTotal = 0;
	var $strMonthName, $intMonth;
	var $strDivisionName;
	var $curSAPageTotal, $curLAPageTotal, $curSALAPageTotal;
	var $curSAGrandTotal, $curLAGrandTotal, $curSALAGrandTotal;	
	var $intWorkDays;
	...
	{	
		...
		$this->Cell(0,5,'PAYROLL REGISTER FOR SUBSISTENCE and LAUNDRY ALLOWANCE', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(25,5,'SUBSISTENCE', 0, 0, 'C',1);
		$this->Cell(20,5,'LAUNDRY', 0, 0, 'C',1);		
		$this->Cell(15,5,'ABSENCE', 0, 0, 'C',1);
		$this->Cell(25,5,'NET', 0, 0, 'C',1);
		$this->Cell(0,5,'SIGNATURE', 0, 0, 'L',1);		
		$this->Ln(7);
	}
	...
	{	
		...
		$this->Cell(25,5,number_format($this->curSAPageTotal, 2,".",","), 0, 0, 'R',1);
		$this->Cell(20,5,number_format($this->curLAPageTotal, 2,".",","), 0, 0, 'C',1);		
		$this->Cell(15,5,'', 0, 0, 'C',1);
		$this->Cell(25,5,number_format($this->curSALAPageTotal, 2,".",","), 0, 0, 'C',1);
		...
		{		
			...
			$this->SetFont('Arial','B',9);
			$this->Cell(65,5,'Project Total:', 0, 0, 'R',1);
			$this->Cell(25,5,number_format($this->curSAGrandTotal, 2,".",","), 0, 0, 'R',1);
			$this->Cell(20,5,number_format($this->curLAGrandTotal, 2,".",","), 0, 0, 'C',1);		
			$this->Cell(15,5,'', 0, 0, 'C',1);
			$this->Cell(25,5,number_format($this->curSALAGrandTotal, 2,".",","), 0, 0, 'C',1);
			$this->Cell(0,5,'', 0, 1, 'L',1);
			$this->Ln(10);
		}
	...
	function setGrandTotal($t_intSAGrandTotal, $t_intLAGrandTotal, $t_intSALAGrandTotal)
	{
		$this->blnGrandTotal = 1;
		$this->curSAGrandTotal = $t_intSAGrandTotal;
		$this->curLAGrandTotal = $t_intLAGrandTotal;		
		$this->curSALAGrandTotal = $t_intSALAGrandTotal;		
	}
	...
	function setPageTotal($t_intSAPageTotal, $t_intLAPageTotal, $t_intSALAPageTotal)
	{
		$this->curSAPageTotal = $t_intSAPageTotal;
		$this->curLAPageTotal = $t_intLAPageTotal;		
		$this->curSALAPageTotal = $t_intSALAPageTotal;				
	}
