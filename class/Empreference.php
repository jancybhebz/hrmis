<?php 
/* 
File Name: Empreference.php (class folder)
----------------------------------------------------------------------
	...
	function viewReference($txtSearch, $optField, $p, $t_strRefName, $t_strRefAddress, $t_strRefTelephone, $t_strEmpNumber) //View list of reference
    {
	     ...
	     if (!$row=mysql_fetch_array($viewResults))
		 {
		    echo "Database is empty";
			 ...
			 echo "<tr class=\"title\"><td width=\"22%\" class=\"border\">NAME</td>";
			...
			// echo "<td width=\"10%\" class=\"border\">&nbsp;</td></tr>";
			 do 
			 {
				...
				//echo "<td class=\"border\"><a href=\"Reference.php?txtSearch=$txtSearch&optField=$optField&p=$p&t_strRefName=$t_strRefName&t_strRefAddress=$t_strRefAddress&t_strRefTelephone=$t_strRefTelephone&t_strEmpNumber=$t_strEmpNumber&Submit=Edit\">Edit</a></td>"; 
				//echo "<td class=\"border\"><a href=\"Reference.php?txtSearch=$txtSearch&optField=$optField&p=$p&t_strRefName=$t_strRefName&t_strRefAddress=$t_strRefAddress&t_strRefTelephone=$t_strRefTelephone&Submit=Delete\">Delete</a></td></tr>";
