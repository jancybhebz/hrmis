<?
/* 
File Name: ReportHeaderFooterTR.php 
----------------------------------------------------------------------
Purpose of this file: 
header footer tardy report
----------------------------------------------------------------------
...
class ReportHeaderFooterTR extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,5,'TARDY REPORT', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(60,5,'', 0, 0, 'L',1);
		$this->Cell(70,5,'TOTAL', 0, 0, 'C',1);
		$this->Cell(20,5,'# OF TARDY ', 0, 0, 'C',1);		
		$this->Cell(0,5,'# OF ', 0, 1, 'C',1);
		
		$this->Cell(60,5,'EMPLOYEE NAME', 0, 0, 'L',1);
		$this->Cell(40,5,'Tardy/Undertime', 0, 0, 'C',1);
		$this->Cell(30,5,'Excess', 0, 0, 'C',1);
		$this->Cell(20,5,'& UND', 0, 0, 'C',1);
		$this->Cell(0,5,'ABSENT', 0, 1, 'C',1);
	...
	function Footer()
	{
		...
		$this->Ln(10);		$this->SetFont('Arial','B',10);
