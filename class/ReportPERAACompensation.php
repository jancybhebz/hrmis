...
class ReportPERAACompensation extends FPDF
{
	var $intPageNo;
	var $blnGrandTotal = 0;
	var $strMonthName, $intYear;
	var $strDivisionName;
	var $curPERAPageTotal, $curACPageTotal, $curNetPageTotal;
	var $intPERAGrandTotal, $intACGrandTotal, $intNetGrandTotal;
	var $intWorkDays;
	...
	{	
		...
		$this->Cell(0,5,'PAYROLL REGISTER FOR PERA AND ADDITIONAL COMPENSATION ALLOWANCE', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(30,5,'PERA', 0, 0, 'C',1);
		$this->Cell(32,5,'AC', 0, 0, 'C',1);
		$this->Cell(32,5,'NET', 0, 0, 'C',1);				
		$this->Ln(7);
	}
	...
	{	
		...
		$this->SetFillColor(200,200,200);
		$this->SetFont('Arial','B',9);
		$this->Cell(80,5,'Page Total:', 0, 0, 'R',1);
		$this->Cell(30,5,number_format($this->curPERAPageTotal, 2,".",","), 0, 0, 'R',1);
		$this->Cell(32,5,number_format($this->curACPageTotal, 2,".",","), 0, 0, 'R',1);
		$this->Cell(32,5,number_format($this->curNetPageTotal, 2,".",","), 0, 0, 'R',1);
		...
		if($this->blnGrandTotal)
		{
			...
			$this->SetFont('Arial','B',9);
			$this->Cell(80,5,'Grand Total:', 0, 0, 'R',1);
			$this->Cell(30,5,number_format($this->intPERAGrandTotal, 2,".",","), 0, 0, 'R',1);
			$this->Cell(32,5,number_format($this->intACGrandTotal, 2,".",","), 0, 0, 'R',1);
			$this->Cell(32,5,number_format($this->intNetGrandTotal, 2,".",","), 0, 0, 'R',1);
			$this->Cell(0, 5, '', 0, 1, 'R', 1);		
		}
		$this->Ln(10);
	...
	function setGrandTotal($t_intPERAGrandTotal, $t_intACGrandTotal, $t_intNetGrandTotal)
	{
		$this->blnGrandTotal = 1;
		$this->intPERAGrandTotal = $t_intPERAGrandTotal;
		$this->intACGrandTotal = $t_intACGrandTotal;
		$this->intNetGrandTotal = $t_intNetGrandTotal;
	}
	...
	function setPageTotal($t_curPERAPageTotal, $t_curACPageTotal, $t_curNetPageTotal)
	{
		$this->curPERAPageTotal = $t_curPERAPageTotal;
		$this->curACPageTotal = $t_curACPageTotal;
