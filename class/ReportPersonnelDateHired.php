<?
/* 
File Name: ReportPersonnelDateHired.php (class folder)
----------------------------------------------------------------------
...
class ReportPersonnelDateHired extends FPDF
{
	...
	//  Page Header
	function ReportPersonnelDateHired()
	{
		$this->FPDF('P', 'mm', 'A4');
	}
	...
	{	
		...
		$this->Cell(0,6,'List of employees by Date Hired', 0, 0, 'C');
		$this->Ln(5);
		...
		$this->Cell(90,10,"DATE HIRED",LBR,0,C,1);
		$this->Ln(10);
