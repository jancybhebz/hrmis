<?
/* 
File Name: ReportPersonnelAge.php (class folder)
----------------------------------------------------------------------
...
class ReportPersonnelAge extends FPDF
{
	...
	{	
		...
		$this->Cell(0,6,"List of Employees' Age", 0, 0, 'C');
		$this->Ln(5);
		$this->Cell(0,6,'CY' . " '" . date("Y"), 0, 0, 'C');
		$this->Ln(10);
