<?
/* 
File Name: ReportHeaderFooterLWOP.php 
----------------------------------------------------------------------
Purpose of this file: 
Header footer of leave without pay
----------------------------------------------------------------------
...
class ReportHeaderFooterLWOP extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,5,'LEAVE WITHOUT PAY', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(0,5,'LEAVE WITHOUT PAY', 0, 1, 'C',1);		
		$this->Cell(60,5,'EMPLOYEE NAME', 0, 0, 'L',1);
		$this->Cell(40,5,'Vacation', 0, 0, 'C',1);
		$this->Cell(40,5,'Sick', 0, 0, 'C',1);
		$this->Cell(40,5,'Total', 0, 0, 'C',1);
		$this->Ln(7);
	}
