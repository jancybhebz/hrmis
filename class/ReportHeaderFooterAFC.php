...
----------------------------------------------------------------------
Date of Revision: September 30, 2004
----------------------------------------------------------------------
Copyright Notice:
...
class ReportHeaderFooterAFC extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,5,'ATTENDANCE TO FLAG CEREMONY', 0, 1, 'C');
		...
		$this->Cell(100,5,'NAME', 1, 0, 'L',1);
		
		for ($intCtr = 0; $intCtr < 6; $intCtr++)
		{
			$this->Cell(30,5,$this->arrMonth[$intCtr], 1, 0, 'C',1);
		}
