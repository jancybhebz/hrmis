<?
/* 
File Name: ReportPersonnelRetiree.php (class folder)
----------------------------------------------------------------------
...
class ReportPersonnelRetiree extends FPDF
{
	...
	//  Page Header
	function ReportPersonnelRetiree()
	{
		$this->FPDF('P', 'mm', 'A4');
	}
	...
	{	
		...
		$this->Cell(0,6,'List of employees by Date Retired', 0, 0, 'C');
		$this->Ln(5);
		...
		$this->Cell(90,10,"DATE RETIRED",LBR,0,C,1);
		$this->Ln(10);
