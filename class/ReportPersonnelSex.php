<?
/* 
File Name: ReportPersonnelSex.php (class folder)
----------------------------------------------------------------------
...
class ReportPersonnelSex extends FPDF
{
	...
	{	
		...
		$this->Cell(0,6,'List of Employees by Sex', 0, 0, 'C');
		$this->Ln(5);
