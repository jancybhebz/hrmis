<?php 
/* 
File Name: Directornotifyleave.php (class folder)
----------------------------------------------------------------------
...
class Directornotifyleave extends General
{

   function directorNotifyLeave() 
   {
      include("../hrmis/class/Connect.php");   //the dbase connection
   }

	function viewChiefLeaveRequestForApproval($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails) //View list of employee/s request (Directornotifyleave.php)
    {
	...
	function approvedLeaveRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_dtmStatusDate, $t_strRemarks, $Submit, $t_strOldRequestStatus, $t_strOldRemarks)  // approved employee/s leave request (Directornotifyleave.php)
    {
      if ($Submit == 'View')
	  {
