<?
/* 
File Name: ReportPositionDescriptionForm.php (class folder)
----------------------------------------------------------------------
...
class ReportPositionDescriptionForm extends FPDF
{
	...
	//  Page Header
	function ReportPositionDescriptionForm()
	{
		$this->FPDF('P', 'mm', 'A4');
	}
...
*/	
	...
	{
		$objOfficeInfo = mysql_query("SELECT tblAgency.abbreviation, tblAgency.agencyName, tblAgency.address, tblAgency.telephone FROM tblAgency");
