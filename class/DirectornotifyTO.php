...
class DirectornotifyTO extends Attendance
{

   function directornotifyTO() 
   {
      include("../hrmis/class/Connect.php");   //the dbase connection
   }

	function viewApproval($strEmpNmbr) //View list of employee/s request (DirectornotifyOB.php)
    {
		 $viewResults = mysql_query("SELECT tblEmpRequest.requestID, 
								...
								WHERE tblEmpRequest.statusDate = '0000-00-00' 
									...
									AND tblEmpRequest.requestStatus = 'Filed Request' 
