<?php 
/* 
File Name: Empnotify.php (class folder)
----------------------------------------------------------------------
...
class Empnotify extends General
{
   ...
   function empNotify() 
   {
	...
	function deleteEmployeeStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks, $Submit) //Delete employee status of request
   	{
	   if ($Submit == 'Delete') 
	   {
	...
	function viewEmployeeStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks) //View list of employee/s request (Chiefnotifyleave.php)
    {
		 ...
		 if (!$row=mysql_fetch_array($viewResults))
		 {
			...
			do 
			{
				...
				echo "<td><a href=\"Empnotify.php?strEmpNmbr=$strEmpNmbr&t_strRequestID=$t_strRequestID&t_strRequestCode=$t_strRequestCode&t_strRequestStatus=$t_strRequestStatus&t_strEmpNumber=$t_strEmpNumber&t_strRemarks=$t_strRemarks&Submit=Delete\" onMouseOver=\"statusBar(); return true;\" onClick=\"statusBar();\" onMouseUp=\"statusBar()\" onFocus=\"statusBar()\">Delete</a></td></tr>";
				echo "<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>";
