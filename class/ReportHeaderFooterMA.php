<?
/* 
File Name: ReportHeaderFooterMA.php 
----------------------------------------------------------------------
Purpose of this file: 
header footer of meating attendance
----------------------------------------------------------------------
...
class ReportHeaderFooterMA extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,5,'MEETING ATTENDANCE REPORT', 0, 1, 'C');
		$this->Ln(1);
		...
		$this->Cell(30,5,'EMPLOYEE #', 0, 0, 'L',1);
		$this->Cell(60,5,'EMPLOYEE NAME', 0, 0, 'L',1);
		$this->Cell(30,5,'DATE', 0, 0, 'L',1);
		$this->Cell(60,5,'TITLE OF MEETING', 0, 0, 'L',1);
		$this->Ln(7);
	}
