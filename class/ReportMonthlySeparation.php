...
class ReportMonthlySeparation extends FPDF 
{
	...
	//Page header
	function ReportMonthlySeparation()
	{
	...
	function Header()
	{
		...
		$this->Cell(0,0,"MONTHLY REPORT ON SEPARATION",0,0,C);
		$this->Ln(5);
		...
		$this->Ln(10);
		$this->Cell(215,0,"INSTRUCTION:       This   report   shall be submitted to  the  Civil",0,0,R);
		$this->Ln(5);
		$this->Cell(216,0,"Service  Commission  not  later  than  the  5th",0,0,R);
		$this->Ln(5);
		$this->Cell(216,0,"day of the succeeding  month.  All employees",0,0,R);
		$this->Ln(5);
		$this->Cell(216,0,"separated during the month shall be reported.",0,0,R);
		$this->Ln(2);
		...
		$this->Cell(60,$Title,"POSITION",0,0,C);
		...
		$this->Cell(50,$Title,"REMARKS",0,0,C);
		$this->Ln(5);
		$this->Cell(70,25," ",1,0,C);                    //  Name                    
		$this->Cell(30,25,"BIRTH",1,0,C);                //  Date of birth
		$this->Cell(60,25,"TITLE",1,0,C);                //  Position title
		$this->Cell(40,25,"APPOINTMENT",1,0,C);          //  Status of appointment
		$this->Cell(25,25,"GRADE",1,0,C);                //  Salary Grade
		$this->Cell(30,25,"SEPARATION",1,0,C);           //  Mode of Separation
		$this->Cell(30,25,"DATE OF",1,0,C);              //  Effectivity Date Of Appointment
		$this->Cell(50,25,"(state basis of",1,0,C);               //  Remarks
		$this->Ln(5);
		$this->Cell(70,$Title," ",0,0,C);                    //  Name
		$this->Cell(30,$Title,"(yyyy/mm/dd)",0,0,C);           //  Date of birth
		$this->Cell(60,$Title,"(per DBM's pal)",0,0,C);           //  Position title
		$this->Cell(40,$Title,"(state whether",0,0,C);       //  Status of appointment
		$this->Cell(25,$Title," ",0,0,C);                    //  Salary Grade
		$this->Cell(30,$Title,"(state whether",0,0,C);       //  Mode of Separation
		$this->Cell(30,$Title,"APPOINTMENT",0,0,C);          //  Effectivity Date Of Appointment
		$this->Cell(50,$Title,"from RA-7430)",0,0,C);             //  Remarks
		$this->Ln(5);
		$this->Cell(70,$Title," ",0,0,C);                    //  Name
		$this->Cell(30,$Title," ",0,0,C);                    //  Date of birth
		$this->Cell(60,$Title," ",0,0,C);                 //  Position title
		$this->Cell(40,$Title,"Perm/Temp/Casual",0,0,C);     //  Status of appointment
		$this->Cell(25,$Title," ",0,0,C);                    //  Salary Grade
		$this->Cell(30,$Title,"retired/resigned",0,0,C);     //  Mode of Separation
		$this->Cell(30,$Title,"(yyyy/mm/dd)",0,0,C);           //  Effectivity Date Of Appointment
