...
class Position extends PreviousDayYr
{
	...
	elseif ($Submit == "Submit"){ 
		...
		$t_strContractEndDate = "0000-00-00";
		...
		/*$objInsertToServiceRec = "INSERT INTO tblServiceRecord(empNumber,serviceFromDate, positionCode, salary ,stationAgency,appointmentCode)
  			     				   VALUES('$t_strEmpNumber', '$t_strEffectiveDate', '$t_strPositionCode','$t_intActualSalary', '$t_strPlaceOfAssignment','$t_strAppointmentCode')";		
		...
		if($totalNumRows!= 0) //change of position & across the board salary adjustments				
		{
