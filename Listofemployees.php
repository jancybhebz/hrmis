...
include("../hrmis/class/Listofemployees.php");
$objEmployee = new listOfEmployees;
                    ...
                    <tr> 
                      <td height="339"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="23" class="header"> <p>LIST OF EMPLOYEES</p></td>
                          </tr>
                          <tr>
                          ...
                          <tr> 
                            <td><table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="25%" class="alterrow">Employee Number</td>
                                  <td width="50%" class="alterrow">Name of Employee</td>
                                </tr>
                                <tr> 
                                  <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr class="td"> 
                                  <td colspan="2"> 
                                    <? $objEmployee->viewListOfEmployees($strEmpNmbr, 15, $p);   //view list of employee
								?>
