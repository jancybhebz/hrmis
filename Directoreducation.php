<?php 
/* 
File Name: Directoreducation.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Employeeeducation.php");
$objEmployee= new employeeEducation;
