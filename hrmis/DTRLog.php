...
if ($txtEmpNmbr != "")
{
	$strMsg = $objLog->checkEmpNmbr($txtEmpNmbr);
}
if ($txtEmpNmbr != "" && $txtPsswrd != "")
{
	$strLogMsg = $objLog->logDTR($txtEmpNmbr, $txtPsswrd, $txtTime, $dtmDate);
	$strMsg = $strLogMsg;
}
?>
<?php
...
function pageBehave()
{
	...
	var strMsg = "<? echo $strMsg?>";
	var strNoEmpNmbr = "<? echo $txtEmpNmbr?>";
	if(strLogMsg)
	{		
		if(strLogMsg.search("password") == -1)
		{
			setTimeout("window.location=('DTRLog.php')", 3000);   //invalid login and login confirmation
		}   //refreshes the page after 3 minutes
		else
		{
			document.frmLog.txtPsswrd.focus();   //wrong password the cursor focus on txtPsswrd
		}
	}
	...
	{
		document.frmLog.txtEmpNmbr.focus();   //wrong employee number the cursor focus on txtEmpNmbr
	}
	else
	{
		document.frmLog.txtPsswrd.focus();   //employee number confirmed and picture appears
	}   //the cursor focus on txtPsswrd
}
...
<div align="center">
  <table height="550" width="750" border="0" cellpadding="0" cellspacing="0" class="background">
    <!--DWLayoutTable-->
    <tr> 
	<td width="60" height="550" rowspan="5" valign="top"><img src="images/sidebar.jpg"></td>
      <td colspan="3" align="center" valign="middle" height="50" class="date"><? echo date("F d, Y");?></td>
    </tr>
    <tr> 
      <td colspan="3" align="center" valign="middle" height="50" class="time">
	  <div id="ClockTime">
	  <? echo(clockTimeString($gDate));?>
	  </div>
	  </td>
    </tr>
	<tr><td colspan="3" align="center" valign="middle" height="50" class="errmsg"><? echo $strMsg;?></td></tr>
    <tr> 
	  <form action="DTRLog.php" method="post" name="frmLog">
	  <td width="70" height="300"></td>
      <td width="210" align="left" valign="middle"> <span class="txtlabel">Employee 
        No.: </span> <br> <input name="txtEmpNmbr" type="text" size="5" class="textbox" onBlur="checkEmpNmbr();" value="<? echo $txtEmpNmbr;?>"> 
        <br><br><span class="txtlabel">Password: </span> <br> <input name="txtPsswrd" type="password" maxlength="5" size="5" class="textbox">
		<input name="txtTime" type="hidden">
		<br><br><input type="image" src="images/inbutton.jpg" name="btnEmply" onClick="getClockTime();"><br><br>

		<input type="image" src="images/dtrpresent.jpg" onClick="window.open('EmployeeIn.php','_blank','toolbar=no,location=no,directories=no,status=0,menubar=0,scrollbars=1,resizable=0,width=600,height=400')">
		<input type="image" src="images/dtrabsent.jpg" onClick="window.open('EmployeeAbsent.php','_blank','toolbar=no,location=no,directories=no,status=0,menubar=0,scrollbars=1,resizable=0,width=600,height=400')">
		<input type="image" src="images/dtrleave.jpg" onClick="window.open('EmployeeOnLeave.php','_blank','toolbar=no,location=no,directories=no,status=0,menubar=0,scrollbars=1,resizable=0,width=600,height=400')">
		<input type="image" src="images/dtrob.jpg" onClick="window.open('EmployeeOBTOTT.php','_blank','toolbar=no,location=no,directories=no,status=0,menubar=0,scrollbars=1,resizable=0,width=600,height=400')">
		</td>
	  </form>
      <td width="210" valign="center" align="left"><img src="EmployeeImage.php?strEmpNmbr=<? echo $txtEmpNmbr;?>" width="192" height="192"><br><br><br></td>
    </tr>
	<tr><td colspan="3" height="100" align="center" valign="top" class="name">
