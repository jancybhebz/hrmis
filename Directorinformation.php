<?php 
/* 
File Name: Directorinformation.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Employeeinformation.php");
$objEmployee= new employeeInformation;
                          ...
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td><p class="header">PERSONAL INFORMATION</p>
