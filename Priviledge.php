                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="99%" height="176" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>PRIVILEDGE LEAVE</p></td>
                          </tr>
                          <tr> 
                            <td height="150" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td colspan="3" class="paragraph">Priviledge Leave :</td>
                                  <td width="409"> <input name="priviledgeLeave" type="text" id="priviledgeLeave" size="30" maxlength="30"> 
                                  </td>
                                </tr>
                                <tr> 
                                  <td colspan="3" class="paragraph">Priviledge Leave Type : </td>
                                  <td> <input name="priviledgeLeaveType" type="text" id="priviledgeLeaveType" size="50" maxlength="50"> 
                                  </td>
                                </tr>
                                <tr> 
