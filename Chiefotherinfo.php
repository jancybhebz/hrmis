...
----------------------------------------------------------------------
Date of Revision: March 24, 2004 (Version 2.0.0)
----------------------------------------------------------------------
Copyright Notice:
...
?>
<html><!-- InstanceBegin template="/Templates/Personalchieftmplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
function openPrint() { 
	...
	strPage = "Chiefindex.php?strEmpNmbr="+strEmpNmbr+"&t_strUserLevel="+t_strUserLevel+"&t_strUserPermission="+t_strUserPermission+"&t_strAccessPermission="+t_strAccessPermission;
