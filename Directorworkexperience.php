<?php 
/* 
File Name: Directorworkexperience.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Employeeworkexperience.php");
$objEmployee= new employeeWorkExperience;
                          ...
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="157"><p class="header">work experience</p>
                                    ...
                                    <hr> 
                                    <? 
								$arrEmpService=$objEmployee->viewServiceRecords($txtSearch, $optField, $p, $t_dtmServiceFromDate, $t_dtmServiceToDate, $t_strPositionCode, $t_strAppointmentCode, $t_strStationAgency, $t_intSalary, $arrEmpPersonal["empNumber"]); //View list of service records 
								?>
                                  </td>
                                </tr>
                              </table>
