...
include("../hrmis/class/Examtype.php");   //Load database connection
$objExamCode= new examCode;   //Load examCode function
$objExamCode->addExamCode($strEmpNmbr, $t_strExamCode, $t_strExamDesc, $t_strExamType, $Submit);   //Load addExamCode function
$objExamCode->editExamCode($strEmpNmbr, $t_strExamCode, $t_strExamDesc, $t_strExamType, $Submit, $t_strOldExamCode);   //Load editExamCode function
$strConfirm = $objExamCode->deleteExamCode($strEmpNmbr, $t_strExamCode, $t_strExamDesc, $t_strExamType, $Submit);   //Load deleteExamCode function
?>
...
function validateCharacter(field) 
{
	...
	if (ok == "no") {
	alert("Invalid entry!  Spaces are not allowed! \n Only characters, numbers, dash and slash are accepted!");
	field.focus();
	field.select();
    }
}
...
var temp
if (document.frmExamType.t_strExamCode.value=="") {
alert("Please input exam code!")
return false
} else if (document.frmExamType.t_strExamDesc.value=="") {
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>EXAM TYPE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmExamType" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      ...
                                      and <? echo $t_strExamDesc; ?> ??? 
                                      <input name="t_strExamCode" type="hidden" id="t_strExamCode" value="<? echo $t_strExamCode; ?>"></td>
                                  </tr>
                                  <tr> 
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Exam Code 
                                      :</td>
                                    <td width="384" colspan="3"> <input name="t_strExamCode" type="text" readonly value="<? echo "$t_strExamCode";?>" size="20" maxlength="20" onBlur="validateCharacter(this)"> 
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Exam Description :</td>
                                    <td colspan="3"> <input name="t_strExamDesc" type="text" value="<? echo "$t_strExamDesc";?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)"> 
                                      <span class="required"> *</span> <input name="t_strOldExamCode" type="hidden" value="<? echo "$t_strExamCode";?>"> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Exam Type :</td>
                                    <td colspan="3"><select name="t_strExamType">
                                        <? 
										if ($t_strExamType == 'None')
										{
										?>
										...
										?>
                                        <? 
										if ($t_strExamType == 'CS-Professional')
										{
										?>
											<option value="CS-Professional" selected>CS-Professional</option>
										<? 
										} else { 
										?>
										...
										?>
                                        <? 
										if ($t_strExamType == 'RA-1080')
										{
										?>
											<option value="RA-1080" selected>RA-1080</option>
										<? 
										} else { 
										?>
                                  ...
                                  <?
								   ...
								   ?>
                                  <tr> 
                                    <td class="paragraph">Exam Code :</td>
                                    <td colspan="3"> <input name="t_strExamCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)"> 
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Exam Description :</td>
                                    <td colspan="3"> <input name="t_strExamDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required">*</span> <span class="required"> 
                                      </span> </td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Exam Type :</td>
                                    <td colspan="3"><select name="t_strExamType">
										<option value="none">None</option>
										<option value="CS-Prof.">CS-Professional</option>
										<option value="RA-1080">RA-1080</option>
 										<option value="Scholar">Scholar</option>
                                     </select> 
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objExamCode->viewExamCode($strEmpNmbr, $t_strExamCode, $t_strExamDesc, $t_strExamType);   //Load viewExamCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
