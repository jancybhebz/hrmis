...
include("../hrmis/class/Chiefreport.php");
$objEmpReport = new chiefReport;
...
function reportRequirement()
{
	...
	var strEmpData = document.frmChiefReport.t_strEmpReport.value;
	
	window.location = "Chiefreport.php?strEmpNmbr="+strEmpNmbr+"&t_strEmpReport="+strEmpData;
}
                    ...
                    <tr> 
                      <td height="338"> <!-- InstanceBeginEditable name="Body" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td>
							<form action="<? $PHP_SELF; ?>" method="post" name="frmChiefReport">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
...
?>
                                  ...
                                  <tr> 
                                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                          <td width="35%" class="paragraph"><input name="t_strD" type="hidden" id="t_strD">
                                            Month : </td>
                                          <td width="16%"> <select name="t_dtmDTRMonth" size="1">
                                              <?
													$objEmpReport->comboMonth(t_dtmDTRMonth);
													?>
                                            </select> </td>
                                          ...
                                          <td width="41%"> <select name="t_dtmDTRYear" size="1">
                                              <?
													$objEmpReport->comboYear(t_dtmDTRYear);
												   	?>
                                            </select>
                                    ...
                                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="16%"> <select name="t_dtmPayslipMonth" size="1">
                                              <?
													$objEmpReport->comboMonth(t_dtmPayslipMonth);
													?>
                                            </select> </td>
                                          <td width="8%" class="paragraph">Year 
                                            : </td>
                                          <td width="41%"> <select name="t_dtmPayslipYear" size="1">
                                              <?
													$objEmpReport->comboYear(t_dtmPayslipYear);
												   	?>
                                            </select>
                                    ...
                                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="16%"> <select name="t_dtmCECMonth" size="1">
                                              <?
													$objEmpReport->comboMonth(t_dtmCECMonth);
													?>
                                            </select> </td>
                                          <td width="8%" class="paragraph">Year 
                                            : </td>
                                          <td width="41%"> <select name="t_dtmCECYear" size="1">
                                              <?
													$objEmpReport->comboYear(t_dtmCECYear);
												   	?>
                                            </select>
