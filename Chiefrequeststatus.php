<?php 
/* 
File Name: Chiefrequeststatus.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Chiefrequeststatus.php");
$objChief = new chiefRequestStatus;
$arrEmpPersonal = $objChief->checkGetEmpNmbr("Employee", $strEmpNmbr);

$objChief->deleteChiefStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks, $Submit); //Delete chief status of request
?>
                                      ...
                                      <tr> 
                                        <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? 
										  $objChief->viewChiefStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks);  //View list of approved employee/s request 
										   ?>
                                              </td>
                                            </tr>
                                          </table></td>
