<?
/* 
File Name: ChiefEmpOnLeave.php 
----------------------------------------------------------------------
Purpose of this file: 
To view the employees on leave in the office under the chief.
----------------------------------------------------------------------
                      ...
                      <td height="338"> <!-- InstanceBeginEditable name="Body" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr height="30" valign="middle" class="header">
							...
							<tr>
							<td width="20%"></td>
							<td width="40%" height="20"><a href="ChiefEmpOnLeave.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=name" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Employee Name</a></td>
							<td width="30%" height="20"><a href="ChiefEmpOnLeave.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=leave" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Leave</a></td>
							<td width="10%"></td>
							</tr>
							<?
							$objLog->getEmpLeaveForNow($strOrder, 10, $p, $strDvsnCode);
							?>
