<?php 
/* 
File Name: Personaleducation.php
----------------------------------------------------------------------
...
$objEmployee->addEducation($strEmpNmbr, $t_strEmpNumber, $t_strLevelCode, $t_strSchoolName, $t_strCourse, $t_intUnits, $t_dtmSchoolFromMonth, $t_dtmSchoolFromDay, $t_dtmSchoolFromYear, $t_dtmSchoolToMonth, $t_dtmSchoolToDay, $t_dtmSchoolToYear, $t_strHonors, $Submit);   //Add employee educational attainment
$objEmployee->editEducation($strEmpNmbr, $txtSearch, $optField, $p, $strLetter, $t_strEmpNumber, $t_strLevelCode, $t_strSchoolName, $t_strCourse, $t_intUnits, $t_dtmSchoolFromMonth, $t_dtmSchoolFromDay, $t_dtmSchoolFromYear, $t_dtmSchoolToMonth, $t_dtmSchoolToDay, $t_dtmSchoolToYear, $t_strHonors, $Submit, $t_strOldSchoolName, $t_strOldLevelCode, $t_dtmOldSchoolFromMonth, $t_dtmOldSchoolFromDay, $t_dtmOldSchoolFromYear, $t_dtmOldSchoolToMonth, $t_dtmOldSchoolToDay, $t_dtmOldSchoolToYear);   //Edit employee educational attainment
$strConfirm=$objEmployee->deleteEducation($strEmpNmbr, $t_strEmpNumber, $t_strLevelCode, $t_strSchoolName, $t_strCourse, $t_intUnits, $t_dtmSchoolFromMonth, $t_dtmSchoolFromDay, $t_dtmSchoolFromYear, $t_dtmSchoolToMonth, $t_dtmSchoolToDay, $t_dtmSchoolToYear, $t_strHonors, $Submit); //Delete employee educational attainment
?>
...
function validateHonor(field) 
{
	var valid = "ABCDEFGHIJKLMNOPQRSTUVWXYZ'+ +'abcdefghijklmnopqrstuvwxyz12345'+-+'"
	var ok = "yes";
	var temp;
	for (var i=0; i<field.value.length; i++) {
	temp = "" + field.value.substring(i, i+1);
	...
	if (ok == "no") {
	alert("Invalid entry!  Only characters, numbers from 1 to 5 and dash are accepted!");
	field.focus();
	field.select();
    }
}
...
var temp
if (document.frmEducation.t_strLevelCode.value=="") {
alert("Please input level description!")
return false
} else if (document.frmEducation.t_strSchoolName.value=="") {
alert("Please input school name!")
return false
} else if (document.frmEducation.t_intUnits.value=="") {
                    ...
                    <tr> 
                      <td height="339"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td><p class="header">EDUCATIONAL BACKGROUND</p>
                              ...
                              <hr>
                              <? 
								$arrEmpEducation=$objEmployee->viewEducation($strEmpNmbr, $txtSearch, $optField, $p, $strLetter, $t_strLevelCode, $t_strSchoolName, $t_strCourse, $t_intUnits, $t_dtmSchoolFromMonth, $t_dtmSchoolFromDay, $t_dtmSchoolFromYear, $t_dtmSchoolToMonth, $t_dtmSchoolToDay, $t_dtmSchoolToYear, $t_strHonors, $arrEmpPersonal["empNumber"]);  //View list of employee educational attainment								
								?>
                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form method="post" action="<? $PHP_SELF; ?>" name="frmEducation" onSubmit="return validate()">
                                  <tr> 
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr> 
								  ...
								  ?>
                                        <tr> 
                                          <td width="770" colspan="3" class="titlebar">Are 
                                            ...
                                            ??? 
                                            <input name="t_strLevelCode" type="hidden" value="<? echo $t_strLevelCode; ?>">
									...
									?>
                                      ...
                                      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td width="21%" class="paragraph"><input name="t_strEmpNumber" type="hidden" value="<? echo $arrEmpPersonal['empNumber']; ?>">
										...
										do {
											...
											{
												print "<OPTION VALUE=\"".$row["levelCode"]."\" selected>".$row["levelDesc"]."\r";
											}
										  print "<OPTION VALUE=\"".$row["levelCode"]."\">".$row["levelDesc"]."\r";
                                        ...
                                        <tr> 
                                          ...
                                          <td colspan="3"> <input name="t_strSchoolName" type="text" value="<? echo "$t_strSchoolName"; ?>" size="60" maxlength="80" onBlur="validateCharacter(this)"> 
                                            <input name="t_strOldSchoolName" type="hidden" id="t_strOldSchoolName" value="<? echo "$t_strSchoolName"; ?>">
                                            <span class="required"> *</span> </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Course :</td>
                                          <td colspan="3"> <input name="t_strCourse" type="text" value="<? echo "$t_strCourse"; ?>" size="50" maxlength="50" onBlur="validateCharacter(this)">
                                            <span class="required">* (write n-a 
                                            if not-applicable)</span> </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Units Earned :</td>
                                          <td colspan="3"> <input name="t_intUnits" type="text" value="<? echo "$t_intUnits"; ?>" size="20" maxlength="6" onBlur="validateUnit(this)">
                                            <span class="required">* (write 0 
                                            if not-applicable)</span> </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Honors :</td>
                                          <td colspan="3"> <input name="t_strHonors" type="text" value="<? echo "$t_strHonors"; ?>" size="60" maxlength="80" onBlur="validateHonor(this)"> 
                                          </td>
                                        </tr>
                                        <tr> 
										...
										echo "<SELECT NAME=\"t_dtmSchoolFromYear\" onChange=\"updateList(t_dtmSchoolFromMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmSchoolFromDay')\">\r";
										$yyyymmdd = $t_dtmSchoolFromDate;
                                        list($t_dtmSchoolFromYear) = array(substr($yyyymmdd,0,4));
										$objEmployee->comboYearOld($t_dtmSchoolFromYear);
										echo "</SELECT>\r";
										?>
                                            <input name="t_dtmOldSchoolFromYear" type="hidden" value="<? echo "$t_dtmSchoolFromYear"; ?>"><?php 
										$result = mysql_query ("SELECT * FROM tblEmpSchool");
									    echo "<SELECT NAME=\"t_dtmSchoolFromMonth\" onChange=\"updateList(this.selectedIndex,t_dtmSchoolFromYear[t_dtmSchoolFromYear.selectedIndex].text,'t_dtmSchoolFromDay')\">"; 
										$yyyymmdd = $t_dtmSchoolFromDate;
                                        list($t_dtmSchoolFromMonth) = array(substr($yyyymmdd,5,2));
										$objEmployee->comboMonth($t_dtmSchoolFromMonth);
										echo "</SELECT>";
										?>
                                            <input name="t_dtmOldSchoolFromMonth" type="hidden" value="<? echo "$t_dtmSchoolFromMonth"; ?>"> 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblEmpSchool");
										echo "<SELECT NAME=\"t_dtmSchoolFromDay\">\r";
										$yyyymmdd = $t_dtmSchoolFromDate;
                                        list($t_dtmSchoolFromDay) = array(substr($yyyymmdd,8,2));
										$objEmployee->comboDay($t_dtmSchoolFromDay);
										echo "</SELECT>\r";
										?>
                                            <input name="t_dtmOldSchoolFromDay" type="hidden" value="<? echo "$t_dtmSchoolFromDay"; ?>"> 
                                             
                                            <input name="t_dtmOldSchoolFromDate" type="hidden" value="<? echo "$t_dtmSchoolFromDate"; ?>"> 
                                          </td>
                                          ...
                                          <td width="32%"> 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblEmpSchool");
										echo "<SELECT NAME=\"t_dtmSchoolToYear\" onChange=\"updateList(t_dtmSchoolToMonth.selectedIndex,this[this.selectedIndex].text,'t_dtmSchoolToDay')\">\r";
										$yyyymmdd = $t_dtmSchoolToDate;
                                        list($t_dtmSchoolToYear) = array(substr($yyyymmdd,0,4));
										$objEmployee->comboYearOld($t_dtmSchoolToYear);
										echo "</SELECT>\r";
										?>
                                            <input name="t_strOldSchoolToYear" type="hidden" value="<? echo "$t_dtmSchoolToYear"; ?>"><?php 
										$result = mysql_query ("SELECT * FROM tblEmpSchool");
									    echo "<SELECT NAME=\"t_dtmSchoolToMonth\" onChange=\"updateList(this.selectedIndex,t_dtmSchoolToYear[t_dtmSchoolToYear.selectedIndex].text,'t_dtmSchoolToDay')\">"; 
										$yyyymmdd = $t_dtmSchoolToDate;
                                        list($t_dtmSchoolToMonth) = array(substr($yyyymmdd,5,2));
										$objEmployee->comboMonth($t_dtmSchoolToMonth);
										echo "</SELECT>";
										?>
                                            <input name="t_dtmOldSchoolToMonth" type="hidden" value="<? echo "$t_dtmSchoolToMonth"; ?>"> 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblEmpSchool");
										echo "<SELECT NAME=\"t_dtmSchoolToDay\">\r";
										$yyyymmdd = $t_dtmSchoolToDate;
                                        list($t_dtmSchoolToDay) = array(substr($yyyymmdd,8,2));
										$objEmployee->comboDay($t_dtmSchoolToDay);
										echo "</SELECT>\r";
										?>
                                            <input name="t_dtmOldSchoolToDay" type="hidden" value="<? echo "$t_dtmSchoolToDay"; ?>"> 
                                             
                                            <input name="t_strOldSchoolToDate" type="hidden" value="<? echo "$t_dtmSchoolToDate"; ?>">
                                            <input name="strEmpNmbr" type="hidden" id="strEmpNmbr" value="<? echo $strEmpNmbr;?>"> 
                                          </td>
                                        </tr>
                                        <tr> 
										...
										?>
                                        <tr> 
                                          <td width="21%" class="paragraph"> Level 
                                            Description : </td>
                                          <td colspan="3"> 
                                            <?php 
										$result = mysql_query ("SELECT levelCode, levelDesc FROM tblEducationalLevel");
                                        ...
                                        <tr> 
                                          <td class="paragraph">School Name :</td>
                                          <td colspan="3"> <input name="t_strSchoolName" type="text" size="60" maxlength="80" onBlur="validateCharacter(this)">
                                            <span class="required"> *</span> </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Course :</td>
                                          <td colspan="3"> <input name="t_strCourse" type="text" size="50" maxlength="50" onBlur="validateCharacter(this)">
                                            <span class="required">* (write n-a 
                                            if not-applicable)</span> </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Units Earned :</td>
                                          <td colspan="3"> <input name="t_intUnits" type="text" id="t_intUnits" size="20" maxlength="6" onBlur="validateUnit(this)">
                                            <span class="required"> * (write 0 
                                            if not-applicable)</span></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Honors :</td>
                                          <td colspan="3"> <input name="t_strHonors" type="text" size="60" maxlength="80" onBlur="validateHonor(this)"> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Date From :</td>
