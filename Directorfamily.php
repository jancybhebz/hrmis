...
include("../hrmis/class/Employeefamily.php");
$objEmployee= new employeeFamily;
                      ...
                      <td height="312"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td><p class="header">FAMILY BACKGROUND</p>
                                      ...
                                      <tr> 
                                        <td><table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          ...
                                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? $objEmployee->viewParent($txtSearch, $optField, $p, $t_strFatherName, $t_strMotherName, $t_strParentAddress, $arrEmpPersonal["empNumber"]);  //View list of employee children information 
									?>
                                              </td>
                                            </tr>
                                          </table>
                                          ...
                                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? $objEmployee->viewSpouse($txtSearch, $optField, $p, $t_strSpouse, $t_strSpouseWork, $t_strSpouseBusName, $t_strSpouseBusAddress, $t_intSpouseTelephone, $arrEmpPersonal["empNumber"]);  //View list of employee's spouse information
										?>
                                              </td>
                                            </tr>
                                          </table>
                                          ...
                                          <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              ...
                                              <td width="94%" valign="middle" class="note">CHILDREN 
                                                INFORMATION </td>
                                            </tr>
                                          </table>
