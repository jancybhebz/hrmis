<?
/* 
File Name: DirectorEmpOnLeave.php 
----------------------------------------------------------------------
Purpose of this file: 
To view employees on leave.
----------------------------------------------------------------------
                      ...
                      <td height="338"> <!-- InstanceBeginEditable name="Body" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr height="30" valign="middle" class="header">
                            <td colspan="4">EMPLOYEES ON LEAVE FOR THE DAY</td>
                          </tr>
							<tr>
							<td width="20%"></td>
							<td width="40%" height="20"><a href="DirectorEmpOnLeave.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=name" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Employee Name</a></td>
							<td width="30%" height="20"><a href="DirectorEmpOnLeave.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=leave" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Leave</a></td>
							<td width="10%"></td>
							</tr>
							<?
