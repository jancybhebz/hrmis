...
include("../hrmis/class/Projectcode.php");   //Load database connection
$objProject= new project;   //Load project function
$objProject->addProjectCode($strEmpNmbr, $t_strProjectCode, $t_strProjectDesc, $Submit);   //Load addProjectCode function
$objProject->editProjectCode($strEmpNmbr, $t_strProjectCode, $t_strProjectDesc, $Submit, $t_strOldProjectCode);   //Load editProjectCode function
$strConfirm = $objProject->deleteProjectCode($strEmpNmbr, $t_strProjectCode, $t_strProjectDesc, $Submit);   //Load deleteProjectCode function
?>
...
function validateCharacter(field) 
{
	...
	if (ok == "no") {
	alert("Invalid entry!  Spaces are not allowed! \n Only characters, period and dash are accepted!");
	field.focus();
	field.select();
    }
}
...
var temp
if (document.frmProject.t_strProjectCode.value=="") {
alert("Please input project code!")
return false
} else if (document.frmProject.t_strProjectDesc.value=="") {
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="175" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="26" class="header"><p>PROJECT CODE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmProject" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strProjectCode; ?> 
                                      and <? echo $t_strProjectDesc; ?> ??? 
                                      <input name="t_strProjectCode" type="hidden" value="<? echo $t_strProjectCode; ?>">
								  ...
								  ?>
                                  <tr> 
                                    <td width="171" class="paragraph">Project 
                                      Code :</td>
                                    <td width="383" colspan="3"> <input name="t_strProjectCode" type="text" value="<? echo "$t_strProjectCode"; ?>" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Project Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strProjectDesc" type="text" value="<? echo "$t_strProjectDesc"; ?>" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span>
<input name="t_strOldProjectCode" type="hidden" value="<? echo "$t_strProjectCode"; ?>">
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"> <input name="t_strProjectCode" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Project Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strProjectDesc" type="text" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objProject->viewProjectCode($strEmpNmbr, $t_strProjectCode, $t_strProjectDesc);   //Load viewProjectCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
