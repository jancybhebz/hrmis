...
function validateTaxRange(field) 
{
...
var temp
if (document.frmTaxRange.taxBase.value=="") {
alert("Please input tax base!")
return false
} else if (document.frmTaxRange.taxDeduction.value=="") {
alert("Please input tax deduction!")
return false
} else if (document.frmTaxRange.taxFactor.value=="") {
alert("Please input tax factor!")
return false
} else if (document.frmTaxRange.taxableFrom.value=="") {
alert("Please input taxable from!")
return false
} else if (document.frmTaxRange.taxableTo.value=="") {
alert("Please input taxable to!")
return false
}

for (var i=0;i<document.frmTaxRange.taxBase.value.length;i++){
temp=document.frmTaxRange.taxBase.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid tax base !")
return false
      }
   }

for (var i=0;i<document.frmTaxRange.taxDeduction.value.length;i++){
temp=document.frmTaxRange.taxDeduction.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid tax deduction !")
return false
      }
   }

for (var i=0;i<document.frmTaxRange.taxFactor.value.length;i++){
temp=document.frmTaxRange.taxFactor.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid tax factor !")
return false
      }
   }

for (var i=0;i<document.frmTaxRange.taxableFrom.value.length;i++){
temp=document.frmTaxRange.taxableFrom.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid taxable from !")
return false
      }
   }

for (var i=0;i<document.frmTaxRange.taxableTo.value.length;i++){
temp=document.frmTaxRange.taxableTo.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid taxable to !")
return false
      }
   }
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="24" class="header"><p>TAX RANGE</p></td>
                          </tr>
                          <form action="<?php $PHP_SELF; ?>" method="get" name="frmTaxRange" onSubmit="return validate()" >
                            <?
								if($Submit2 == "Delete")
								{
								?>
                            <tr> 
                              <td colspan="3" class="titlebar">Are you sure you 
                                want to delete this tax range??? 
                                <input name="taxBase" type="hidden" value="<? echo "$taxBase"; ?>"> 
                                <input name="taxDeduct" type="hidden" id="taxDeduct" value="<? echo "$taxDeduction"; ?>"> 
                                <input name="taxFactor" type="hidden" id="taxFactor" value="<? echo "$taxFactor"; ?>"> 
                                <input name="taxableFrom" type="hidden" id="taxableFrom" value="<? echo "$taxableFrom"; ?>"> 
                                <input name="taxableTo" type="hidden" id="taxableTo" value="<? echo "$taxableTo"; ?>"> 
                            ...
                            <?
								...
								?>
                            <tr> 
                              <td colspan="7" class="paragraph">Tax Base :</td>
                              <td colspan="3"> <input name="taxBase" type="text" id="taxBase" onBlur="validateTaxRange(this)" value="<? echo"$taxBase";?>" size="30" maxlength="30">
                                <span class="required"> * </span></td>
                            </tr>
                            <tr> 
                              <td height="21" colspan="7" class="paragraph">Tax 
                                Deduction :</td>
                              <td colspan="3"> <input name="taxDeduction" type="text" size="30" maxlength="30" value="<? echo"$taxDeduct";?>" onBlur="validateTaxRange(this)">
                                <span class="required"> * </span> </td>
                            </tr>
                            <tr> 
                              <td colspan="7" class="paragraph">Factor :</td>
                              <td colspan="3"> <input name="taxFactor" type="text" size="30" maxlength="30" value="<? echo"$taxFactor";?>" onBlur="validateTaxRange(this)">
                                <span class="required"> * </span> </td>
                            </tr>
                            <tr> 
                              <td colspan="7" class="paragraph">Taxable FROM :</td>
                              <td width="158"> <input name="taxableFrom" type="text" size="20" maxlength="20" value="<? echo"$taxableFrom";?>" onBlur="validateTaxRange(this)">
                                <span class="required"> * </span> </td>
                              <td width="44"> T O :</td>
                              <td width="231"> <input name="taxableTo" type="text" size="20" maxlength="20" value="<? echo"$taxableTo";?>" onBlur="validateTaxRange(this)">
                                <span class="required"> * </span>
<input name="taxBase1" type="hidden" value="<? echo $taxBase; ?>"> 
                                <input name="strEmpNmbr" type="hidden" value="<? echo "$strEmpNmbr"; ?>"> 
                              </td>
                            </tr>
                            <tr> 
                              <td colspan="10" class="paragraph">&nbsp;</td>
                            </tr>
                            <tr> 
                              <td colspan="10" class="paragraph"><div align="center"> 
                            ...
                            <? } else  {
 								?>
                            <tr> 
                              <td height="131" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td colspan="7" class="paragraph">Tax Base 
                                      :</td>
                                    <td colspan="3"> <input name="taxBase" type="text" id="taxBase" onBlur="validateTaxRange(this)" size="30" maxlength="30">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td height="21" colspan="7" class="paragraph">Tax 
                                      Deduction :</td>
                                    <td colspan="3"> <input name="taxDeduction" type="text" size="30" maxlength="30" onBlur="validateTaxRange(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="7" class="paragraph">Factor :</td>
                                    <td colspan="3"> <input name="taxFactor" type="text" size="30" maxlength="30" onBlur="validateTaxRange(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="7" class="paragraph">Taxable 
                                      FROM :</td>
                                    <td width="158"> <input name="taxableFrom" type="text" size="20" maxlength="20" onBlur="validateTaxRange(this)">
                                      <span class="required"> * </span> </td>
                                    <td width="44"> T O :</td>
                                    <td width="231"> <input name="taxableTo" type="text" size="20" maxlength="20" onBlur="validateTaxRange(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="10" class="paragraph"><input name="strEmpNmbr" type="hidden" value="<? echo "$strEmpNmbr"; ?>"></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="10" class="paragraph"><div align="center"> 
                        ...
                        <table width="99%" height="45" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY" dwcopytype="CopyTableCell">
                          <tr> 
                            <td height="18" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="18"> 
                                    <?php
include("../hrmis/class/TaxPhilhealth.php");   //Load taxrange functions
$objTaxRange = new TaxPhilhealth;
$objTaxRange->addTaxRange($strEmpNmbr, $taxBase, $taxDeduction, $taxFactor, $taxableFrom, $taxableTo, $Submit2, $taxBase1);
$objTaxRange->viewTaxRange($strEmpNmbr);
?>
                                  </td>
                                </tr>
                              </table>
