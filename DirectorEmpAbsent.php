<?
/* 
File Name: DirectorEmpAbsent.php 
----------------------------------------------------------------------
Purpose of this file: 
To view absent employees.
----------------------------------------------------------------------
                      ...
                      <td height="338"> <!-- InstanceBeginEditable name="Body" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr height="30" valign="middle" class="header">
                            <td colspan="4">EMPLOYEES ABSENT FOR THE DAY</td>
                          </tr>
							<tr>
							<td width="20%"></td>
							<td width="60%" height="20"><b>Employee Name</b></td>
							<td width="20%"></td>
							</tr>
							<?
							$objLog->getEmpAbsForNow(10, $p);
							?>
