<?
/* 
File Name: TerminalLeave.php 
----------------------------------------------------------------------
Purpose of this file: 
Forfeit terminal leave
----------------------------------------------------------------------
...
if($btnMonetize == "FOREFEIT AVAILABLE LEAVE CREDITS")
{
	$arrLB = $objAttendance->lastestMonthOnLB($arrEmpPersonal["empNumber"]);
	$intVL = $arrLB["vlBalance"];
	$intSL = $arrLB["slBalance"];
	$strConfirm = $objAttendance->terminalLeave($arrEmpPersonal["empNumber"], $arrLB["periodMonth"], $arrLB["periodYear"]);
}
$arrLB = $objAttendance->lastestMonthOnLB($arrEmpPersonal["empNumber"]);
$intVL = $arrLB["vlBalance"];
$intSL = $arrLB["slBalance"];
...
?>					  
                          ...
                          <tr> 
                            <td height="62"><p class="header">TERMINAL LEAVE</p>
								<p align="center">
								  <?
...
{
?>								  
								<form method="get" name="frmTerminal">
								  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titlebar">
								      <tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="20" valign="middle"><? echo $strConfirm?></td>
                                      </tr>
                                      <tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="30" valign="middle">
										Leave Credits Available as of <? echo $strMonthFullLB." ".$arrLB["periodYear"];?>
										</td>
                                      </tr>
                                      <tr bgcolor="#99CCFF"> 
                                ...
                                <tr> 
                                  <td colspan="2" height="30" valign="bottom"><div align="center"> 
                                      <input type="submit" name="btnMonetize" value="FOREFEIT AVAILABLE LEAVE CREDITS">
                                    </div></td>
                                </tr>
                                    </table>
									</form>
