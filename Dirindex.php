...
#divControl{ position:absolute; width:503; font-family:arial; left:20; top:100; font-size:10pt; visibility:hidden}

#divControl2{position:absolute; width:200; font-family:arial; left:895px; top:294px; font-size:10pt}
...
#divCont{position:absolute; top:128px; left:325px; clip:rect(0,550,1450,0); height:0; width:550}
...
<div id="divControl" style="width: 305; height: 685">
	...
	<p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      ...
      <font size="4" color="#CC3300">DIRECTOR MODULE</font></a></font></b><font size="4" color="#CC3300">
      </font>
      ...
      <a href="#" target="_self" onclick="changeActive(11)"><font color="#000099">- to request which 201 Info to update</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
 	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(12)"><font color="#000099">- to request to update Profile Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
 	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(13)"><font color="#000099">- to request to update Educ. Attnmnt Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
 	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(14)"><font color="#000099">- to request to update Trainings Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
 	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(15)"><font color="#000099">- to request to update Examinations Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(16)"><font color="#000099">- to request to update Children Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(17)"><font color="#000099">- to request to update CTC Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
 	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(18)"><font color="#000099">- to request to update References Info</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      
  	  <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(19)"><font color="#000099">- to submit requests for Reports</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
     
     <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(20)"><font color="#000099">- to request for Remittances Reports</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
     
     <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(21)"><font color="#000099">- to request for Payslip Reports</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
     
     <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(22)"><font color="#000099">- to request for CEC Reports</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
     
      <p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(23)"><font color="#000099">- to exit system</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      &nbsp;<!--msimagelist--><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <!--msimagelist--><tr>
        <!--msimagelist--><td valign="baseline" width="42">
        <img src="images/point.png" width="7" height="6" hspace="17" alt="bullet"></td>
      ...
      <a href="#" target="_self" onclick="changeActive(24)"><font color="#000099">- to view request status</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <font color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font> 
      <a href="#" target="_self" onclick="changeActive(25)"><font color="#000099">- to view 
      employees present</font></a><p align="left" dir="ltr" style="margin-top: 0; margin-bottom: 0">
      <a href="#" target="_self" onclick="changeActive(26)"><font color="#000099">&nbsp;</font></a><font color="#000099"></font></font><p align="left" dir="ltr"><font color="#000099">
	<br><br>
	&nbsp;</font></div>
...
<div id="divCont">
	...
	<div id="divScroll1" class="clScroll" style="width: 548; height: 350">
  	<center><b><font color="#000099" face="Trebuchet MS" size = "4">Director Module</font></b></center>
  	<p align="center">
  	<img border="0" src="images/dirimg1.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2">This is the default interface of a director module. This module is composed of three(3) sections namely: 201, Request and Notifications Section.</font></b></center>
    </div>
	...
	<p align="center">
	<img border="0" src="images/dirimg2.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Personal Information button to view personal information of the director.</font></b></center>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg3.jpg" width="548" height="498">		
 	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Family Background button to view family background of the director which consists of information about parents, spouse and children.</font></b></center>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg4.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Education button to view educational attainment of the director.</font></b></center>
    </font>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg5.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Examinations button to view examinations taken by the director.</font></b></center>
    </font>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg6.jpg" width="548" height="350">	
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Work Experience button to view the work experiences of the director including the private agencies they have been engaged in.</font></b></center>
    </font>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg7.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Voluntary Works button to view involvement of the director in civic, non-government, people and voluntary organizations.</font></b></center>
    </font>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg8.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Trainings button to view trainings attended by the director.</font></b></center>
    </font>
	</div>
	...
	<p align="center">
	<img border="0" src="images/dirimg9.jpg" width="548" height="626">
	...
	<p align="center">
	<img border="0" src="images/dirimg10.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2"> Click the Position Details button to view position details and optional policy loans available for the director.</font></b></center>
	...
	<p align="center">
	<img border="0" src="images/dirimg11.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg12.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2">Select from the dropdown menu which personal data you want to update. The personal data that can be updated are the following: Profile, Educational Attainment, Trainings, Examinations, Children, Community Tax Certificate and References.</font></b></center>
	...
	<p align="center">
	<img border="0" src="images/dirimg13.jpg" width="548" height="500">
	...
	<p align="center">
	<img border="0" src="images/dirimg14.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg15.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg16.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg17.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg18.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg19.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg20.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2">Click Submit button after selecting a type of report from the dropdown menu and inputting the details of the report selected to submit report request to the HR Officer. The director may select from the following type of reports namely: Payslips, Remittances and CEC.</font></b></center>
	...
	<p align="center">
	<img border="0" src="images/dirimg21.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg22.jpg" width="548" height="350">
	...
	<p align="center">
	<img border="0" src="images/dirimg23.jpg" width="548" height="350">
	...
	<center><b><font color="#000099" face="Trebuchet MS" size = "4">To Exit System</font></b></center>
	<p align="center">
	<img border="0" src="images/dirimg24.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2">Click Logout button to exit system.</font></b></center>
	...
	<p align="center">
	<img border="0" src="images/dirimg25.jpg" width="548" height="350">
	...
	<center><b><font color="#000099" face="Trebuchet MS" size = "4">Viewing Employees Present</font></b></center>
	<p align="center">
	<img border="0" src="images/dirimg26.jpg" width="548" height="350">
	<center><b><font color="#000099" face="Trebuchet MS" size = "2">Click Employees Present link to view the number of employees present.</font></b></center>
