<?php 
/* 
File Name: Leavespecify.php
----------------------------------------------------------------------
Purpose of this file: 
To add and delete study leave and reporting days to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Leavespecify.php");   //Load database connection
$objSpecifyLeave= new specifyLeave;   //Load specifyLeave function
$objSpecifyLeave->addSpecifyLeave($strEmpNmbr, $t_strLeaveCode, $t_strSpecifyLeave, $Submit);   //Load addSpecifyleave function
$objSpecifyLeave->editSpecifyLeave($strEmpNmbr, $t_strLeaveCode, $t_strSpecifyLeave, $Submit, $t_strOldSpecifyLeave);   //Load editSpecifyleave function
$strConfirm = $objSpecifyLeave->deleteSpecifyLeave($strEmpNmbr, $t_strLeaveCode, $t_strSpecifyLeave, $Submit);   //Load deleteSpecifyleave function
?>
...
<!-- Begin
nextfield = "t_strSpecifyLeave"; // name of first box on page
netscape = "";
...
eval('document.frmSpecifyLeave.' + nextfield + '.focus()');
return false;
      }
   }
}
...
if (document.frmSpecifyLeave.t_strLeaveCode.value=="") {
alert("Please input leave code!")
return false
} else if (document.frmSpecifyLeave.t_strSpecifyLeave.value=="") {
alert("Please input specific leave!")
return false
} 
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p> LEAVE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr>
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="Leave.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('LeaveIndicator','','images/indicator2.jpg',1)"><img src="images/indicator2.jpg" alt="Leave Indicator" name="LeaveIndicator" width="7" height="12" border="0"></a><a href="Leave.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()"> 
                                    Leave Type</a> </td>
                                </tr>
                                <tr> 
                                  <td height="22" class="radio"> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('LeaveSpecifyIndicator','','images/indicator1.jpg',1)"><img src="images/indicator1.jpg" alt="Leave Specify Indicator" name="LeaveSpecifyIndicator" width="7" height="12" border="0"></a> 
                                    Specify Leave</td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmSpecifyLeave" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
								  ...
								  ?>
                                  <tr> 
                                    <td width="170" class="paragraph">Leave Code 
                                      : </td>
                                    <td width="384" colspan="3"> 
                                      <?php 
										$result = mysql_query ("SELECT leaveCode FROM tblLeave");
										echo "<SELECT NAME=\"t_strLeaveCode\">\r";
										if ($row = mysql_fetch_array($result)) {
										do {
											if ($t_strLeaveCode == $row["leaveCode"])
											{
												print "<OPTION VALUE=\"".($row["leaveCode"])."\" selected>".($row["leaveCode"])."\r";
											}
										  print "<OPTION VALUE=\"".($row["leaveCode"])."\">".($row["leaveCode"])."\r";
										} while($row = mysql_fetch_array($result));
										} else {print "no results!";}
										echo "</SELECT>\r";
										?>
                                      <input name="t_strOldLeaveCode" type="hidden" value="<? echo $t_strLeaveCode; ?>"></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Specific Leave :</td>
                                    <td colspan="3"> <input name="t_strSpecifyLeave" type="text" value="<? echo "$t_strSpecifyLeave"; ?>" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span>
<input name="t_strOldSpecifyLeave" type="hidden" value="<? echo "$t_strSpecifyLeave"; ?>">
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"> 
                                      <?php 
										$result = mysql_query ("SELECT * FROM tblLeave");
										echo "<SELECT NAME=\"t_strLeaveCode\">\r";
										if ($row = mysql_fetch_array($result)) {
										do {
											if ($t_strLeaveCode == $row["leaveCode"])
                                  ...
                                  <tr> 
                                    <td class="paragraph">Specific Leave :</td>
                                    <td colspan="3"> <input name="t_strSpecifyLeave" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objSpecifyLeave->viewSpecifyLeave($strEmpNmbr, $t_strLeaveCode, $t_strSpecifyLeave);   //Load viewSpecifyLeave function
									?>
                                  </td>
                                </tr>
                              </table></td>
