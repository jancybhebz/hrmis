...
var temp
if (document.frmTaxExempt.taxStatus.value=="") {
alert("Please input tax status!")
return false
} else if (document.frmTaxExempt.exemptionAmount.value=="") {
alert("Please input exemption amount!")
return false
}

for (var i=0;i<document.frmTaxExempt.exemptionAmount.value.length;i++){
temp=document.frmTaxExempt.exemptionAmount.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid exemption amount!")
return false
      }
   }
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
						  <table width="99%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                            <tr> 
                            <td height="19" class="header"><p>TAX EXEMPTION</p></td>
                          </tr>
							<form action="<?php $PHP_SELF; ?>" method="post" name="frmTaxExempt" onSubmit="return validate()" >
							<?
								if($Submit2 == "Delete")
								{
								?>
                              ...
                              <td colspan="3" class="titlebar">Are you sure you 
                                want to delete <? echo $taxStatus; ?> and <? echo $exemptionAmount; ?>??? 
                                <input name="taxStatus" type="hidden" value="<?echo"$taxStatus";?>">
                              </td>
                                  </tr>
		<tr>
								...
								?>
									   <tr> 
                                    <td colspan="5" class="paragraph">Tax Status 
                                      :</td>
                                    <td width="433"> <input name="taxStatus" type="text" size="30" maxlength="30" value="<? echo"$taxStatus"; ?>" onBlur="validateCharacter(this)">
                                <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="5" class="paragraph">Exemption 
                                      Amount :</td>
                                    <td> <input name="exemptionAmount" type="text" size="30" maxlength="30" value="<? echo"$exemptionAmount"; ?>" onBlur="validateAmount(this)">
                                <span class="required"> * </span>
<input name="taxStatus1" type="hidden" value="<? echo $taxStatus; ?>"> 
                              </td>
                                  </tr>
                                  <tr> 
                            ...
                            <tr> 
							  ...
							  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td colspan="5" class="paragraph">Tax Status 
                                      :</td>
                                    <td width="433"> <input name="taxStatus" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="5" class="paragraph">Exemption 
                                      Amount :</td>
                                    <td> <input name="exemptionAmount" type="text" size="30" maxlength="30" onBlur="validateAmount(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="6" class="paragraph">&nbsp;</td>
						  ...
						  <table width="99%" height="45" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY" dwcopytype="CopyTableCell">
                            <tr> 
                            <td height="19" class="header"><p>&nbsp;</p></td>
                          </tr>
                          <tr> 
                            <td height="18" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="18">
                              		<?php
include("../hrmis/class/TaxPhilhealth.php");   //Load taxexempt functions
$objTax = new TaxPhilhealth;
$objTax->addTaxExempt($strEmpNmbr, $taxStatus, $exemptionAmount, $Submit2, $taxStatus1);
$objTax->viewTaxExempt($strEmpNmbr, $taxStatus, $exemptionAmount, $Submit2);
