                                ...
                                <tr> 
                                  <td> <form name="frmChiefOB" method="post" action="<? $PHP_SELF; ?>">
									...
									<tr> 
										...
										<input type="submit" name="Submit" value="Submit" onClick="trapFormEntry(txtDestination, txtPurpose, cboMonthFrom, cboYearFrom, cboDayFrom, cboMonthTo, cboYearTo, cboDayTo)">
