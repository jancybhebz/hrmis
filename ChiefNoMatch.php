<?
/* 
File Name: ChiefNoMatch.php 
----------------------------------------------------------------------
Purpose of this file: 
To trap the wrong entries in the search.
----------------------------------------------------------------------
...
$objAttendance->setvar(array("strEmpNmbr"=>$strEmpNmbr, 'strOrder'=>$strOrder)); //for maintain state
...
{
?>
					<table border="0" cellpadding="10" cellspacing="10" width="622">
					  <tr><td>								
					  		<p align="center">
								  <?
					  ...
					  <tr>
					  <td valign="top" class="errorsearch">
...
?>
					<table border="0" cellpadding="10" cellspacing="10" width="622">
					  ...
					  <tr>
					  <td valign="top" class="errorsearch">Your search did not match any employee record.<br><br><br>
        Suggestions: <br>
                              <ul>
                                <li> Make sure that the employee name or employee 
                                  number is spelled correctly. <br>
                                  </li>
