...
if ($Submit)
{
	...
	$objEmpLeave->addRequest($strEmpNmbr, $cboLeaveType, "Leave", $cboSpecifyLeave, $cboMonthFrom, $cboDayFrom, $cboYearFrom, $cboMonthTo, $cboDayTo, $cboYearTo, $txtReason, $t_strRequestStatus);   //Add employee privilege leave request
}
?>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  <td> 
								  <form action="<? $PHP_SELF; ?>" name="frmEmpLeave" method="post"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
								  ...
								  <br></div>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr> 
                                                <td width="30%" height="25" class="paragraph">Type 
                                                  of Leave :</td>
                                                <td width="70%"> <strong> 
                                                  <select name="cboLeaveType" onChange="changeSpecific('employee');">
                                                    <?
...
?>
                                              <tr> 
                                                <td width="31%" height="25" class="paragraph"> 
                                                  Specific Type of Leave:</td>
                                                <td width="69%"> 
<select name="cboSpecifyLeave" onChange="changeSpecific('employee');">
<?
...
?>
									   ...
									   ?>
                                                  </select> <select name="cboMonthFrom" onChange="updateList(this.selectedIndex,cboYearFrom[cboYearFrom.selectedIndex].text,'cboDayFrom')">
                                                    <?
...
?>
                                              ...
                                              <tr> 
                                                <td height="25" class="paragraph">Leave From 
                                                  :</td>
                                                <td><select name="cboYearFrom" size="1" onChange="updateList(cboMonthFrom.selectedIndex,this[this.selectedIndex].text,'cboDayFrom')">
                                                    <?
										$objEmpLeave->comboYear(date("Y"));
									   ?>
                                                  </select> <select name="cboMonthFrom" size="1" onChange="updateList(this.selectedIndex,cboYearFrom[cboYearFrom.selectedIndex].text,'cboDayFrom')">
                                                    <?
										$objEmpLeave->comboMonth(date("n"));
										?>
										...
										?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Leave To 
                                                  :</td>
                                                <td><select name="cboYearTo" size="1" onChange="updateList(cboMonthTo.selectedIndex,this[this.selectedIndex].text,'cboDayTo')">
                                                    <?
										$objEmpLeave->comboYear(date("Y"));
									   ?>
                                                  </select> <select name="cboMonthTo" size="1" onChange="updateList(this.selectedIndex,cboYearTo[cboYearTo.selectedIndex].text,'cboDayTo')">
                                                    <?
										$objEmpLeave->comboMonth(date("n"));
										?>
...
<tr> 
								  ...
								  <font class="note">*</font>
                                              ...
                                              <tr> 
                                                <td height="25" valign="top" class="paragraph"> 
                                                  Specify Reason(s):&nbsp;&nbsp;&nbsp;</td>
