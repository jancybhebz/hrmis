<?php 
/* 
File Name: Holidayyear.php
----------------------------------------------------------------------
Purpose of this file: 
To add and delete Holiday year to database.
----------------------------------------------------------------------
...
----------------------------------------------------------------------
Date of Revision: October 27, 2003
----------------------------------------------------------------------
Copyright Notice:
...
include("../hrmis/class/Holidayyear.php");   //Load database connection									
$objHolidayYear= new holidayYear;   //Load holidayYear function
$objHolidayYear->addHolidayYear($strEmpNmbr, $t_strHolidayCode, $t_dtmHolidayMonth, $t_dtmHolidayDay, $t_dtmHolidayYear, $Submit);   //Add holiday year
$objHolidayYear->editHolidayYear($strEmpNmbr, $t_strHolidayCode, $t_dtmHolidayMonth, $t_dtmHolidayDay, $t_dtmHolidayYear, $Submit, $t_strOldHolidayCode, $t_strOldHolidayMonth, $t_strOldHolidayDay, $t_strOldHolidayYear);  //edit  holiday information
$strConfirm = $objHolidayYear->deleteHolidayYear($strEmpNmbr, $t_strHolidayCode, $t_dtmHolidayDate, $Submit);   //Load deleteHolidayYear function 
?>
...
var temp
if (document.frmHolidayYear.t_strHolidayCode.value=="") {
alert("Please input holiday code!")
return false
}
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="225" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>HOLIDAY</p></td>
                          </tr>
                          <tr> 
                            <td class="header"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                  </td>
                                </tr>
                          ...
                          <tr> 
                            <td class="header"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="Holiday.php" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('Indicator','','images/indicator_down.jpg',1); statusBar(); return true;" onClick="statusBar();"> 
                                    </a><a href="Holiday.php" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('HolidayIndicator','','images/indicator2.jpg',1); statusBar(); return true;" onClick="statusBar();"><img src="images/indicator2.jpg" alt="Holiday Indicator" name="HolidayIndicator" width="7" height="12" border="0"></a><a href="Holiday.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Add 
                                    Holiday</a></td>
                                </tr>
                                <tr> 
                                  <td class="radio"> <a href="#" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('HolidayYearIndicator','','images/indicator1.jpg',1); statusBar(); return true;" onClick="statusBar();"><img src="images/indicator1.jpg" alt="Holiday Year Indicator" name="HolidayYearIndicator" width="7" height="12" border="0"></a>View 
                                    Holiday <a href="Holidayyear.php" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()"> 
                                    </a></td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> <form action="<? $PHP_SELF; ?>" method="post" name="frmHolidayYear">
                                      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
										...
										?>
                                        <tr> 
                                          <td class="titlebar">Are you sure you 
                                            want to delete <? echo $t_strHolidayCode; ?> 
                                            and <? echo $t_dtmHolidayDate; ?> 
                                            ??? 
                                            <input name="t_strHolidayCode" type="hidden" value="<? echo "$t_strHolidayCode"; ?>"></td>
                                        </tr>
                                        <tr> 
                                      ...
                                      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <?
										   ...
										   {
										?>
                                          <td width="26%" class="paragraph">Holiday 
                                            Code : </td>
                                          <td> 
                                            <?php 
										$result = mysql_query ("SELECT holidayCode FROM tblHoliday ORDER BY holidayCode ASC");
										echo "<SELECT NAME=\"t_strHolidayCode\">\r";
										if ($row = mysql_fetch_array($result)) {
										do {
											if ($t_strHolidayCode == $row["holidayCode"])
											{
												print "<OPTION VALUE=\"".($row["holidayCode"])."\" selected>".($row["holidayCode"])."\r";
											}
										  print "<OPTION VALUE=\"".($row["holidayCode"])."\">".($row["holidayCode"])."\r";
										} while($row = mysql_fetch_array($result));
										} else {print "no results!";}
										echo "</SELECT>\r";
										?>
                                            <input name="t_strOldHolidayCode" type="hidden" value="<? echo "$t_strHolidayCode"; ?>"> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph"> Holiday : </td>
                                          <td width="74%">Year 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblHolidayYear");
										echo "<SELECT NAME=\"t_dtmHolidayYear\" onChange=\"updateList(t_dtmHolidayMonth.selectedIndex,t_dtmHolidayYear[t_dtmHolidayYear.selectedIndex].text,'t_dtmHolidayDay')\">\r";
										$yyyymmdd = $t_dtmHolidayDate;
                                        list($t_dtmHolidayYear) = array(substr($yyyymmdd,0,4));
										$objHolidayYear->comboYear($t_dtmHolidayYear);
										echo "</SELECT>\r";
										?>
                                            <input name="t_dtmOldHolidayYear" type="hidden" value="<? echo "$t_dtmHolidayYear"; ?>"> Month 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblHolidayYear");
									    echo "<SELECT NAME=\"t_dtmHolidayMonth\" onChange=\"updateList(t_dtmHolidayMonth.selectedIndex,t_dtmHolidayYear[t_dtmHolidayYear.selectedIndex].text,'t_dtmHolidayDay')\">"; 
										$yyyymmdd = $t_dtmHolidayDate;
                                        list($t_dtmHolidayMonth) = array(substr($yyyymmdd,5,2));
										$objHolidayYear->comboMonth($t_dtmHolidayMonth);
										echo "</SELECT>";
										?>
                                            <input name="t_dtmOldHolidayMonth" type="hidden" value="<? echo "$t_dtmHolidayMonth"; ?>">
                                            Day 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblHolidayYear");
										echo "<SELECT NAME=\"t_dtmHolidayDay\">\r";
										$yyyymmdd = $t_dtmHolidayDate;
                                        list($t_dtmHolidayDay) = array(substr($yyyymmdd,8,2));
										$objHolidayYear->comboDay($t_dtmHolidayDay);
										echo "</SELECT>\r";
										?>
                                            <input name="t_dtmOldHolidayDay" type="hidden" value="<? echo "$t_dtmHolidayDay"; ?>">
                                             
                                            <input name="t_dtmOldHolidayDate" type="hidden" value="<? echo "$t_dtmHolidayDate"; ?>">
                                      ...
                                      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                          ...
                                          <td> 
                                            <?php 
										$result = mysql_query ("SELECT * FROM tblHoliday ORDER BY holidayCode ASC");
										echo "<SELECT NAME=\"t_strHolidayCode\">\r";
										if ($row = mysql_fetch_array($result)) {
										do {
											if ($t_strHolidayCode == $row["holidayCode"])
                                        ...
                                        <tr> 
                                          ...
                                          <td width="74%">
                                            Year : 
                                            <select name="t_dtmHolidayYear" disabled size="1" onChange="updateList(t_dtmHolidayMonth.selectedIndex,t_dtmHolidayYear[t_dtmHolidayYear.selectedIndex].text,'t_dtmHolidayDay')">
                                              <?
											$objHolidayYear->comboYear(date('Y'));
											?>
                                            </select>Month 
                                            <select name="t_dtmHolidayMonth" size="1" onChange="updateList(t_dtmHolidayMonth.selectedIndex,t_dtmHolidayYear[t_dtmHolidayYear.selectedIndex].text,'t_dtmHolidayDay')">
                                              <?
											$objHolidayYear->comboMonth(t_dtmHolidayMonth);
											?>
                                            </select>
                                            Day 
                                            <select name="t_dtmHolidayDay" size="1">
                                              <?
											$objHolidayYear->comboDay(t_dtmHolidayDay);
											?>
                                            </select>
                            ...
                            <td valign="top"> 
                              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objHolidayYear->viewHolidayYear($strEmpNmbr, $t_strHolidayCode, $t_dtmHolidayDate);   //Load viewHolidayYear function
							  		?>
                                  </td>
                                </tr>
                              </table> </td>
