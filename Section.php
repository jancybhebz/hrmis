...
To add and delete useraccount and password to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Section.php");   //Load database connection									
$objSection= new section;   //Load section function
$objSection->addSection($strEmpNmbr, $t_strSectionCode, $t_strDivisionCode, $t_strSectionName, $t_strEmpNumber, $t_strSectionHead, $t_strSectionHeadTitle, $Submit);   //Load addSection function
$objSection->editSection($strEmpNmbr, $t_strSectionCode, $t_strDivisionCode, $t_strSectionName, $t_strEmpNumber, $t_strSectionHead, $t_strSectionHeadTitle, $Submit, $t_strOldSectionCode);   //Load editSection function
$strConfirm = $objSection->deleteSection($strEmpNmbr, $t_strSectionCode, $t_strDivisionCode, $t_strSectionName, $t_strEmpNumber, $t_strSectionHead, $t_strSectionHeadTitle, $Submit);   //Load deleteSection function
?>
...
var temp
if (document.frmSection.t_strSectionCode.value=="") {
alert("Please input section code!")
return false
} else if (document.frmSection.t_strSectionName.value=="") {
alert("Please input section name!")
return false
} else if (document.frmSection.t_strSectionHead.value=="") {
alert("Please input section head!")
return false
} else if (document.frmSection.t_strSectionHeadTitle.value=="") {
alert("Please input section head title!")
return false
}
...
function sectionHeadRequirement()
{	
	// for combo section head
	var strEmpNmbr = "<? echo $strEmpNmbr; ?>";
	var t_strEmpNumber = document.frmSection.t_strEmpNumber.value;
	var t_strSectionHead = document.frmSection.t_strSectionHead.value;
	var t_strSectionCode = "<? echo $t_strSectionCode; ?>";
	var t_strSectionName = "<? echo $t_strSectionName; ?>";
	var t_strDivisionCode = "<? echo $t_strDivisionCode; ?>";
	var t_strSectionHeadTitle = "<? echo $t_strSectionHeadTitle; ?>";
	var strSubmit = "<? echo $Submit ?>";
	

	window.location = "Section.php?strEmpNmbr="+strEmpNmbr+"&t_strEmpNumber="+t_strEmpNumber+"&t_strSectionHead="+t_strSectionHead+"&t_strSectionCode="+t_strSectionCode+"&t_strSectionName="+t_strSectionName+"&t_strSectionHeadTitle="+t_strSectionHeadTitle+"&t_strDivisionCode="+t_strDivisionCode+"&Submit="+strSubmit;
	
}

function editSectionHeadRequirement()
{	
	// for combo section head
	var strEmpNmbr = "<? echo $strEmpNmbr; ?>";
	var t_strSectionHead = document.frmSection.t_strSectionHead.value;
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="264" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>SECTION</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td height="53" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmSection" onSubmit="return validate()">
                                  <?
							      if($strConfirm)
							      {
							      ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are 
                                      you sure you want to delete <? echo $t_strSectionCode; ?>, 
                                      <? echo $t_strDivisionCode; ?>, <? echo $t_strSectionName; ?>, 
                                      <? echo $t_strSectionHead; ?> and <? echo $t_strSectionHeadTitle; ?> 
                                      ??? 
                                      <input name="t_strSectionCode" type="hidden" value="<? echo $t_strSectionCode; ?>"> 
								  ...
								  ?>
                                  <tr> 
                                    <td height="19" colspan="4" class="paragraph">&nbsp; 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="170" class="paragraph">Employee 
                                      Number : </td>
                                    <td width="384" colspan="3"> <select name="t_strEmpNumber" onChange="editSectionHeadRequirement()">
                                        <?  
									  $objSection->comboEmpNumber($strEmpNmbr, $t_strEmpNumber);
									  ?>
                                      </select>
                                  ...
                                  <tr> 
                                    <td class="paragraph"> 
                                      <? 
											$t_strSectionHead = $objSection->sectionHead($t_strEmpNumber); 
											?>
                                      Section Head :</td>
                                    <td colspan="3"><input name="t_strSectionHead" type="text" value="<? echo "$t_strSectionHead"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Section Head Title :</td>
                                    <td colspan="3"><input name="t_strSectionHeadTitle" type="text" value="<? echo "$t_strSectionHeadTitle"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph"><input name="t_strOldEmpNumber" type="hidden" id="t_strOldEmpNumber" value="<? echo "$t_strEmpNumber"; ?>">
                                      Section Code :</td>
                                    <td colspan="3"><input name="t_strSectionCode" type="text" onBlur="validateCharacter(this)" value="<? echo "$t_strSectionCode"; ?>" size="30" maxlength="30">
                                      <span class="required"> * 
                                      <input name="t_strOldSectionCode" type="hidden" value="<? echo "$t_strSectionCode"; ?>">
                                      </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Section Name :</td>
                                    <td colspan="3"><input name="t_strSectionName" type="text" id="t_strSectionName" onBlur="validateCharacterAndSpace(this)" value="<? echo "$t_strSectionName"; ?>" size="50" maxlength="50"> 
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    ...
                                    <td colspan="3"> 
                                      <?php 
										...
										do {
											...
											{
												print "<OPTION VALUE=\"".($row["divisionCode"])."\" selected>".($row["divisionCode"])."\r";
											}
										  print "<OPTION VALUE=\"".($row["divisionCode"])."\">".($row["divisionCode"])."\r";
                                  ...
                                  <? 
								     ...
								     ?>
                                  <tr> 
                                    <td class="paragraph">Employee Number :</td>
                                    <td colspan="3"> <select name="t_strEmpNumber" onChange="sectionHeadRequirement()">
                                        <?  
									  $objSection->comboEmpNumber($strEmpNmbr, $t_strEmpNumber);
									  ?>
                                      </select> </td>
                                  ...
                                  <tr> 
                                    <td class="paragraph"> 
                                      <? 
											...
											?>
                                      Section Head :</td>
                                    <td colspan="3"><input name="t_strSectionHead" type="text" onBlur="validateCharacterAndSpace(this)" value="<? echo $t_strSectionHead; ?>" size="50" maxlength="50" readonly="readonly"> 
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Section Head Title :</td>
                                    <td colspan="3"><input name="t_strSectionHeadTitle" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)"> 
                                      <span class="required"> * </span> <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Section Code :</td>
                                    <td colspan="3"><input name="t_strSectionCode" type="text" id="t_strSectionCode" onBlur="validateCharacter(this)" size="30" maxlength="30">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Section Name :</td>
                                    <td colspan="3"><input name="t_strSectionName" type="text" id="t_strSectionName" onBlur="validateCharacterAndSpace(this)" size="50" maxlength="50"> 
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Division Code :</td>
                          ...
                          <tr> 
                            <td height="13" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objSection->viewSection($strEmpNmbr, $t_strSectionCode, $t_strDivisionCode, $t_strSectionName, $t_strEmpNumber, $t_strSectionHead, $t_strSectionHeadTitle);   //Load viewSection function
									?>
                                  </td>
                                </tr>
                              </table></td>
