<?php 
/* 
File Name: DirectornotifyOB.php 
----------------------------------------------------------------------
...
include("../hrmis/class/DirectornotifyOB.php");
$objDirector = new directorNotifyOB;
$arrEmpPersonal = $objDirector->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objDirector->approvedOBRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks, $t_dtmStatusDate, $Submit, $t_strOldRequestStatus, $t_strOldRemarks); // approved employee/s leave request (DirectornotifyOB.php)
?>
                                ...
                                <tr> 
                                  <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td> 
                                          <?
							  $objDirector->viewChiefOBRequestForApproval($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRemarks);  //View list of employee/s request (DirectornotifyOB.php)
							  ?>
                                        </td>
                                      </tr>
                                    </table></td>
                                          ...
                                          <td><table width="85%" border="1" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                ...
                                                <td><select name="t_strRequestStatus" size="1">
                                                  ...
                                                  Status of Request)</span> <input name="t_dtmStatusDate" type="hidden" value="<? echo date ("Y-m-d"); ?>"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Remarks 
                                                  : </td>
                                                <td><textarea name="t_strReason" cols="30" rows="3"><? echo $t_strReason; ?></textarea></td>
                                              </tr>
                                              <tr> 
