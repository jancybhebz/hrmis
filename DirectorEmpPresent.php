<?
/* 
File Name: DirectorEmpPresent.php 
----------------------------------------------------------------------
Purpose of this file: 
To view present employees.
----------------------------------------------------------------------
                      ...
                      <td height="338"> <!-- InstanceBeginEditable name="Body" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr height="30" valign="middle" class="header">
							...
							<tr>
							<td width="20%"></td>
							<td width="40%" height="20"><a href="DirectorEmpPresent.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=name" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Employee Name</a></td>
							<td width="30%" height="20"><a href="DirectorEmpPresent.php?strEmpNmbr=<? echo $strEmpNmbr?>&strOrder=time" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Time In</a></td>
							<td width="10%"></td>
							</tr>
							<?
							$objLog->empInside($strOrder, 10, $p);
							?>
