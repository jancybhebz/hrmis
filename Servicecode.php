<?php 
/* 
File Name: Servicecode.php 
----------------------------------------------------------------------
Purpose of this file: 
To add and delete project code and description to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Servicecode.php");   //Load database connection
$objService= new service;   //Load service function
$objService->addServiceCode($strEmpNmbr, $t_strServiceCode, $t_strServiceDesc, $Submit);   //Load addServiceCode function
$objService->editServiceCode($strEmpNmbr, $t_strServiceCode, $t_strServiceDesc, $Submit, $t_strOldServiceCode);   //Load editServiceCode function
$strConfirm = $objService->deleteServiceCode($strEmpNmbr, $t_strServiceCode, $t_strServiceDesc, $Submit);   //Load deleteServiceCode function
?>
...
var temp
if (document.frmService.t_strServiceCode.value=="") {
alert("Please input service code!")
return false
} else if (document.frmService.t_strServiceDesc.value=="") {
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="203" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="26" class="header"><p>SERVICE CODE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td height="48" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmService" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strServiceCode; ?> 
                                      and <? echo $t_strServiceDesc; ?> ??? 
                                      <input name="t_strServiceCode" type="hidden" value="<? echo $t_strServiceCode; ?>">
								  ...
								  ?>
                                  <tr> 
                                    <td width="171" class="paragraph">Service 
                                      Code :</td>
                                    <td width="383" colspan="3"> <input name="t_strServiceCode" type="text" value="<? echo "$t_strServiceCode"; ?>" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Service Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strServiceDesc" type="text" value="<? echo "$t_strServiceDesc"; ?>" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"> <input name="t_strServiceCode" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Service Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strServiceDesc" type="text" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span>
<input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objService->viewServiceCode($strEmpNmbr, $t_strServiceCode, $t_strServiceDesc);   //Load viewServiceCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
