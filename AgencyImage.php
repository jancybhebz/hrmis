...
$objAgency->deleteAgencyLogo($strEmpNmbr, $t_strAgencyName, $Submit2);  //delete/add logo
?>
...
?>
<script>
function validateAgencyImage(){
var digits="0123456789"
var temp
if (document.frmAgencyImage.t_strAgencyName.value=="") {
alert("Please input agency name!")
return false
} else if (document.frmAgencyImage.form_data.value=="") {
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="28" class="header"><p>AGENCY IMAGE</p>
                              </td>
                          </tr>
                          <tr>
                            <td><form enctype="multipart/form-data" action="<? '<a href=\"Agency.php?strEmpNmbr=$strEmpNmbr&filename=$filename&t_strAgencyName=$t_strAgencyName&t_strAbbreviation=$t_strAbbreviation&t_strAddress=$t_strAddress&t_intTelephone=$t_intTelephone&t_strDTRScheme=$t_strDTRScheme&t_dtmFixedFrom=$t_dtmFixedFrom&t_dtmFixedTo=$t_dtmFixedTo&t_dtmMorningFrom=$t_dtmMorningFrom&t_dtmMorningTo=$t_dtmMorningTo&t_dtmAfternoonFrom=$t_dtmAfternoonFrom&t_dtmAfternoonTo=$t_dtmAfternoonTo&t_strSalarySchedule=$t_strSalarySchedule&t_dtmLBStartMonth=$t_dtmLBStartMonth&t_dtmLBStartYear=$t_dtmLBStartYear&t_intGSISEmpShare=$t_intGSISEmpShare&t_intGSISEmprShare=$t_intGSISEmprShare&t_intPAGIBIGEmpShare=$t_intPAGIBIGEmpShare&t_intPAGIBIGEmprShare=$t_intPAGIBIGEmprShare&t_intPHILHEALTHEmpShare=$t_intPHILHEALTHEmpShare&t_intPHILHEALTHEmprShare=$t_intPHILHEALTHEmprShare&t_intPHILHEALTHPercentage=$t_intPHILHEALTHPercentage&t_intLongevityMultiply=$t_intLongevityMultiply&t_intLongevityYear=$t_intLongevityYear&t_intHPFactor=$t_intHPFactor&t_intSubsistence=$t_intSubsistence\"></a>'?>" method="post" name="frmAgencyImage">
...
$result=mysql_query("INSERT INTO tblAgencyImages (agencyLogo,agencyName,filename,filesize,filetype) ". "VALUES ('$data','$t_strAgencyName','$form_data_name','$form_data_size','$form_data_type')");

print "<p><br>Agency Logo has been changed from the database: <b>$filename</b>";
mysql_close();
} else {  
...
?>
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="39%" class="paragraph">Agency Name 
                                      : </td>
                                    <td width="61%"><select name="t_strAgencyName" size="1">
									<? $objAgency->AgencyName($t_strAgencyName);?>
									</select>
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Picture (Banner/Logo) 
                                      :</td>
                                    <td width="61%"><input name="form_data" type="file" size="40"> 
                                  ...
                                  <tr> 
                                    <td colspan="2" class="td"> <input name="Submit" type="submit" id="Submit" onClick="return validateAgencyImage()" value="Submit"> 
                                    </td>
                                  </tr>
                                </table>
                                <?php
