<?
/* 
File Name: ChiefDTR.php 
----------------------------------------------------------------------
Purpose of this file: 
To view DTR of chief and employees under him.
----------------------------------------------------------------------
...
<script>
function openPrint(strEmpNmbr, intYear, intMonth)
{
/*	var  = document.all.cboEmpNmbr.value;
	var  = document.all.cboMonth.value;	
	var  = document.all.cboYear.value;*/
	var strDivSec = "<? echo $strDvsnCode?>";
	var strPage
	
	strPage = "ReportData.php?strEmpNmbr="+strEmpNmbr+"&strReports=DTR&strEmpSelect=Per Division&strDivSec="+strDivSec+"&intMonth="+intMonth+"&intYear="+intYear;
              ...
              <tr> 
                ...
                <td width="84%" valign="top"><table width="99%" height="338" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
					  ...
					  <form name="frmPrintDtr">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="25" class="header">DTR REPORT</td>
                          </tr>
						  <tr>
						  <td>
						  ...
						  <tr> 
							...
							<tr> 
                                                  <td width="30%" align="right" height="25"> 
                                                    Employees:&nbsp;&nbsp;</td>
                                                  <td width="30%" height="25"> 
                                                    <? 
										$objAttendance->comboEmpReport("cboEmpNmbr", $cboEmpNmbr, "DTR", "Per Division", $strDvsnCode);
										?>
                                                  </td>
                                                  <td width="40%"> <p> Highlight 
                                                      desired employee. <br>
						  ...
						  <tr><td colspan="3" height="30">
						   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                      ...
                                                      <tr> 
                                                        <td width="30%" height="25" align="right">Month 
                                                          :&nbsp;</td>
						  ...
						  <tr><td height="30" colspan="3" align="center" valign="bottom"><input type="button" name="Submit" value="PRINT/PREVIEW" onClick="openPrint(cboEmpNmbr.value, cboYear.value, cboMonth.value)"></td></tr>
						  </table>
						  </td>
						  </tr>
                        </table>
