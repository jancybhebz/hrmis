...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/notificationover.jpg','images/attendanceover.jpg','images/reportsover.jpg','images/librariesover.jpg','images/compensationover.jpg','images/201click.jpg','images/education2.jpg','images/trainings2.jpg','images/examinations2.jpg','images/position2.jpg','images/reference2.jpg','images/logout2.jpg','images/family-background2.jpg','images/work-experience2.jpg','images/voluntary-work2.jpg','images/other%20information2.jpg','images/personal-information2.jpg','images/legal2.jpg'); history.forward()" onContextMenu="return false"><div align="center"> 
                    ...
                    <tr> 
                      <td height="339"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="24" class="header"><p>OTHER INFORMATION</p></td>
                          </tr>
                          <tr> 
                            <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>SKILLS, NON-ACADEMIC DISTINCTION/RECOGNITION 
                                    &amp; MEMBERSHIP IN ASSOCIATION</td>
                                </tr>
                                <tr>
                                  <td><a href="Legalinfo.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('legalinformation','','images/legal2.jpg',1)"><img src="images/legal1.jpg" alt="legalinformation" name="legalinformation" width="108" height="20" border="0"></a></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                </tr>
