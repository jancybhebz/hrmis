<?php 
/* 
File Name: Division.php
----------------------------------------------------------------------
Purpose of this file: 
To add, edit and delete division to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Division.php");   //Load database connection									
$objDivision= new Division;   //Load division function
$objDivision->addDivision($strEmpNmbr, $t_strDivisionCode, $t_strDivisionName, $t_strProjectCode, $t_strEmpNumber, $t_strDivisionHead, $t_strDivisionHeadTitle, $Submit);   //Load addDivision function
$objDivision->editDivision($strEmpNmbr, $t_strDivisionCode, $t_strDivisionName, $t_strProjectCode, $t_strEmpNumber, $t_strDivisionHead, $t_strDivisionHeadTitle, $Submit, $t_strOldDivisionCode, $t_strOldProjectCode);   //Load editDivision function
$strConfirm = $objDivision->deleteDivision($strEmpNmbr, $t_strDivisionCode, $t_strDivisionName, $t_strProjectCode, $t_strEmpNumber, $t_strDivisionHead, $t_strDivisionHeadTitle, $Submit);   //Load deleteDivision function
?>
...
function empNumberRequirement()
{	
	// for combo employee number
	var strEmpNmbr = "<? echo $strEmpNmbr; ?>";
	var txtSearch = "<? echo $txtSearch; ?>";
	var optField = "<? echo $optField; ?>";
	var strDivisionCode = "<? echo $t_strDivisionCode; ?>";
	var strDivisionName = "<? echo $t_strDivisionName; ?>";
	var strProjectCode = "<? echo $t_strProjectCode; ?>";
	var strDivisionHead = document.frmDivision.t_strDivisionHead.value;
	var strDivisionHeadTitle = "<? echo $t_strDivisionHeadTitle; ?>";
	var strSubmit = "<? echo $Submit; ?>";
	var strEmpNumber = document.frmDivision.t_strEmpNumber.value;
	
	window.location = "Division.php?strEmpNmbr="+strEmpNmbr+"&txtSearch="+txtSearch+"&optField="+optField+"&t_strDivisionCode="+strDivisionCode+"&t_strDivisionName="+strDivisionName+"&t_strProjectCode="+strProjectCode+"&t_strEmpNumber="+strEmpNumber+"&t_strDivisionHead="+strDivisionHead+"&t_strDivisionHeadTitle="+strDivisionHeadTitle+"&Submit="+strSubmit;
...
var temp
if (document.frmDivision.t_strDivisionHead.value=="") {
alert("Please select employee number of division head!")
return false
} else if (document.frmDivision.t_strDivisionHeadTitle.value=="") {
alert("Please input division head title!")
return false
} else if (document.frmDivision.t_strDivisionCode.value=="") {
alert("Please input division code!")
return false
} else if (document.frmDivision.t_strDivisionName.value=="") {
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>DIVISION</p></td>
                          </tr>
                          <tr> 
                            <td valign="top"> <div align="center"> 
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <form action="<?php $PHP_SELF; ?>" method="post" name="frmDivision" onSubmit="return validate()">
                                    <?
								if($strConfirm)
								{
								?>
                                    <tr> 
                                      <td colspan="3" class="titlebar">Are you 
                                        sure you want to delete <? echo $t_strDivisionCode; ?>, 
                                        <? echo $t_strDivisionName; ?>, <? echo $t_strProjectCode; ?>, 
                                        <? echo $t_strDivisionHead; ?> and <? echo $t_strDivisionHeadTitle; ?> 
                                        ??? 
                                        <input name="t_strDivisionCode" type="hidden" id="t_strDivisionCode" value="<? echo $t_strDivisionCode; ?>"></td>
                                    </tr>
                                    <tr> 
								    ...
								    ?>
                                    <tr> 
                                      <td width="195" height="9" class="paragraph">Employee 
                                        Number of Division Head:</td>
                                      <td width="359" colspan="3"><select name="t_strEmpNumber" size=1 id="t_strEmpNumber" onChange="empNumberRequirement()">
                                          <?php 
										$objDivision->comboEmpNumber($t_strEmpNumber);
										?>
                                        </select>
                                        <span class="required"> *</span> </td>
                                    </tr>
                                    <tr> 
                                      <td height="10" class="paragraph">
                                        <? 
											$t_strDivisionHead = $objDivision->divisionHead($t_strEmpNumber); 
											?>
                                        Division Head : </td>
                                      <td width="359" colspan="3"><input name="t_strDivisionHead" type="text" value="<? echo $t_strDivisionHead; ?>" size="50" maxlength="50" readonly>
                                        <span class="required"> *</span></td>
                                    </tr>
                                    <tr> 
                                      <td height="10" class="paragraph">Division 
                                        Head Title : </td>
                                      <td width="359" colspan="3"><input name="t_strDivisionHeadTitle" type="text" onBlur="validateCharacterAndSpace(this)" value="<? echo $t_strDivisionHeadTitle; ?>" size="50" maxlength="50"> 
                                    ...
                                    <tr> 
                                      <td height="9" class="paragraph">Division 
                                        Code : </td>
                                      <td colspan="3"><input name="t_strDivisionCode" type="text" id="t_strDivisionCode" onBlur="validateCharacter(this)" value="<? echo $t_strDivisionCode; ?>" size="20" maxlength="20">
                                        <span class="required"> *</span></td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Division Name : </td>
                                      <td colspan="3"> <input name="t_strDivisionName" type="text" value="<? echo $t_strDivisionName; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                        <span class="required"> *</span> </td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Project Code : </td>
                                      <td colspan="3"> <select name="t_strProjectCode" size=1 id="t_strProjectCode">
                                          <?php 
										$objDivision->comboProjectCode($t_strProjectCode);
										?>
                                        </select> <input name="t_strOldProjectCode" type="hidden" value="<? echo $t_strProjectCode; ?>">
                                        <span class="required"> *</span> </td>
                                    </tr>
                                    <tr> 
                                    ...
                                    <tr> 
                                      <td height="10" class="paragraph"> <? 
											...
											?>
                                        Division Head : </td>
                                      <td width="359" colspan="3"><input name="t_strDivisionHead" type="text" id="t_strDivisionHead" value="<? echo $t_strDivisionHead; ?>" size="50" maxlength="50" readonly>
                                        <span class="required"> *</span></td>
                                    </tr>
                                    <tr> 
                                      <td height="19" class="paragraph">Division 
                                        Head Title : </td>
                                      <td width="359" colspan="3"><input name="t_strDivisionHeadTitle" type="text" id="t_strDivisionHeadTitle" onBlur="validateCharacterAndSpace(this)" size="50" maxlength="50"> 
                                        <input name="strEmpNmbr" type="hidden" id="strEmpNmbr" value="<? echo $strEmpNmbr; ?>">
                                        <span class="required"> *</span></td>
                                    </tr>
                                    <tr> 
                                      <td height="19" class="paragraph">Division 
                                        Code : </td>
                                      <td width="359" colspan="3"><input name="t_strDivisionCode" type="text" id="t_strDivisionCode" onBlur="validateCharacter(this)" size="20" maxlength="20">
                                        <span class="required"> *</span></td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Division Name : </td>
                                      <td colspan="3"> <input name="t_strDivisionName" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                        <span class="required"> *</span> </td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Project Code : </td>
                                      <td colspan="3"> <select name="t_strProjectCode" size=1>
                                          <?php 
										$objDivision->comboProjectCode($t_strProjectCode);
										?>
                                        </select> <input name="t_strOldProjectCode" type="hidden" value="<? echo $t_strProjectCode; ?>">
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
								$objDivision->viewDivision($strEmpNmbr, $t_strDivisionCode, $t_strDivisionName, $t_strProjectCode, $t_strEmpNumber, $t_strDivisionHead, $t_strDivisionHeadTitle);   //Load viewDivision function
							 ?>
                                  </td>
                                </tr>
                              </table></td>
