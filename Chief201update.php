...
include("../hrmis/class/Chief201update.php");
$objEmp201Update = new chief201Update;
...
function updateRequirement()
{
	...
	var strEmpData = document.frmChief201.t_strEmpProfile.value;
	
	window.location = "Chief201update.php?strEmpNmbr="+strEmpNmbr+"&t_strEmpProfile="+strEmpData;
}
...
if (document.frmChief201.t_strTaxCertNmbr.value=="") {
alert("Please input community tax certificate!")
return false
} else if (document.frmChief201.t_strIssuedAt.value=="") {
...
if (document.frmChief201.t_strRefName.value=="") {
alert("Please input reference name!")
return false
} else if (document.frmChief201.t_strRefAddress.value=="") {
alert("Please input reference address!")
return false
} else if (document.frmChief201.t_intRefTelephone.value=="") {
alert("Please input reference telephone!")
return false
} 

for (var i=0;i<document.frmChief201.t_intRefTelephone.value.length;i++){
temp=document.frmChief201.t_intRefTelephone.value.substring(i,i+1)
...
if (document.frmChief201.t_strExamPlace.value=="") {
alert("Please input place of exam!")
return false
} else if (document.frmChief201.t_intExamRating.value=="") {
alert("Please input exam rating!")
return false
}

for (var i=0;i<document.frmChief201.t_intExamRating.value.length;i++){
temp=document.frmChief201.t_intExamRating.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
if (document.frmChief201.t_strSchoolName.value=="") {
alert("Please input school name!")
return false
} else if (document.frmChief201.t_strCourse.value=="") {
alert("Please input course!")
return false
} else if (document.frmChief201.t_intUnits.value=="") {
alert("Please input unit!")
return false
}

for (var i=0;i<document.frmChief201.t_intUnits.value.length;i++){
temp=document.frmChief201.t_intUnits.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert(" Invalid rate of exam! \n\n Please input numbers only!")
return false
      }
...
if (document.frmChief201.t_strChildName.value=="") {
...
if (document.frmChief201.t_intTrainingHours.value=="") {
alert("Please input training hours!")
return false
} else if (document.frmChief201.t_strTrainingVenue.value=="") {
alert("Please input training venue!")
return false
} else if (document.frmChief201.t_strTrainingConductedBy.value=="") {
alert("Please input training conducted by!")
return false
} else if (document.frmChief201.t_intTrainingCost.value=="") {
alert("Please input training cost!")
return false
} 

for (var i=0;i<document.frmChief201.t_intTrainingHours.value.length;i++){
temp=document.frmChief201.t_intTrainingHours.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intTrainingCost.value.length;i++){
temp=document.frmChief201.t_intTrainingCost.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
var digits=".0123456789"
var temp
if (document.frmChief201.t_strVWName.value=="") {
alert("Please input name of organization!")
return false
} else if (document.frmChief201.t_strVWAddress.value=="") {
alert("Please input address of organization!")
return false
} else if (document.frmChief201.t_intVWHours.value=="") {
alert("Please input number of hours!")
return false
} else if (document.frmChief201.t_strVWPosition.value=="") {
alert("Please input position/nature of work!")
return false
}

for (var i=0;i<document.frmChief201.t_intVWHours.value.length;i++){
temp=document.frmChief201.t_intVWHours.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
if (document.frmChief201.t_strSurname.value=="") {
alert("Please input surname!")
return false
} else if (document.frmChief201.t_strFirstname.value=="") {
alert("Please input first name!")
return false
} else if (document.frmChief201.t_strMiddlename.value=="") {
alert("Please input middle name!")
return false
} else if (document.frmChief201.t_intWeight.value=="") {
alert("Please input weight in kgs.!")
return false
} else if (document.frmChief201.t_strResidentialAddress.value=="") {
alert("Please input residential!")
return false
} else if (document.frmChief201.t_intZipCode1.value=="") {
alert("Please input resident zip code!")
return false
} else if (document.frmChief201.t_strPermanentAddress.value=="") {
alert("Please input permanent address!")
return false
} else if (document.frmChief201.t_intZipCode2.value=="") {
alert("Please input permanent zip code!")
return false
} else if (document.frmChief201.t_strEmail.value=="") {
alert("Please input email!")
return false
}

for (var i=0;i<document.frmChief201.t_intWeight.value.length;i++){
temp=document.frmChief201.t_intWeight.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intZipCode1.value.length;i++){
temp=document.frmChief201.t_intZipCode1.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intTelephone1.value.length;i++){
temp=document.frmChief201.t_intTelephone1.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intZipCode2.value.length;i++){
temp=document.frmChief201.t_intZipCode2.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intTelephone2.value.length;i++){
temp=document.frmChief201.t_intTelephone2.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.frmChief201.t_intMobile.value.length;i++){
temp=document.frmChief201.t_intMobile.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  <td> <form action="<? $PHP_SELF; ?>" name="frmChief201" method="post">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%"  class="paragraph" height="25"><strong> 
                                                  </strong> <input name="t_strExamRequestCode" type="hidden" id="t_strExamRequestCode" value="<? echo $t_strExamRequestCode; ?>">
                                                  Exam Type :</td>
                                                <td width="70%"> 
                                                  <?php 
										...
										?>
                                              ...
                                              <tr> 
                                                <td height="25" class="paragraph">License 
                                                  No. (if applicable) :</td>
                                                <td><input name="t_strLicenseNumber" type="text" id="t_strLicenseNumber" size="25" maxlength="50"></td>
                                              </tr>
                                              <tr> 
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" class="paragraph" height="25"><input name="t_strEducationRequestCode" type="hidden" id="t_strTrainingRequestCode3" value="<? echo $t_strEducationRequestCode; ?>">
										...
										?>
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">School 
                                                  Name : </td>
                                                <td><input name="t_strSchoolName" type="text" id="t_strSchoolName" size="60" maxlength="80"> 
                                                  <span class="required"> *</span></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph" height="25">Course 
                                                  : </td>
                                                <td><input name="t_strCourse" type="text" id="t_strCourse" size="50" maxlength="50"> 
                                                  <span class="required"> *(write 
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Units 
                                                  Earned :</td>
                                                <td><input name="t_intUnits" type="text" id="t_intUnits" size="20" maxlength="10" onBlur="validateUnit(this)">
                                                  <span class="required">*(write 
                                              ...
                                              <tr> 
                                                <td class="paragraph" height="25">Honors 
                                                  : </td>
                                                <td><input name="t_strHonors" type="text" id="t_strHonors" size="60" maxlength="80"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph" height="25">Date 
                                                  From :</td>
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="31%" height="25" class="paragraph"><input name="t_strTaxRequestCode" type="hidden" id="t_strTrainingRequestCode4" value="<? echo $t_strTaxRequestCode; ?>">
	...
	{ 	
//	$objEmp201Update->addReference($t_strEmpNumber, $t_strRequestCode, $t_strRefName, $t_strRefAddress, $t_intRefTelephone, $Submit);   //Add employee reference
?>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" height="25" class="paragraph"><strong> 
                                                  ...
                                                  <input name="t_strRefRequestCode" type="hidden" id="t_strTrainingRequestCode5" value="<? echo $t_strRefRequestCode; ?>">
                                                  Name :</td>
...
?>
                                        ...
                                        <tr> 
                                          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                <td width="30%" height="25" class="paragraph"><input name="t_strChildRequestCode" type="hidden" id="t_strTrainingRequestCode6" value="<? echo $t_strChildRequestCode; ?>">
                                                  Name of Children :</td>
											...
											?>
                                              ...
                                              <tr> 
                                                <td colspan="2"><div align="center"><strong>
                                                    ...
                                                    <input name="Submit" type="submit" value="Submit" onClick="trapEntryVoluntary();return validateVoluntaryWorks()">
                                                    <input name="Reset" type="reset" value="Clear">
                                                  </div></td>
                                              </tr>
                                              <tr> 
										  	...
										  	?>
                                                    ...
                                                    <tr> 
                                                      <td colspan="2" class="paragraph"><div align="center"><strong> 
                                                          ...
                                                          <input name="Submit" type="submit" id="Submit" onClick="return validateProfile()" value="Submit">
