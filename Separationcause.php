<?php 
/* 
File Name: Separationcause.php
----------------------------------------------------------------------
Purpose of this file: 
To add, edit and delete separation cause to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Separationcause.php");  //Load database connection 
$objSeparation = new Separationcause;   //Load separationCause function
$objSeparation->addSeparationCause($strEmpNmbr, $t_strSeparationCause, $Submit);   //Load addSeparationCause function
$objSeparation->editSeparationCause($strEmpNmbr, $t_strSeparationCause, $Submit, $t_strOldSeparationCause);   //Load editSeparationCause function
$strConfirm = $objSeparation->deleteSeparationCause($strEmpNmbr, $t_strSeparationCause, $Submit);   //Load deleteSeparationCause function
?>
...
<!-- Begin
nextfield = "t_strSeparationCause"; // name of first box on page
netscape = "";
...
eval('document.frmSeparationCause.' + nextfield + '.focus()');
return false;
      }
   }
}
...
if (document.frmSeparationCause.t_strSeparationCause.value=="") {
alert("Please input separation cause!")
return false
}
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="174" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>SEPARATION CAUSE</p></td>
                          </tr>
                          <tr> 
                            <td height="18" valign="top"> 
                              <div align="center"> 
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <form action="<?php $PHP_SELF; ?>" method="post" name="frmSeparationCause" onSubmit="return validate()">
                                    <?
									if($strConfirm)
									{
									?>
                                    <tr> 
                                      <td colspan="3" class="titlebar">Are you 
                                        sure you want to delete <? echo $t_strSeparationCause; ?> 
                                        ??? 
									...
									?>
                                    <tr> 
                                      <td width="170" class="paragraph">Separation 
                                        Cause : </td>
                                      <td width="384" colspan="3"> <input name="t_strSeparationCause" type="text" value="<? echo $t_strSeparationCause; ?>" size="50" maxlength="50" onBlur="validateCharacter(this)">
                                    ...
                                    <tr> 
                                      ...
                                      <td colspan="3"> <input name="t_strSeparationCause" type="text" size="50" maxlength="50" onBlur="validateCharacter(this)">
                          ...
                          <tr> 
                            <td height="112" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
									<?php
									   $objSeparation->viewSeparationCause($strEmpNmbr, $t_strSeparationCause);
									?>
                                  </td>
                                </tr>
                              </table></td>
