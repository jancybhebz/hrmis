...
include("../hrmis/class/Appointment.php");  //Load database connection 
include("../hrmis/class/JSgeneral.php");
$objAppointment= new AppointmentStatus;   //Load appointmentStatus function
//$arrEmpPersonal2 = $objAppointment->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objAppointment->addAppointmentStatus($strEmpNmbr, $t_strAppointmentCode, $t_strAppointmentDesc, $t_strHeader, $t_strLeaveEntitled, $t_strPaymentBasis, $Submit);
$objAppointment->editAppointmentStatus($strEmpNmbr, $t_strAppointmentCode, $t_strAppointmentDesc, $t_strHeader, $t_strLeaveEntitled, $t_strPaymentBasis, $Submit, $t_strOldAppointmentCode);
$strConfirm = $objAppointment->deleteAppointmentStatus($strEmpNmbr, $t_strAppointmentCode, $t_strAppointmentDesc, $t_strHeader, $t_strLeaveEntitled, $t_strPaymentBasis, $Submit);
?>
...
var temp;
var invalid = ""; //invalid spaces
if (document.frmAppointment.t_strAppointmentCode.value=="") {
alert("Please input appointment code!")
return false
} else if (document.frmAppointment.t_strAppointmentDesc.value=="") {
alert("Please input appointment description!")
return false
} else if (document.frmAppointment.t_strHeader.value=="") {
alert("Please input payslip header!")
return false
}
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="174" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>APPOINTMENT STATUS</p></td>
                          </tr>
                          <tr> 
                            <td height="18" valign="top"> 
                              <div align="center"> 
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <form action="<?php $PHP_SELF; ?>" method="post" name="frmAppointment" onSubmit="return validate()">
                                    <?
									if($strConfirm)
									{
									?>
                                    <tr> 
                                      <td colspan="3" class="titlebar">Are you 
                                        sure you want to delete <? echo $t_strAppointmentCode; ?> 
                                        and <? echo $t_strAppointmentDesc; ?> 
                                        ??? 
                                        <input type="hidden" name="t_strAppointmentCode" value="<? echo $t_strAppointmentCode; ?>"></td>
                                    </tr>
                                    <tr> 
                                      <td colspan="3"><div align="center"> 
                                          <input name="Submit" type="submit" onClick="MM_validateForm('t_strAppointmentCode','','R','t_strAppointmentDesc','','R');return document.MM_returnValue" value="OK" >
									...
									?>
                                    <tr> 
                                      <td width="171" class="paragraph">Appointment 
                                        Code :</td>
                                      <td width="383" colspan="3"> <input name="t_strAppointmentCode" type="text" value="<? echo $t_strAppointmentCode; ?>" size="30" maxlength="30" readonly onBlur="validateCharacter(this)">
                                        <span class="required"> * </span> </td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Appointment Description 
                                        :</td>
                                      <td colspan="3"> <input name="t_strAppointmentDesc" type="text" value="<? echo $t_strAppointmentDesc;?>" size="50" maxlength="50" readonly onBlur="validateCharacterAndSpace(this)">
                                        <span class="required"> * </span> 
                                        <input type="hidden" name="t_strOldAppointmentCode" value="<? echo $t_strAppointmentCode; ?>"> 
                                      </td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Pay Slip Header : 
                                      </td>
                                      <td colspan="3"><input name="t_strHeader" type="text" value="<? echo $t_strHeader; ?>" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                        <span class="required"> * </span> </td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Leave Entitled :</td>
                                      <td colspan="3"> 
                                        <?
									 if($t_strLeaveEntitled == "Y" || $t_strLeaveEntitled == "")
									  {
									  	echo "<input name='t_strLeaveEntitled' type='radio' value='Y' checked>";
									  }
									  else
									  {
									  	echo "<input name='t_strLeaveEntitled' type='radio' value='Y'>";
									  }
									  ?>
                                        Yes 
                                        <?
									 if($t_strLeaveEntitled == "N")
									  {
									  	echo "<input name='t_strLeaveEntitled' type='radio' value='N' checked>";
									  }
									  else
									  {
									  	echo "<input name='t_strLeaveEntitled' type='radio' value='N'>";
									  } 
									  ?>
                                        No</td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Payment Basis : </td>
                                      <td colspan="3"> 
                                        <?
									 if($t_strPaymentBasis == "CLNDR" || $t_strPaymentBasis == "")
									  {
									  	echo "<input name='t_strPaymentBasis' type='radio' value='CLNDR' checked>";
									  }
									  else
									  {
									  	echo "<input name='t_strPaymentBasis' type='radio' value='CLNDR'>";
									  }
									  ?>
                                        Calendar Days 
                                        <?
									 if($t_strPaymentBasis == "WKDY")
									  {
									  	echo "<input name='t_strPaymentBasis' type='radio' value='WKDY' checked>";
									  }
									  else
									  {
									  	echo "<input name='t_strPaymentBasis' type='radio' value='WKDY'>";
									  } 
									  ?>
                                        Weekdays 
                                    ...
                                    <tr> 
                                      <td colspan="4" class="paragraph"> <div align="center"> 
                                          <input name="Submit" type="submit" value="Submit" onClick="MM_validateForm('t_strAppointmentCode','','R','t_strAppointmentDesc','','R');return document.MM_returnValue">
                                    ...
                                    <tr> 
                                      <td width="171" class="paragraph">Appointment 
                                        Code :</td>
                                      <td width="383" colspan="3"> <input name="t_strAppointmentCode" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                        <span class="required"> * </span></td>
                                    </tr>
                                    <tr> 
                                      <td class="paragraph">Appointment Description 
                                        :</td>
                                      <td colspan="3"> <input name="t_strAppointmentDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                        <span class="required"> * </span></td>
                                    </tr>
                                    <tr>
                                      <td class="paragraph">Pay Slip Header : 
                                      </td>
                                      <td colspan="3"><input name="t_strHeader" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                        <span class="required"> * </span></td>
                                    </tr>
                                    <tr>
                                      <td class="paragraph">Leave Entitled :</td>
                                      <td colspan="3">
<input name="t_strLeaveEntitled" type="radio" value="Y" checked>
                                        Yes 
                                        <input type="radio" name="t_strLeaveEntitled" value="N">
                                        No </td>
                                    </tr>
                                    <tr>
                                      <td class="paragraph">Payment Basis : </td>
                                      <td colspan="3"> <input name="t_strPaymentBasis" type="radio" value="CLDR" checked>
                                        Calendar Days
<input type="radio" name="t_strPaymentBasis" value="WKDY">
                                        Weekdays
                                        <input name="strEmpNmbr" type="hidden" id="strEmpNmbr" value="<? echo $strEmpNmbr; ?>"></td>
                                    </tr>
                                    <tr> 
                          ...
                          <tr> 
                            <td height="112" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									   $objAppointment->viewAppointmentStatus($strEmpNmbr, $t_strAppointmentCode, $t_strAppointmentDesc, $t_strHeader, $t_strLeaveEntitled, $t_strPaymentBasis);   // View appointment
									?>
                                  </td>
                                </tr>
                              </table></td>
