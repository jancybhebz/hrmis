...
----------------------------------------------------------------------
Date of Revision: June 18, 2004 (Version 2.0.0)
----------------------------------------------------------------------
Copyright Notice:
...
include("../hrmis/class/Personalduties.php");
$objEmployee= new personalDuties;
...
//--------------------------------  Add Duties -------------------------------//
$objEmployee->addDuties($strEmpNmbr, $t_strEmpNumber, $t_intPercentWork, $t_strDuties, $Submit);   //Add employee duties and responsibilities

//--------------------------------  Edit Duties -------------------------------//

$objEmployee->editDuties($strEmpNmbr, $txtSearch, $optField, $p, $strLetter, $t_strEmpNumber, $t_intPercentWork, $t_strDuties, $Submit, $t_strOldDuties);   //Edit employee duties and responsibilities

//--------------------------------  Delete Duties -------------------------------//

$strConfirm=$objEmployee->deleteDuties($strEmpNmbr, $t_strEmpNumber, $t_intPercentWork, $t_strDuties, $Submit);   //Delete employee duties and responsibilities
?>
...
if (document.frmDuties.t_intPercentWork.value=="") {
alert("Please input percent of working time!")
return false
} else if (document.frmDuties.t_strDuties.value=="") {
alert("Please input duties!")
return false
}
...
for (var i=0;i<document.frmDuties.t_intPercentWork.value.length;i++){
temp=document.frmDuties.t_intPercentWork.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid percent of working time !")
return false
      }
   }
                    ...
                    <tr> 
                      <td height="339"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td><p class="header">DUTIES AND RESPONSIBILITIES</p>
                              ...
                              <hr> 
                              <? 
								$objEmployee->viewDuties($strEmpNmbr, $txtSearch, $optField, $p, $strLetter,  $t_intPercentWork, $t_strDuties, $arrEmpPersonal["empNumber"]);   //view employee duties and responsibilities
								?>
                              <br> 
                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form method="post" action="<? $PHP_SELF; ?>" name="frmDuties" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_intPercentWork; ?> 
                                      and <? echo $t_strDuties; ?> ??? 
                                      <input name="t_strOldDuties" type="hidden" id="t_strOldDuties" value="<? echo $t_strDuties; ?>"></td>
                                  </tr>
                                  <tr> 
							      ...
							      ?>
                                  <tr> 
                                    <td colspan="2" class="paragraph"><input name="t_strEmpNumber" type="hidden" id="t_strEmpNumber" value="<? echo "$t_strEmpNumber"; ?>">
                                      Percent of Working Time :</td>
                                    <td width="378"><input name="t_intPercentWork" type="text" onBlur="validateNumber(this)" value="<? echo $t_intPercentWork; ?>" size="5" maxlength="3">
                                      <span class="text"> %</span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="2" class="paragraph">Duties and 
                                      Responsibilities :</td>
                                    <td><textarea name="t_strDuties" onBlur="validateCharacter(this)"><? echo $t_strDuties; ?></textarea>
                                      <input name="t_strOldDuties" type="hidden" value="<? echo $t_strDuties; ?>"></td>
                                  </tr>
                                  <tr> 
                                  ...
                                  <?
								     ...
								     ?>
                                  <tr> 
                                    <td colspan="2" class="paragraph"> Percent 
                                      of Working Time : </td>
                                    <td><input name="t_intPercentWork" type="text" onBlur="validateNumber(this)" size="5" maxlength="3">
                                      <span class="text"> %</span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="2" class="paragraph">Duties and 
                                      Responsibilities :</td>
                                    <td><textarea name="t_strDuties" onBlur="validateCharacter"></textarea></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3">&nbsp;</td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph"> <div align="center">
                                        ...
                                        <input name="p" type="hidden" id="p2" value="<? echo $p; ?>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">&nbsp;</td>
                                  ...
                                  <tr> 
                                    <td colspan="3" class="paragraph"> <? $objEmployee->output(); ?>
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" class="paragraph">&nbsp;</td>
