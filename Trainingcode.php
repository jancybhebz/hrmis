<?php 
/* 
File Name: Trainingcode.php
----------------------------------------------------------------------
Purpose of this file: 
To add and delete training code and title to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Trainingcode.php");   //Load database connection
$objTrainingCode= new trainingCode;   //Load trainingCode function
$objTrainingCode->addTrainingCode($strEmpNmbr, $t_strUserLevel, $t_strTrainingCode, $t_strTrainingTitle, $Submit);   //Load addTrainingCode function
$objTrainingCode->editTrainingCode($strEmpNmbr, $t_strTrainingCode, $t_strTrainingTitle, $Submit, $t_strOldTrainingCode);   //Load editTrainingCode function
$strConfirm = $objTrainingCode->deleteTrainingCode($strEmpNmbr, $t_strTrainingCode, $t_strTrainingTitle, $Submit);   //Load deleteTrainingCode function
?>
...
function validateTrainingCode(field) 
{
...
var temp
if (document.frmTrainingCode.t_strTrainingCode.value=="") {
alert("Please input training code!")
return false
} else if (document.frmTrainingCode.t_strTrainingTitle.value=="") {
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="196" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>TRAINING CODE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="get" name="frmTrainingCode" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strTrainingCode; ?> 
                                      and <? echo $t_strTrainingTitle; ?> ??? 
								  ...
								  ?>
                                  <tr> 
                                    <td width="121" class="paragraph">Training 
                                      Code :</td>
                                    <td width="433" colspan="3"> <input name="t_strTrainingCode" type="text" value="<? echo "$t_strTrainingCode"; ?>" size="20" maxlength="20" onBlur="validateTrainingCode(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Training Title : </td>
                                    <td colspan="3"> <input name="t_strTrainingTitle" type="text" value="<? echo "$t_strTrainingTitle"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                  ...
                                  <tr>
                                    <td colspan="4" class="paragraph"><div align="center">
									 ...
									 ?>
                                  <tr> 
                                    <td class="paragraph">Training Code :</td>
                                    <td colspan="3"> <input name="t_strTrainingCode" type="text" size="20" maxlength="20" onBlur="validateTrainingCode(this)">
                                      <span class="required">*</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Training Title : </td>
                                    <td colspan="3"> <input name="t_strTrainingTitle" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required">*</span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo "$strEmpNmbr"; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="18"> 
                                    <?php
									$objTrainingCode->viewTrainingCode($strEmpNmbr, $t_strTrainingCode, $t_strTrainingTitle);   //Load viewTrainingCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
