...
To add and delete income code & description to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Incomecode.php"); // Load database connection
$objIncome= new income;   //Load income function
$objIncome->addIncome($strEmpNmbr, $t_strIncomeCode, $t_strIncomeAbb, $t_strIncomeDesc, $Submit); //Load addIncome function
$objIncome->editIncome($strEmpNmbr, $t_strIncomeCode, $t_strIncomeAbb, $t_strIncomeDesc, $Submit, $t_strOldIncomeCode);   ///Load editIncome function									
$strConfirm = $objIncome->deleteIncome($strEmpNmbr, $t_strIncomeCode, $t_strIncomeAbb, $t_strIncomeDesc, $Submit);   //Load deleteIncome function
?>
...
var temp
if (document.frmIncome.t_strIncomeCode.value=="") {
alert("Please input income code!")
return false
} else if (document.frmIncome.t_strIncomeAbb.value=="") {
alert("Please input income abbreviation!")
return false
} else if (document.frmIncome.t_strIncomeDesc.value=="") {
alert("Please input income description!")
return false
}
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>INCOME</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr>
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('IncomeIndicator','','images/indicator1.jpg',1)"><img src="images/indicator1.jpg" alt="Income Indicator" name="IncomeIndicator" width="7" height="12" border="0"></a> 
                                    Income</td>
                                </tr>
                                <tr> 
                                  <td height="12" class="radio"> <a href="http://dbmis.dost.gov.ph/hrmis/Incomeadditional.php"> 
                                    </a><a href="http://dbmis.dost.gov.ph/hrmis/Incomeadditional.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('IncomeAdditionalIndicator','','images/indicator2.jpg',1)"><img src="images/indicator2.jpg" alt="Income Additional Indicator" name="IncomeAdditionalIndicator" width="7" height="12" border="0"></a><a href="Incomeadditional.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Additional 
                                    Income</a></td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmIncome" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strIncomeCode; ?>, 
                                      <? echo $t_strIncomeAbb; ?> and <? echo $t_strIncomeDesc; ?> 
                                      ??? 
                                      <input name="t_strIncomeCode" type="hidden" id="t_strIncomeCode" value="<? echo $t_strIncomeCode; ?>"></td>
                                  </tr>
                                  <tr> 
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Income Code 
                                      : </td>
                                    <td width="384" colspan="3"> <input name="t_strIncomeCode" type="text" value="<? echo "$t_strIncomeCode"; ?>" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td width="170" class="paragraph">Income Abbreviation 
                                      : </td>
                                    <td colspan="3"><input name="t_strIncomeAbb" type="text" value="<? echo "$t_strIncomeAbb"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Income Description :</td>
                                    <td colspan="3"> <input name="t_strIncomeDesc" type="text" value="<? echo "$t_strIncomeDesc"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> 
                                      <input name="t_strOldIncomeCode" type="hidden" value="<? echo "$t_strIncomeCode"; ?>">
                                  ...
                                  <?
								   ...
								   ?>
                                  <tr> 
                                    <td class="paragraph">Income Code : </td>
                                    <td colspan="3"> <input name="t_strIncomeCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Income Abbreviation 
                                      :</td>
                                    <td colspan="3"><input name="t_strIncomeAbb" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Income Description :</td>
                                    <td colspan="3"> <input name="t_strIncomeDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objIncome->viewIncome($strEmpNmbr, $t_strIncomeCode, $t_strIncomeAbb, $t_strIncomeDesc);   //Load viewIncome function
									?>
                                  </td>
                                </tr>
                              </table></td>
