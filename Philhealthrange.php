...
include("../hrmis/class/TaxPhilhealth.php");   //Load philhealth functions
$objPhilHealth = new TaxPhilhealth;
$objPhilHealth->addPhilhealth($strEmpNmbr, $philhealthFrom, $philhealthTo, $philSalaryBase, $Submit2, $philSalaryBase1);
?>
...
var temp
if (document.myPhilhealth.philhealthFrom.value=="") {
alert("Please input range from!")
return false
} else if (document.myPhilhealth.philhealthTo.value=="") {
alert("Please input range to!")
return false
} else if (document.myPhilhealth.philSalaryBase.value=="") {
alert("Please input philhealth salary base!")
return false
}

for (var i=0;i<document.myPhilhealth.philhealthFrom.value.length;i++){
temp=document.myPhilhealth.philhealthFrom.value.substring(i,i+1)
...
for (var i=0;i<document.myPhilhealth.philhealthTo.value.length;i++){
temp=document.myPhilhealth.philhealthTo.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
...
for (var i=0;i<document.myPhilhealth.philSalaryBase.value.length;i++){
temp=document.myPhilhealth.philSalaryBase.value.substring(i,i+1)
if (digits.indexOf(temp)==-1){
alert("Invalid salary base !")
return false
      }
   }
...
?>
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="24" class="header"><p>philhealth RANGE</p></td>
                          </tr>
                          <form action="<?php $PHP_SELF; ?>" method="post" name="myPhilhealth" onSubmit="return validate()" >
                            <?
								if($Submit2 == "Delete")
								{
								?>
                            <tr> 
                              <td colspan="3" class="titlebar">Are you sure you 
                                want to delete this range??? 
                                <input name="philSalaryBase" type="hidden" id="philSalaryBase" value="<?echo"$philSalaryBase";?>">
                            ...
                            <?
								...
								?>
                            <tr> 
                              <td colspan="7" class="paragraph">Range From:</td>
                              <td colspan="3"> <input name="philhealthFrom" type="text" size="30" maxlength="30" value="<?echo"$philhealthFrom";?>" onBlur="validateAmount(this)">
                                <span class="required"> *</span> </td>
                            </tr>
                            <tr> 
                              <td height="21" colspan="7" class="paragraph">Range 
                                To :</td>
                              <td colspan="3"> <input name="philhealthTo" type="text" size="30" maxlength="30" value="<? echo"$philhealthTo";?>" onBlur="validateAmount(this)">
                                <span class="required"> *</span> </td>
                            </tr>
                            <tr> 
                              <td colspan="7" class="paragraph">Salary Base:</td>
                              <td colspan="3"> <input name="philSalaryBase" type="text" size="30" maxlength="30" value="<? echo"$philSalaryBase";?>" onBlur="validateAmount(this)">
                                <span class="required"> *</span> 
                                <input name="philSalaryBase1" type="hidden" value="<?echo"$philSalaryBase";?>">
                            ...
                            <? } else  {
 								?>
                            <tr> 
                              <td height="104" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td colspan="7" class="paragraph">Range From 
                                      :</td>
                                    <td colspan="3"> <input name="philhealthFrom" type="text" size="30" maxlength="30" onBlur="validateAmount(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td height="21" colspan="7" class="paragraph">Range 
                                      To :</td>
                                    <td colspan="3"> <input name="philhealthTo" type="text" size="30" maxlength="30" onBlur="validateAmount(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="7" class="paragraph">Salary Base 
                                      :</td>
                                    <td colspan="3"> <input name="philSalaryBase" type="text" size="30" maxlength="30" onBlur="validateAmount(this)">
                                      <span class="required"> *</span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
					...
					<table width="99%" height="38" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY" dwcopytype="CopyTableCell">
                          <tr> 
                            <td height="16" class="header"><p>&nbsp;</p></td>
                          </tr>
                          <tr> 
                            <td height="18" valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="18"> 
                                    <?php
$objPhilHealth->viewPhilhealth($strEmpNmbr);
?>
                                  </td>
                                </tr>
                              </table>
