...
$objRequestCode->addRequestCode($strEmpNmbr, $t_strRequestCode, $t_strRequestDesc, $Submit);   //Load addRequestCode function
$objRequestCode->editRequestCode($strEmpNmbr, $t_strRequestCode, $t_strRequestDesc, $Submit, $t_strOldRequestCode);   //Load editRequestCode function
$strConfirm = $objRequestCode->deleteRequestCode($strEmpNmbr, $t_strRequestCode, $t_strRequestDesc, $Submit);   //Load deleteRequestCode function
?>
...
var temp
if (document.frmRequest.t_strRequestCode.value=="") {
alert("Please input request code!")
return false
} else if (document.frmRequest.t_strRequestDesc.value=="") {
alert("Please input request description!")
return false
}
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>REQUEST TYPE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmRequest" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strRequestCode; ?> 
                                      and <? echo $t_strRequestDesc; ?> ??? 
                                      <input name="t_strRequestCode" type="hidden" value="<? echo $t_strRequestCode; ?>">
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Request 
                                      Code :</td>
                                    <td width="384" colspan="3"> <input name="t_strRequestCode" type="text" value="<? echo "$t_strRequestCode";?>" size="20" maxlength="20" 
="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Request Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strRequestDesc" type="text" value="<? echo "$t_strRequestDesc";?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> 
                                      <input name="t_strOldRequestCode" type="hidden" value="<? echo "$t_strRequestCode";?>">
                                  ...
                                  <?
								   ...
								   ?>
                                  <tr> 
                                    <td class="paragraph">Request Code :</td>
                                    <td colspan="3"> <input name="t_strRequestCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Request Description 
                                      :</td>
                                    <td colspan="3"> <input name="t_strRequestDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objRequestCode->viewRequestCode($strEmpNmbr, $t_strRequestCode, $t_strRequestDesc);   //Load viewRequestCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
