...
To add and delete exam code & description to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Requesttype.php");   //Load database connection
$objRequestCode= new requestCode;   //Load RequestCode function
$objRequestCode->addRequestCode($t_strRequestCode, $t_strRequestDesc, $Submit);   //Load addRequestCode function
$objRequestCode->editRequestCode($t_strRequestCode, $t_strRequestDesc, $Submit, $t_strOldRequestCode);   //Load editRequestCode function
$strConfirm = $objRequestCode->deleteRequestCode($t_strRequestCode, $t_strRequestDesc, $Submit);   //Load deleteRequestCode function
?>
...
var temp
if (document.frmReport.t_strReportCode.value=="") {
alert("Please input report code!")
return false
} else if (document.frmReport.t_strReportDesc.value=="") {
alert("Please input report description!")
return false
} else if (document.frmReport.t_strReportType.value=="") {
alert("Please input report type!")
return false
} else if (document.frmReport.t_strReportModule.value=="") {
alert("Please input report module!")
return false
}
...
?>
                                    <table width="108" height="300" border="0" align="center" cellpadding="0" cellspacing="0" id="NAVTBL">
                                      ...
                                      <tr> 
                                        <td><a href="Requesttype.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOut="MM_swapImgRestore(); statusBar()" onFocus="statusBar()" onMouseOver="MM_swapImage('requesttype1','','images/requesttype2.jpg',1); statusBar(); return true;" onClick="statusBar();"><img src="images/requesttype.jpg" alt="requesttype" name="requesttype1" width="108" height="20" border="0" id="requesttype1"></a></td>
                                      </tr>
                                      <tr> 
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>REPORT TYPE</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmReport" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strReportCode; ?>, 
                                      <? echo $t_strReportDesc; ?>, <? echo $t_strReportType; ?> 
                                      and <? echo $t_strRequestModule; ?> ??? 
                                      <input name="t_strReportCode2" type="hidden" id="t_strReportCode2" value="<? echo "$t_strReportCode";?>"></td>
                                  </tr>
                                  <tr> 
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Report Code 
                                      :</td>
                                    <td width="384" colspan="3"> <input name="t_strReportCode" type="text" id="t_strReportCode" value="<? echo "$t_strReportCode";?>" size="20" maxlength="20">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Report Description :</td>
                                    <td colspan="3"> <input name="t_strReportDesc" type="text" id="t_strReportDesc" value="<? echo "$t_strReportDesc";?>" size="50" maxlength="50"> 
                                      <input name="t_strOldReportCode" type="hidden" id="t_strOldReportCode" value="<? echo "$t_strReportCode";?>"> 
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Report Type :</td>
                                    <td colspan="3"><input name="t_strReportType" type="text" id="t_strReportType" value="<? echo "$t_strReportType"; ?>" size="50" maxlength="50"></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Report Module :</td>
                                    <td colspan="3"><input name="t_strReportModule" type="text" id="t_strReportModule" value="<? echo "$t_strReportModule"; ?>" size="20" maxlength="4"></td>
                                  </tr>
                                  <tr> 
                                  ...
                                  <?
								   ...
								   ?>
                                  <tr> 
                                    <td class="paragraph">Report Code :</td>
                                    <td colspan="3"> <input name="t_strReportCode" type="text" id="t_strReportCode" size="20" maxlength="10">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Report Description :</td>
                                    <td colspan="3"> <input name="t_strReportDesc" type="text" id="t_strReportDesc" size="50" maxlength="50"> 
                                    </td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Report Type :</td>
                                    <td colspan="3"><input name="t_strReportType" type="text" id="t_strReportType" size="50" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Report Module :</td>
                                    <td colspan="3"><input name="t_strReportModule" type="text" id="t_strReportModule" size="20" maxlength="4"></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="4" class="paragraph">&nbsp;</td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objRequestCode->viewRequestCode($t_strRequestCode, $t_strRequestDesc);   //Load viewRequestCode function
									?>
                                  </td>
                                </tr>
                              </table></td>
