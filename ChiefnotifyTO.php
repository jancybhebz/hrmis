<?php 
/* 
File Name: ChiefnotifyTO.php 
----------------------------------------------------------------------
Purpose of this file: 
To view employee travel request.
----------------------------------------------------------------------
...
----------------------------------------------------------------------
Author: Brian Jill DG. Sarandi and Pearliezl Samoy Dy Tioco
----------------------------------------------------------------------
...
include("../hrmis/class/ChiefnotifyTO.php");
$objChief = new chiefNotifyTO;
$arrEmpPersonal = $objChief->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objChief->approvedRequest($strEmpNmbr, $t_strRequestID, $t_strRequestStatus, $t_dtmStatusDate, $t_strRemarks, $Submit);  // approved employee/s OB request
?>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="22" class="header"><p>TRAVEL ORDER REQUEST 
                                      FOR APPROVAL</p></td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td> 
                                          <?
							  $objChief->viewRequestForApproval($strEmpNmbr, $arrEmpPersonal['divisionCode']); //View list of employee/s request
							  ?>
                                        </td>
                                      </tr>
                                    </table></td>
