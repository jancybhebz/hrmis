...
include("../hrmis/class/Chiefreference.php");
$objChief= new reference;
                                ...
                                <form action="<? $PHP_SELF; ?>" method="post" name="frmReference">
                                  <tr> 
                                    <td><p class="header">REFERENCE</p>
                                      ...
                                      <hr> 
                                      <? 
								$objChief->viewReference($txtSearch, $optField, $p, $t_strRefName, $t_strRefAddress, $t_strRefTelephone, $arrEmpPersonal["empNumber"]);   //View Reference
								?>
                                      <br> </td>
                                  </tr>
                                </form>
