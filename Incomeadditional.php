<?php 
/* 
File Name: Incomeadditional.php
----------------------------------------------------------------------
Purpose of this file: 
To add, edit and delete additional income to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Incomeadditional.php"); // Load database connection
$objAddIncome= new incomeAdditional;   //Load incomeAdditional function
$objAddIncome->addAdditionalIncome($strEmpNmbr, $t_strAddIncomeCode, $t_strAddIncomeDesc, $t_intFixedAmount, $Submit); //Load addAdditionalIncome function
$objAddIncome->editAdditionalIncome($strEmpNmbr, $t_strAddIncomeCode, $t_strAddIncomeDesc, $t_intFixedAmount, $Submit,  $t_strOldAddIncomeCode);   ///Load editAdditionalIncome function									
$strConfirm = $objAddIncome->deleteAdditionalIncome($strEmpNmbr, $t_strAddIncomeCode, $t_strAddIncomeDesc, $t_intFixedAmount, $Submit);   //Load deleteAdditionalIncome function
?>
...
var temp
if (document.frmAddIncome.t_strAddIncomeCode.value=="") {
alert("Please input additional income code!")
return false
} else if (document.frmAddIncome.t_strAddIncomeDesc.value=="") {
alert("Please input additional income description!")
return false
} else if (document.frmAddIncome.t_intFixedAmount.value=="") {
alert("Please input fixed amount!")
return false
}

for (var i=0;i<document.frmAddIncome.t_intFixedAmount.value.length;i++){
temp=document.frmAddIncome.t_intFixedAmount.value.substring(i,i+1)
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        ...
                        <table width="99%" height="166" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="25" class="header"><p>INCOME (Additional)</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr>
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td class="radio"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Indicator','','images/indicator_down.jpg',1)"> 
                                    </a><a href="Income.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('IncomeIndicator','','images/indicator2.jpg',1)"><img src="images/indicator2.jpg" alt="Income Indicator" name="IncomeIndicator" width="7" height="12" border="0"> 
                                    </a><a href="Income.php?strEmpNmbr=<? echo $strEmpNmbr; ?>&t_strUserLevel=<? echo $t_strUserLevel; ?>&t_strUserPermission=<? echo $t_strUserPermission; ?>&t_strAccessPermission=<? echo $t_strAccessPermission; ?>" onMouseOver="statusBar(); return true;" onClick="statusBar();" onMouseUp="statusBar()" onFocus="statusBar()">Income</a></td>
                                </tr>
                                <tr> 
                                  <td height="12" class="radio"> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('IncomeAdditionalIndicator','','images/indicator1.jpg',1)"><img src="images/indicator1.jpg" alt="Income Additional Indicator" name="IncomeAdditionalIndicator" width="7" height="12" border="0"></a> 
                                    Additional Income</td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          <tr> 
                            <td valign="top"> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmAddIncome" onSubmit="return validate()">
                                  <?
								if($strConfirm)
								{
								?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strAddIncomeCode; ?>, 
                                      <? echo $t_strAddIncomeDesc; ?> and <? echo $t_intFixedAmount; ?> 
                                      ??? 
                                      <input name="t_strAddIncomeCode" type="hidden" id="t_strAddIncomeCode" value="<? echo $t_strAddIncomeCode; ?>">
								...
								?>
                                  <tr> 
                                    <td width="170" class="paragraph">Add Income 
                                      Code : </td>
                                    <td width="384" colspan="3"> <input name="t_strAddIncomeCode" type="text" value="<? echo "$t_strAddIncomeCode"; ?>" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td width="170" class="paragraph">Add Income 
                                      Description : </td>
                                    <td colspan="3"><input name="t_strAddIncomeDesc" type="text" value="<? echo "$t_strAddIncomeDesc"; ?>" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph"> Amount :</td>
                                    <td colspan="3"> <input name="t_intFixedAmount" type="text" value="<? echo "$t_intFixedAmount"; ?>" size="20" maxlength="20" onBlur="validateAmount(this)">
                                      <span class="required"> * </span>
<input name="t_strOldAddIncomeCode" type="hidden" value="<? echo "$t_strAddIncomeCode"; ?>">
                                  ...
                                  <?
								   ...
								   ?>
                                  <tr> 
                                    <td class="paragraph">Add Income Code : </td>
                                    <td colspan="3"> <input name="t_strAddIncomeCode" type="text" size="20" maxlength="20" onBlur="validateCharacter(this)">
                                      <span class="required"> * </span> </td>
                                  </tr>
                                  <tr>
                                    <td class="paragraph">Add Income Description 
                                      :</td>
                                    <td colspan="3"><input name="t_strAddIncomeDesc" type="text" size="50" maxlength="50" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> * </span></td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Amount :</td>
                                    <td colspan="3"> <input name="t_intFixedAmount" type="text" size="20" maxlength="20" onBlur="validateAmount(this)">
                                      <span class="required"> * </span>
<input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objAddIncome->viewAdditionalIncome($strEmpNmbr, $t_strAddIncomeCode, $t_strAddIncomeDesc, $t_intFixedAmount);   //Load viewAdditionalIncome function
									?>
                                  </td>
                                </tr>
                              </table></td>
