...
include("../hrmis/class/DirectornotifyTO.php");
$objDirector = new directorNotifyTO;
$arrEmpPersonal = $objDirector->checkGetEmpNmbr("Employee", $strEmpNmbr);
$objDirector->approvedRequest($strEmpNmbr, $t_strRequestID, $t_strRequestStatus, $t_dtmStatusDate, $t_strRemarks, $Submit);  // approved employee/s OB request
?>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="22" class="header"><p>tO REQUEST 
                                      FOR APPROVAL</p></td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td> 
                                          <?
							  $objDirector->viewApproval($strEmpNmbr);  //View list of employee/s request (DirectornotifyOB.php)
							  ?>
                                        </td>
                                      </tr>
                                    </table></td>
                                        ...
                                        <tr> 
                                          <td><table width="85%" border="1" align="center" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr> 
                                                ...
                                                <td><input name="t_strDestination" type="text" readonly value="<? echo $t_strDest; ?>" size="50"></td>
                                              </tr>
											  <tr>
                                              ...
                                              <tr> 
                                                <td class="paragraph">Purpose 
                                                  :</td>
                                                <td><textarea name="t_strPurpose" cols="30" readonly rows="3"><? echo $t_strPurpose; ?></textarea></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Source of Fund 
                                                  :</td>
                                                <td><input name="t_strFund" type="text" readonly value="<? echo $t_strFund; ?>" size="20"></td>
                                              </tr>
                                              <tr> 
                                                <td class="paragraph">Transportation 
                                                  :</td>
                                                <td><input name="t_strTranspo" type="text" readonly value="<? echo $t_strTranspo; ?>" size="20"></td>
                                              </tr>
                                              <tr> 
