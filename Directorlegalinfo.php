...
include("../hrmis/class/Emplegalinfo.php");
$objLegalinfo= new legalinfo;
$arrEmpPersonal = $objLegalinfo->checkGetEmpNmbr("Employee", $strEmpNmbr);
?>
                          ...
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="151"><p class="header">LEGAL INFORMATION</p>
