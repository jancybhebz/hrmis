<?php 
/* 
File Name: Directorrequeststatus.php 
----------------------------------------------------------------------
...
include("../hrmis/class/Directorrequeststatus.php");
$objDirector = new directorRequestStatus;
$arrEmpPersonal = $objDirector->checkGetEmpNmbr("Employee", $strEmpNmbr);

$objDirector->deleteDirectorStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks, $Submit); //Delete director status of request
?>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="23" class="header"><p> REQUEST STATUS</p></td>
                                </tr>
                                <tr> 
                                      ...
                                      <tr> 
                                        <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td> 
                                                <? 
										  $objDirector->viewDirectorStatusOfRequest($strEmpNmbr, $t_strRequestID, $t_strRequestCode, $t_strEmpNumber, $t_strSurname, $t_strFirstname, $t_strMiddlename, $t_strRequestDetails, $t_strRequestStatus, $t_strRemarks);  //View list of approved director request 
										   ?>
                                              </td>
                                            </tr>
                                          </table></td>
