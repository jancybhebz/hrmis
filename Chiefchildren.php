...
include("../hrmis/class/Chiefchildren.php");
$objChief= new children;
                                ...
                                <form method="post" action="<? $PHP_SELF; ?>" name="frmEmpChild" >
                                  <tr> 
                                    <td><p class="header">CHILDREN</p>
                                      ...
                                      <hr> 
                                      <? 
									 $objChief->viewChild($txtSearch, $optField, $p, $t_strChildName, $t_strChildBirthDate, $arrEmpPersonal["empNumber"]); //View list of employee children information
									 ?>
                                      <br> </td>
                                  </tr>
                                </form>
