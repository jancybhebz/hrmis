...
To add and delete level code and description to database.
----------------------------------------------------------------------
...
include("../hrmis/class/Level.php");   //Load database connection
$objLevel= new educationalLevel;   //Load educationalLevel function
$objLevel->addEducationalLevel($strEmpNmbr, $t_strLevelCode, $t_strLevelDesc, $Submit);   //Load addEducationalLevel function
$objLevel->editEducationalLevel($strEmpNmbr, $t_strLevelCode, $t_strLevelDesc, $Submit, $t_strOldLevelCode);   //Load editEducationalLevel function
$strConfirm = $objLevel->deleteEducationalLevel($strEmpNmbr, $t_strLevelCode, $t_strLevelDesc, $Submit);   //Load deleteEducationalLevel function
?>
...
var temp
if (document.frmLevel.t_strLevelCode.value=="") {
alert("Please input level code!")
return false
} else if (document.frmLevel.t_strLevelDesc.value=="") {
                ...
                <td width="84%" valign="top"><table width="99%" height="563" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" --> 
                        <table width="99%" height="165" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODY">
                          <tr> 
                            <td height="24" class="header"><p>EDUCATIONAL LEVEL</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <form action="<?php $PHP_SELF; ?>" method="post" name="frmLevel" onSubmit="return validate()">
                                  <?
								  if($strConfirm)
								  {
								  ?>
                                  <tr> 
                                    <td colspan="3" class="titlebar">Are you sure 
                                      you want to delete <? echo $t_strLevelCode; ?> 
                                      and <? echo $t_strLevelDesc; ?> ??? 
                                      <input type="hidden" name="t_strLevelCode" value="<? echo $t_strLevelCode; ?>"></td>
                                  </tr>
                                  <tr> 
								  ...
								  ?>
                                  <tr> 
                                    <td width="169" class="paragraph">Level Code 
                                      :</td>
                                    <td width="385" colspan="3"> <input name="t_strLevelCode" type="text" value="<? echo "$t_strLevelCode";?>" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Level Description : 
                                    </td>
                                    <td colspan="3"> <input name="t_strLevelDesc" type="text" value="<? echo "$t_strLevelDesc"; ?>" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                  ...
                                  <tr> 
                                    ...
                                    <td colspan="3"> <input name="t_strLevelCode" type="text" size="30" maxlength="30" onBlur="validateCharacter(this)">
                                      <span class="required"> *</span> </td>
                                  </tr>
                                  <tr> 
                                    <td class="paragraph">Level Description : 
                                    </td>
                                    <td colspan="3"> <input name="t_strLevelDesc" type="text" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)">
                                      <span class="required"> *</span> 
                                      <input name="strEmpNmbr" type="hidden" value="<? echo $strEmpNmbr; ?>"> 
                                    </td>
                                  </tr>
                          ...
                          <tr> 
                            <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?php
									$objLevel->viewEducationalLevel($strEmpNmbr, $t_strLevelCode, $t_strLevelDesc);   //Load viewEducationalLevel function
									?>
                                  </td>
                                </tr>
                              </table></td>
