...
$objAttendance->trapButton($txtSearch, $strLetter, "ChiefNoMatch.php", "ChiefDTR.php");
$strDvsnCode = $objAttendance->getChiefDivision($strEmpNmbr);
$arrEmpPersonal = $objAttendance->checkGetEmpNmbr("Chief", $txtSearch, $optField, $cboMonth, $cboYear, 1, $p, $strLetter, $strDvsnCode);
?>
...
?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="21"><p class="header">Daily Time 
                                      Record</p>
  								<p align="center">
								  <?
                                        ...
                                        <td width="480" height="73"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#99CCFF">
                                            <tr> 
                                              <td width="141" class="paragraph">Employee 
                                                Number : </td>
                                              <td width="339"><strong>&nbsp;<? echo $arrEmpPersonal['empNumber']; ?></strong></td>
                                            </tr>
                                            <tr> 
                          ...
                          <tr> 
                            <td><table width="90%" align="center" cellpadding="0" cellspacing="0">
								...
								$objAttendance->viewDTR($cboMonth, $cboYear, $arrEmpPersonal["empNumber"], 0); //View list of employee daily time record 
								?>
