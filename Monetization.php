<?
/* 
File Name: Monetization.php 
----------------------------------------------------------------------
Purpose of this file: 
Leave Monetization of employee
----------------------------------------------------------------------
...
if($btnMonetize == "MONETIZE LEAVE")
{
	if(strlen($intMaxMonetize) == 0)
	{
		$intMaxMonetize = 0;
	}
	if(strlen($txtMonetizeVL) == 0)
	{
		$txtMonetizeVL = 0;
	}
	
	if ($intMaxMonetize < $txtMonetizeVL)
	{
		$strConfirm = "The leave monetize entry is more than the maximum leave to be monetize!";
	}
	else
	{
		$arrLB = $objAttendance->lastestMonthOnLB($arrEmpPersonal["empNumber"]);
		$intVL = $arrLB["vlBalance"];
		$intSL = $arrLB["slBalance"];
		$strConfirm = $objAttendance->monetization($arrEmpPersonal["empNumber"], $txtMonetizeVL, $txtMonetizeSL, $arrLB["periodMonth"], $arrLB["periodYear"]);
	}
}
...
$intVL = $arrLB["vlBalance"];
$intSL = $arrLB["slBalance"];
$strMonthFullLB = $objAttendance->intToMonthFull($arrLB["periodMonth"]);

$arrLatestMonetize = $objAttendance->latestMonetize($arrEmpPersonal["empNumber"], $cboYear);
$intMonetizeVL = $arrLatestMonetize["vlMonetize"];
$intMonetizeSL = $arrLatestMonetize["slMonetize"];
...
function checkLeaveCredit(t_txtLeave, t_intLeave, t_strLeaveTyp)
{
	if(t_intLeave < Number(t_txtLeave))
	{
		alert("The monetize "+t_strLeaveTyp+" leave is more than the allowed to be monetized "+t_strLeaveTyp+" leave.")
		event.returnValue=false;
	}
	else if(Number(t_txtLeave) == 0)
	{
		alert("Please enter number of leave(s) to be monetized on "+t_strLeaveTyp+" leave textbox.")
		event.returnValue=false;	
	}
}
</script>
...
?>
                          ...
                          <tr> 
                            <td height="62"><p class="header">LEAVE MONETIZATION</p>
								<p align="center">
								  <?
...
?>								  
								  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titlebar">
                                      <tr bgcolor="#99CCFF"> 
                                        <td align="center" class="warning" colspan="2" height="20" valign="middle"><? echo $strConfirm?></td>
                                      </tr>
									  									  
                                      <tr bgcolor="#99CCFF"> 
                                        
                                      <td align="center" class="title" colspan="2" height="30" valign="middle">Leave 
                                        Credits Available as of <? echo $strMonthFullLB." ".$arrLB["periodYear"];?></td>
                                      </tr>
                                      <tr bgcolor="#99CCFF"> 
                                        <td align="right" class="radio" width="50%" height="20">Vacation Leave:&nbsp;</td>
                                        <td width="50%"><? echo number_format($intVL, 3, '.','');?></td>
                                      </tr>									  									  
                                      <tr bgcolor="#99CCFF"> 
                                        <td align="right" class="radio" height="20">Sick Leave:&nbsp;</td>
                                        <td><? echo number_format($intSL, 3, '.','');?></td>
                                      </tr>
                                      <tr bgcolor="#99CCFF"> 
                                        <td align="right" class="radio" height="20">Total Leave Credits:&nbsp;</td>
                                        <td><? echo number_format($intSL+$intVL, 3, '.','');?></td>
                                      </tr>
										<tr bgcolor="#99CCFF"><td height="10" colspan="2"></td></tr>
										<tr bgcolor="#99CCFF"> 
									  <td colspan="2" class="note" align="center"> <p><i>&quot;Monetization of 50% or more of all your accumulated leave credit may be allowable for valid and <br>
										justifiable reasons subject to the discretion of the agency head and the availability of funds.&quot;</i></p>
										<p><i>"Sick leave credits may be monetized if an employee has no available vacation leave credits. 
										<br>Vacation leave credits must be exhausted first before sick leave credits maybe used."</i></p>
										Five (5) days must be left at Vacation Leaves credits after monetization. 
										<br>
										 </td>
										</tr>
									  <?
									  if(floor($intVL) > 5 && !is_array($arrLatestMonetize))
									  {
									  ?>
									  <form name="frmVL" method="get">
									  <tr bgcolor="#99CCFF"><td colspan="2" class="note" align="center">
									  <br>You are allowed to monetized maximum of <? echo $intMaxMonetize = floor($intVL) - 5?> vacation leave day(s).
									  <br><br>
									  </td></tr>
										<tr bgcolor="#99CCFF"><td height="10" colspan="2"></td></tr>
                                      <tr bgcolor="#99CCFF"> 
                                    <td align="right" class="radio" height="20"># 
                                      of Leave(s) to be Monetized on Vacation Leave:&nbsp;</td>
                                    <td>
                                      <input type="text" name="txtMonetizeVL" maxlength="7" value="<? echo number_format($intMonetizeVL, 3, ".", ",")?>"></td>
                                      </tr>
									<tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="20" valign="middle">
								  <input type="hidden" name="txtSearch" value="<? echo $txtSearch?>"> 
									...
									<input type="hidden" name="intMaxMonetize" value="<? echo $intMaxMonetize?>">										
										</td>
                                      </tr>
  									<tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="30" valign="bottom">
										<input type="submit" name="btnMonetize" value="MONETIZE LEAVE" onClick="checkLeaveCredit(frmVL.txtMonetizeVL.value, frmVL.intMaxMonetize.value, 'vacation')">
										</td>
									</tr>
									<tr bgcolor="#99CCFF"><td height="10" colspan="2"></td></tr>
									</form>
									  ...
									  elseif(floor($intVL) <= 5 && floor($intSL) > 5 && !is_array($arrLatestMonetize))
									  {
									  ?>
									  <form name="frmSL" method="get">
									  <tr bgcolor="#99CCFF"><td colspan="2" class="note" align="center">
									  <br>You are allowed to monetized maximum of <? echo $intMaxMonetize = floor($intSL) - 5?> sick leave day(s).
									  <br><br>
									  </td></tr>
									  
                                      <tr bgcolor="#99CCFF"> 
                                    <td align="right" class="radio" height="20"># 
                                      of Leave(s) to be Monetized on Sick Leave:&nbsp;</td>										
                                    <td>
                                      <input type="text" name="txtMonetizeSL" maxlength="7" value="<? echo number_format($intMonetizeSL, 3, ".", ",")?>"></td>
                                      </tr>
									<tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="20" valign="middle">
								  <input type="hidden" name="txtSearch" value="<? echo $txtSearch?>"> 
									...
									<input type="hidden" name="intMaxMonetize" value="<? echo $intMaxMonetize?>">										
  									...
  									<tr bgcolor="#99CCFF"> 
                                        <td align="center" class="title" colspan="2" height="30" valign="bottom">
										<input type="submit" name="btnMonetize" value="MONETIZE LEAVE"  onClick="checkLeaveCredit(frmSL.txtMonetizeSL.value, frmSL.intMaxMonetize.value, 'sick')">
										</td>
									</tr>
									<tr bgcolor="#99CCFF"><td height="10" colspan="2"></td></tr>
									</form>
									  ...
									  elseif (is_array($arrLatestMonetize))
									  {
									  ?>
									  <tr bgcolor="#99CCFF"><td height="20" colspan="2"></td></tr>
									  <tr bgcolor="#99CCFF"><td height="50" colspan="2" class="errorsearch" align="center"> This employee already 
									  availed monetization for this year <?=date("Y")?>.  <br>Monetization of leave credits can only be avail ONCE a year</td></tr>
									  <tr bgcolor="#99CCFF"><td height="10" colspan="2"></td></tr>
									  <?
									  }
									  ?>
