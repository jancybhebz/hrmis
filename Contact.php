...
*/
session_start();
include("../hrmis/class/Contact.php");
$objContact = new contact;

$objContact->addContact($strEmpNmbr, $t_strAgencyCode, $t_strAgency, $t_strSurname, $t_strFirstname, $t_strMiddleInitial, $t_strTitle, $t_strPosition, $t_strAddress, $t_intTelephone, $t_strEmail, $Submit, $t_strOldAgencyCode); //Add contact
?>
...
function validateInitial(field) 
{
	var valid = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
	var ok = "yes";
	var temp;
...
function validateEmail(field) 
{
	...
	if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(field.t_strEmail.value)){
	return (true)
	}
...
var temp
if (document.frmContact.t_strAgencyCode.value=="") {
alert("Please input agency code!")
return false
} else if (document.frmContact.t_strAgency.value=="") {
alert("Please input agency name!")
return false
} else if (document.frmContact.t_strSurname.value=="") {
alert("Please input surname!")
return false
} else if (document.frmContact.t_strFirstname.value=="") {
alert("Please input firstname!")
return false
} else if (document.frmContact.t_strMiddleInitial.value=="") {
alert("Please input middle initial!")
return false
} else if (document.frmContact.t_strPosition.value=="") {
alert("Please input position!")
return false
} else if (document.frmContact.t_strAddress.value=="") {
alert("Please input address!")
return false
} else if (document.frmContact.t_intTelephone.value=="") {
alert("Please input telephone!")
return false
} else if (document.frmContact.t_strEmail.value=="") {
alert("Please input email!")
return false
}
 

for (var i=0;i<document.frmContact.t_intTelephone.value.length;i++){
temp=document.frmContact.t_intTelephone.value.substring(i,i+1)
                    ...
                    <tr> 
                      <td height="563"><!-- InstanceBeginEditable name="BODY" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="24" class="header"><p>CONTACT</p></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td> <form action="<? $PHP_SELF; ?>" method="post" name="frmContact"  onSubmit="return checkEmail(this)">
								<? if ($Submit == 'Delete') {?>
                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td class="titlebar">Are you sure you want 
                                      to delete employee/s contact information 
                                      ??? 
                                      <input name="t_strAgencyCode" type="hidden" value="<? echo $t_strAgencyCode; ?>"></td>
                                  </tr>
                                  <tr>
								...
								<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td width="31%" class="paragraph">Agency 
                                            Code :</td>
                                          <td width="69%"> <input name="t_strAgencyCode" type="text" value="<? echo "$t_strAgencyCode"; ?>" size="10" maxlength="10" onBlur="validateCharacter(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Agency Name :</td>
                                          <td><input name="t_strAgency" type="text" value="<? echo "$t_strAgency"; ?>" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Surname :</td>
                                          <td><input name="t_strSurname" type="text" value="<? echo $t_strSurname; ?>" size="30" maxlength="50" onBlur="validateCharacterAndSpace(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">First Name :</td>
                                          <td><input name="t_strFirstname" type="text" value="<? echo $t_strFirstname; ?>" size="30" maxlength="50" onBlur="validateCharacter(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Middle Initial 
                                            :</td>
                                          <td><input name="t_strMiddleInitial" type="text" value="<? echo $t_strMiddleInitial; ?>" size="10" maxlength="1" onBlur="validateInitial(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Title :</td>
                                          <td> <select name="t_strTitle" size="1" onBlur="validateCharacter(this)">
                                              <?
											if ($t_strTitle == 'Atty.')
											{
												echo "<option value=\"Atty.\" selected>Atty.</option>";
											} else {
												echo "<option value=\"Atty.\">Atty.</option>";
											}
											?>
                                              <?
											if ($t_strTitle == 'Dr.')
											...
											if ($t_strTitle == 'Engr.')
											{
												echo "<option value=\"Engr.\" selected>Engr.</option>";
											} else {
												echo "<option value=\"Engr.\">Engr.</option>";
											}
											?>
                                              <?
											if ($t_strTitle == 'Mr.')
                                        ...
                                        <tr> 
                                          ...
                                          <td><input name="t_strPosition" type="text" id="t_strPosition" value="<? echo $t_strPosition; ?>" size="30" maxlength="30" onBlur="validatePosition(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Address :</td>
                                          <td> <textarea name="t_strAddress" cols="30" wrap="VIRTUAL" onBlur="validateAddress(this)"><? echo "$t_strAddress"; ?></textarea> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Telephone :</td>
                                          <td><input name="t_intTelephone" type="text" onBlur="validateNumber(this)" value="<? echo $t_intTelephone; ?>" size="15" maxlength="10"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">E-mail Address 
                                            :</td>
                                          <td><input name="t_strEmail" type="text" value="<? echo $t_strEmail; ?>" size="30" maxlength="30" onBlur="validateEmail(this)">
                                            <input name="t_strOldAgencyCode" type="hidden" value="<? echo $t_strAgencyCode; ?>">
                                  ...
                                  <tr> 
                                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td width="31%" class="paragraph">Agency 
                                            Code :</td>
                                          <td width="69%"> <input name="t_strAgencyCode" type="text" size="10" maxlength="10" onBlur="validateCharacter(this)"> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Agency Name :</td>
                                          <td><input name="t_strAgency" type="text" size="50" maxlength="70" onBlur="validateCharacterAndSpace(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Surname :</td>
                                          <td><input name="t_strSurname" type="text" size="30" maxlength="50" onBlur="validateCharacterAndSpace(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">First Name :</td>
                                          <td><input name="t_strFirstname" type="text" size="30" maxlength="50" onBlur="validateCharacterAndSpace(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Middle Initial 
                                            :</td>
                                          <td><input name="t_strMiddleInitial" type="text" size="10" maxlength="1" onBlur="validateInitial(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Title :</td>
                                          <td> <select name="t_strTitle" size="1">
                                        ...
                                        <tr> 
                                          <td class="paragraph">Position :</td>
                                          <td><input name="t_strPosition" type="text" size="30" maxlength="30" onBlur="validatePosition(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Address :</td>
                                          <td> <textarea name="t_strAddress" cols="30" wrap="VIRTUAL" onBlur="validateAddress(this)"></textarea> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">Telephone :</td>
                                          <td><input name="t_intTelephone" type="text" size="15" maxlength="10" onBlur="validateNumber(this)"></td>
                                        </tr>
                                        <tr> 
                                          <td class="paragraph">E-mail Address 
                                            :</td>
                                          <td><input name="t_strEmail" type="text" size="30" maxlength="30" onFocus="return checkEmail(this)">
                                      ...
                                      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td> <div align="center"> 
                                              <input type="submit" name="Submit" value="ADD" onClick="return validate(this)">
                          ...
                          <tr> 
                            <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> 
                                    <?
								  $objContact->viewContact($strEmpNmbr);
								  ?>
                                  </td>
                                </tr>
                              </table></td>
