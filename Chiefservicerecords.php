<?php 
/* 
File Name: Chiefservicerecords.php
----------------------------------------------------------------------
...
include("../hrmis/class/Chiefservicerecords.php");
$objChief= new service;
$arrEmpPersonal = $objChief->checkGetEmpNmbr("Employee", $strEmpNmbr);
?>
<html><!-- InstanceBegin template="/Templates/Chieftmplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<table width="778" border="0" cellpadding="0" cellspacing="0" id="OUTERTBL">
  <tr> 
    <td height="395"><table width="100%" height="395" border="0" align="center" cellpadding="0" cellspacing="0" id="INNERTBL">
        <tr> 
          <td width="58%" height="44" valign="bottom"><img src="images/divchiefmodule.jpg" width="170" height="23"> 
          </td>
        ...
        <tr bgcolor="#E9F3FE"> 
          <td height="320" colspan="2" valign="top"><table width="100%" height="313" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                            ...
                            <td height="313" valign="top"><table width="90%" height="313" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="NAVTBL">
                                <tr> 
                                  <td height="289" valign="top"><table width="108" height="184" border="0" align="center" cellpadding="0" cellspacing="0" id="NAVTBL">
                                      <tr> 
                                        <td><a href="Chiefprofile.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Personnel','','images/personnel2.jpg',1)"><img src="images/personnel1.jpg" alt="Personnel Profile" name="Personnel" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td><a href="Chiefeducation.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Education','','images/education2.jpg',1)"><img src="images/education1.jpg" alt="Education" name="Education" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td><a href="Chieftrainings.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Trainings','','images/trainings2.jpg',1)"><img src="images/trainings1.jpg" alt="Trainings" name="Trainings" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td><a href="Chiefservicerecords.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ServiceRecords','','images/servicerecords2.jpg',1)"><img src="images/servicerecords1.jpg" alt="Service Records" name="ServiceRecords" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td height="20"><a href="Chiefexaminations.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Examinations','','images/examinations2.jpg',1)"><img src="images/examinations1.jpg" alt="Examinations" name="Examinations" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td height="20"><a href="Chieflegalinfo.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('LegalInfo','','images/legal2.jpg',1)"><img src="images/legal1.jpg" alt="Legal Info" name="LegalInfo" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td height="20"><a href="Chiefchildren.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Children','','images/children2.jpg',1)"><img src="images/children1.jpg" alt="Children" name="Children" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td height="20"><a href="Chiefpositiondetails.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('PositionDetails','','images/position2.jpg',1)"><img src="images/position1.jpg" alt="Position Details" name="PositionDetails" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td height="10"><a href="Chiefreference.php?strEmpNmbr=<? echo $arrEmpPersonal['empNumber']; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Reference','','images/reference2.jpg',1)"><img src="images/reference.jpg" alt="Reference" name="Reference" width="108" height="20" border="0"></a></td>
                                      </tr>
                                      <tr>
                ...
                <td width="84%" valign="top"><table width="99%" height="312" border="0" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="BODYTBL">
                    <tr> 
                      <td height="312"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><!-- InstanceBeginEditable name="Body" --> 
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="198"><p class="header">SERVICE RECORDS</p>
                                    ...
                                    <hr>
                                    <? 
								$objChief->viewServiceRecords($txtSearch, $optField, $p, $t_dtmServiceFromDate, $t_dtmServiceToDate, $t_strPositionCode, $t_strAppointmentCode, $t_strStationAgency, $t_intSalary, $t_intLeaveWoPay, $t_strBranch, $t_strSeparationCause, $t_dtmSeparationDate, $arrEmpPersonal["empNumber"]);  //View list of service records
								?>
                                  </td>
                                </tr>
                              </table>
