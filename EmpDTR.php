...
include("../hrmis/class/EmpDTR.php");
$objEmpDTR = new empDTR;
$arrEmpPersonal = $objEmpDTR->checkGetEmpNmbr("Employee", $strEmpNmbr);
...
?>
<html><!-- InstanceBegin template="/Templates/Employeeattendancetmplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/201over.jpg','images/logout2.jpg','images/requestsover.jpg','images/attendanceclick.jpg','images/notificationover.jpg'); history.forward();" onContextMenu="return false"><div align="center"> 
<table width="778" border="0" cellpadding="0" cellspacing="0" id="OUTERTBL">
  <tr> 
    <td><table width="100%" height="426" border="0" align="center" cellpadding="0" cellspacing="0" id="INNERTBL">
        <tr> 
          <td width="59%" height="44" valign="bottom"> <img src="images/empmodule.jpg" width="170" height="23"></td>
                      ...
                      <td height="228" valign="top"><table width="100%" height="313" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td height="313" valign="top"><table width="90%" height="338" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#C1E2FF" id="NAVTBL">
                                <tr> 
                                  <td height="338" valign="top"><table width="108" height="33" border="0" align="center" cellpadding="0" cellspacing="0" id="NAVTBL">
                                      <tr> 
                                        <td height="13">&nbsp;</td>
                                      </tr>
                                      <tr> 
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td height="21" class="header"><p>Daily Time 
                                      Record</p></td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td>
								  <form action="<? $PHP_SELF; ?>" method="post" name="frmEmpDTR">
								  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="36%" class="paragraph">Month 
                                          :</td>
                                        <td width="8%"><select name="cboMonth" size="1">
                                            <?
										$objEmpDTR->comboMonth($cboMonth);
										?>
                                          </select></td>
                                        <td width="7%" class="paragraph">Year 
                                          :</td>
                                        <td width="8%"><select name="cboYear" size="1">
                                            <?
										$objEmpDTR->comboYear($cboYear);
									   ?>
                                          </select></td>
                                        <td width="41%">&nbsp;&nbsp;
							  ...
							  <tr> 
								<td><table width="90%" align="center"><tr><td class="warning">* BOLD time means Quasi and Official Business</td></tr></table></td>
							  </tr>
                                <tr>
                                  <td>
								  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" class="titlebar">
								...
								$objEmpDTR->viewDTR($cboMonth, $cboYear, $arrEmpPersonal["empNumber"]); //View list of employee daily time record 
								?>
                              </table>
								  </td>
                                </tr>
